...
<div class="leftpanelinner">
    ...
    <ul class="nav nav-pills nav-stacked nav-bracket">
        ...
        <li class="nav-parent">
            ...
            <ul class="children">
                <?php /*?><li><a href="<?php echo site_url('inventory/preferences/inventory_config'); ?>"><i class="fa fa-circle-o"></i> Setup Awal Barang</a></li>
                                <li><a href="<?php echo site_url('inventory/preferences/system_config'); ?>"><i class="fa fa-circle-o"></i> Setup Awal Sistem</a></li><?php */ ?>
            </ul>
        </li>
        <li class="nav-parent">
            ...
            <ul class="children">
                ...
                <li><a href="<?php echo site_url('inventory/reports/rekap_pembelian_obat/dialog'); ?>"><i class="fa fa-circle-o"></i> Rekap Pembelian Obat</a></li>
