...
<ul class="dev-page-navigation">
    ...
    <li<?php if(in_array(@$page, array("report_first_registration_patient"))){echo " class=\"active\"";} ?>><a href="<?php echo base_url( 'registrations/reports/first_registration_patient' ) ?>" data-toggle="form-ajax-modal"><i class="fa fa-file-text"></i> <?php echo 'Laporan Pasien Pertama Kali Registrasi' ?></a></li>
</ul>
