...
<ul class="dev-page-navigation">
    ...
    <li<?php if(in_array(@$page, array("reports"))){echo " class=\"active\"";} ?>>
        ...
        <ul>                          
            ...
            <li<?php if(in_array(@$page, array("report_top_drugs"))){echo " class=\"active\"";} ?>><a href="<?php echo base_url( 'pharmacy/reports/top_drugs' ) ?>" data-toggle="form-ajax-modal"><i class="fa fa-circle-o"></i> <span><?php echo "Top 10 Penggunaan Obat" ?></span></a></li>  
