...
/*
 *
 * web: http://avenir.ro/revisiting-my_model-copying-jamie-rumbelow-looking-eloquent/
 * git: https://github.com/avenirer/CodeIgniter-MY_Model/blob/version-3.0/MY_Model.php
 *
 */
...
class MY_Model extends CI_Model
{
     ...
     */
    protected $_sync_fields_map = array();

    public function __construct()
    {
        parent::__construct();
        
		$this->load->helper('inflector','date');
    ...
    protected function _prep_before_write($data)
    {
    ...
    protected function _prep_before_read()
    {

    }

    protected function _prep_after_read($data, $multi = TRUE)
    {
    ...
    public function __call($method, $arguments)
    {
		...
		{
			echo 'No method with that name ('.$method.') in MY_Model.';
		}
	}
