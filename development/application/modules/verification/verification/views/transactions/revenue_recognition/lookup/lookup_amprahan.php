...
<div class="table-responsive">
    <table id="dt-lookup-revenue_recognition" class="table table-sm table-bordered table-hover table-icd" width="100%">
        <thead>
            <tr>
                <th></th>
...
(function( $ ){		
		$.fn.extend({
				DT_Lookup_Revenue_recognition: function(){
						var _this = this;
						...
						var _datatable = _this.DataTable( {
							...
							//scrollY: "200px",
							ajax: {
									url: "<?php echo base_url("verification/transactions/revenue_recognition/lookup_collection") ?>",
									type: "POST",
		...
		var _datatable = $( "#dt-lookup-revenue_recognition" ).DT_Lookup_Revenue_recognition();
