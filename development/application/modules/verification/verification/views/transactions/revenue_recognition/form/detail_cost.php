...
<div class="row">
	...
	<div class="form-group">
		<div class="table-responsive">
			<table id="dt_detail_cost" class="table table-sm table-bordered" width="100%">
				<thead>
					<tr>
						<th><?php echo lang('label:description')?></th>                        
						<th><?php echo lang('label:qty')?></th>                                                
						<th><?php echo lang('label:value')?></th>                    
						<th><?php echo lang('label:cost_rs')?></th>    
					</tr>
				</thead>
				<tbody>
				</tbody>
...
(function( $ ){
		...
		$.fn.extend({
				dt_detail_cost: function(){
						...
						$( "#dt_detail_cost_length select, #dt_detail_cost_filter input" )
