...
<div class="row">
	...
	<div class="form-group">
		<div class="table-responsive">
			<table id="dt_detail_cash" class="table table-sm table-bordered" width="100%">
				<thead>
					<tr>
...
(function( $ ){
		...
		$.fn.extend({
				dt_detail_cash: function(){
						...
						$( "#dt_detail_cash_length select, #dt_detail_cash_filter input" )
