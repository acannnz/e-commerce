    ...
    <div class="row" style="margin:0 !important;">
    	<div class="col-lg-12" style="margin:0 !important;">
        	...
        	<div class="row text-center" style="margin:0 !important;">
            	<h4><?php echo lang('reports:polyclinic_registration_heading'); ?></h4>
                    	...
                    	<table class="table reports-table"  style="border:1px solid black; font-size:10px">
                            <thead>
                            	<tr style="border:1px solid black;">
	                            	...
	                            	<th style="border:1px solid black; padding:8px;"><?php echo lang('reports:date_label'); ?></th>
	                            	<th style="border:1px solid black; padding:8px;"><?php echo lang('reports:regnum_label'); ?></th>
	                            	<th style="border:1px solid black; padding:8px;"><?php echo lang('reports:nrm_label'); ?></th>
	                            	<th style="border:1px solid black; padding:8px;"><?php echo lang('reports:patient_label'); ?></th>
	                            	<th style="border:1px solid black; padding:8px;"><?php echo lang('reports:address_label'); ?></th>
	                            	<th style="border:1px solid black; padding:8px;"><?php echo lang('reports:doctor_label'); ?></th>
	                            	<th style="border:1px solid black; padding:8px;"><?php echo lang('reports:old_label'); ?></th>
	                            	<th style="border:1px solid black; padding:8px;"><?php echo lang('reports:new_label'); ?></th>
                                </tr> 
                            </thead>
                            <tbody>	
                            	...
                            	<tr>
                                	...
                                	<td style="border:1px solid black; padding:2px;"><?php echo substr(@$row->TglReg, 0, 10); ?></td>
                                	<td style="border:1px solid black; padding:2px;"><?php echo @$row->NoReg ?></td>
                                	<td style="border:1px solid black; padding:2px;"><?php echo @$row->NRM ?></td>
                                	...
                                	<td align="center" style="border:1px solid black; padding:2px;"><?php echo @$row->PasienBaru == 0 ? "&radic;" : NULL ?></td>
                                	<td align="center" style="border:1px solid black; padding:2px;"><?php echo @$row->PasienBaru == 1 ? "&radic;" : NULL ?></td>
                                </tr>
                                <?php endforeach; else: ?>
