...
<body>
            ...
            <table class="table table_detail" width="100%" style="font-size:14px;">
                ...
                <tbody>
                    <tr>
                        ...
                        <td align="center" style="color:red;">Positif </td>
    ...
    <ul type="disc" style="margin-top:40px;">
        <li style="padding-bottom: 1px; font-size:16px;">Saran :</li>
        <li style="padding-bottom: 10px; padding-left:40px;">- &nbsp; Pemeriksaan konfirmasi dengan pemeriksaan RT-PCR</li>
        <li style="padding-bottom: 10px; padding-left:40px;">- &nbsp; Lakukan karantina atau isolasi dengan gejala</li>
        <li style="padding-bottom: 10px; padding-left:40px;">- &nbsp; Menerapkan PHBS (Perilaku hidup bersih dan sehat, mencuci tangan,</li>
        <li style="padding-bottom: 10px; padding-left:49px;"> &nbsp; menerapkan etika batuk, menggunakan masker, menjaga stamina)</li>
        <li style="padding-bottom: 10px; padding-left:49px;"> &nbsp; dan physical distancing</li>
    </ul>
    <div class="row">
