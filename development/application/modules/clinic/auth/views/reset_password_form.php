...
<section id="content" class="m-t-lg wrapper-md animated fadeInUp">
		...
		<div class="container aside-xxl">
		 <a class="navbar-brand block" href="<?php echo base_url()?>"><?php echo $this->config->item('company_name')?></a> 
		 <section class="panel panel-default bg-white m-t-lg">
		<header class="panel-heading text-center"> <strong>Change Password <?php echo $this->config->item('company_name')?></strong> </header>
