	...
	<div class="col-md-4">	
		...
		<div class="form-group">
			...
			<div class="col-lg-7">
				...
				<input type="hidden" id="k_Charge_2" name="k[charge_2]" value="<?php echo  !empty($item->AddCharge_Persen2) ? $item->AddCharge_Persen2 : 0.00 ?>" placeholder="" class="credit-card-2">
				<input type="hidden" id="k_Total_2" name="k[total_2]" value="<?php echo  !empty($collection[8]) ? number_format($collection[8] + ($collection[8] * $item->AddCharge_Persen2 / 100), 2, '.', ',') : 0.00; ?>" placeholder="" class="credit-card-2">
				<div class="input-group">
