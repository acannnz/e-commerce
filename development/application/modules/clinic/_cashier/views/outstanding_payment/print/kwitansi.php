...
<head>
    ...
    <style>
		#kwitansi_bg {
			background:url('<?php echo base_url("public/resource/print/kwitansi-default.png")?>');
...
<body>
    <div id="kwitansi_bg">
        ...
        <div id="NamaPasien" class="row"><?php echo $item->NamaPasien ?></div>
        <div id="Spelled" class="row"><?php echo ucwords($spelled." rupiah") ?></div>
        <div id="ForPayment" class="row"><?php echo $for_payment ?></div>
        <div id="Location" class="row"><?php echo sprintf("%s, %s", "Denpasar", date("Y-m-d") )?></div>
        <div id="NilaiPembayaran" class=""><?php echo number_format($item->NilaiPembayaran, 2, ',', '.') ?></div>
