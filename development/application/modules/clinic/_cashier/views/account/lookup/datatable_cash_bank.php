...
<div class="table-responsive">
    <table id="dt-lookup-account" class="table table-sm table-bordered table-striped" width="100%">
        <thead>
            <tr>
                <th></th>
                <th>Akun No</th>
...
(function( $ ){
		$.fn.extend({
				DT_Lookup_Account: function(){
						...
						var _datatable = _this.DataTable( {
							...
							//scrollY: "200px",
							ajax: {
									url: "<?php echo base_url("cashier/account/lookup_cash_bank_collection") ?>",
									type: "POST",
									data: function( params ){
										params.BackOfficeDatabase = $('#BackOfficeDatabase').val();
									}
								},
							columns: [
									{ 
		...
		var _datatable = $( "#dt-lookup-account" ).DT_Lookup_Account();
