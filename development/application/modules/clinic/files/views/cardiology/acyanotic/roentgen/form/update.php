...
?>
<?php echo form_open_multipart(current_url(), array('id' => 'form_files_cardiology_acyanotic_roentgen', 'name' => 'form_files_cardiology_acyanotic_roentgen')); ?>
    <h5><?php echo lang( "acyanotic:roentgen_thorax_subtitle" ) ?></h5>
    <div class="form-group">
        <label class="col-md-12"><?php echo lang("acyanotic:roentgen_thorax_label") ?></label>
        <div class="col-md-12">
...
;(function( $ ){
		$.fn.extend({
				form_files_cardiology_acyanotic_roentgen: function( remote_server ){
		...
		$( document ).ready(function(e) {
            	$( "form[name=\"form_files_cardiology_acyanotic_roentgen\"]" )
					.form_files_cardiology_acyanotic_roentgen( "<?php echo @$update_action ?>" );
        	});
	})( jQuery );
//]]>
</script>
