...
?>
<?php echo form_open_multipart(current_url(), array('id' => 'form_files_cardiology_acyanotic_echocardiography', 'name' => 'form_files_cardiology_acyanotic_echocardiography')); ?>
    <h5><?php echo lang( "acyanotic:echocardiography_subtitle" ) ?></h5>
    <div class="form-group">
        <label class="col-md-12"><?php echo lang("acyanotic:echocardiography_label") ?></label>
        <div class="col-md-12">
            <?php if( @$item->file_name ): ?>
            <a id="file_chart_usg_thumbnail" href="javascript:;" class="thumbnail">
                <img id="file_chart_usg_img" src="<?php echo base_url( "resource/patients/cardiology/acyanotic" ) ?>/<?php echo @$item->file_name ?><?php echo (sprintf("?rand=%s", @time())) ?>">
            </a>
            <?php else: ?>
            <a id="file_chart_usg_thumbnail" href="javascript:;" class="thumbnail">
                <img id="file_chart_usg_img" src="<?php echo base_url( "resource/patients/cardiology/acyanotic" ) ?>/<?php echo sprintf("default_picture_%s.jpg", @$acyanotic_support) ?>">
            </a>
            <?php endif ?>
        </div>
        <div class="col-md-6">
...
;(function( $ ){
		$.fn.extend({
				form_files_cardiology_acyanotic_echocardiography: function( remote_server ){
		...
		$( document ).ready(function(e) {
            	$( "form[name=\"form_files_cardiology_acyanotic_echocardiography\"]" )
					.form_files_cardiology_acyanotic_echocardiography( "<?php echo @$update_action ?>" );
        	});
	})( jQuery );
//]]>
</script>
