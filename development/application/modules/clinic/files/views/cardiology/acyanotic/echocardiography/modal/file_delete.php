...
<div class="modal-dialog">
    <div class="modal-content">
        <?php echo form_open(current_url(), array("id" => "form_files_cardiology_acyanotic_echocardiography_file_delete", "name" => "form_files_cardiology_acyanotic_echocardiography_file_delete")); ?>
...
;(function( $ ){
		$.fn.extend({
				form_files_cardiology_acyanotic_echocardiography_file_delete: function(){
						...
						_form.on( "submit", function(e){
								...
								try{
									...
									$.post( form_action, form_data, function( response, status, xhr ){
											...
											//console.log( status );
											try{
												var _form_v = $( "form#form_files_cardiology_acyanotic_echocardiography" );
												...
												img.attr( "src", "<?php echo base_url( "resource/patients/cardiology/acyanotic" ) ?>/default_picture.jpg?rund=" + (new Date()).getTime() );											
		...
		$( document ).ready(function(e) {
            	$( "form[name=\"form_files_cardiology_acyanotic_echocardiography_file_delete\"]" )
					.form_files_cardiology_acyanotic_echocardiography_file_delete();
        	});
	})( jQuery );
//]]>
</script>
