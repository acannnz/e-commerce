...
<div class="row">
    <div class="col-md-12">
        <?php echo form_open_multipart(current_url(), array('id' => 'form_files_chart_laboratory_upload', 'name' => 'form_files_chart_laboratory_upload', 'class' => 'drop-box text-center')); ?>
...
;(function( $ ){
		...
		$.fn.extend({
				form_files_chart_laboratory_upload: function( remote_server ){
						...
						var show_files = function( files ){
							...
							uploaded_files = function( files ){
									try{
										...
										img.attr( "src", "<?php echo base_url( "resource/patients/laboratory" ) ?>/" + (files.file_name || "default_picture.jpg") + "?rund=" + (new Date()).getTime() );											
		...
		$( document ).ready(function(e) {
            	$( "form[name=\"form_files_chart_laboratory_upload\"]" )
					.form_files_chart_laboratory_upload( "<?php echo @$form_action ?>" );
        	});
	})( jQuery );
//]]>
</script>
