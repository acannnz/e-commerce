...
<div class="row">
	<div class="col-md-12">
    	<div class="page-subtitle">
            <i class="fa fa-square-o pull-left text-info"></i>
            <h3><?php echo lang( "chart_file:usg_subtitle" ) ?></h3>
            <p><?php echo lang( "chart_file:usg_helper" ) ?></p>
        </div>
        <div class="row">
        	<div class="col-md-12">
				<?php echo form_open_multipart(current_url(), array('id' => 'form_files_chart_usg', 'name' => 'form_files_chart_usg')); ?>
                <div class="form-group">
                    <div class="col-md-12">
                    	<?php if( @$item->file_name ): ?>
                        <a id="file_chart_usg_thumbnail" href="javascript:;" class="thumbnail">
							<img id="file_chart_usg_img" src="<?php echo base_url( "resource/patients/ultrasonography" ) ?>/<?php echo @$item->file_name ?><?php echo (sprintf("?rand=%s", @time())) ?>">
                        </a>
                        <?php else: ?>
                        <a id="file_chart_usg_thumbnail" href="javascript:;" class="thumbnail">
                        	<img id="file_chart_usg_img" src="<?php echo base_url( "resource/patients/ultrasonography" ) ?>/default_picture.jpg">
                        </a>
						<?php endif ?>
                    </div>
                    <div class="col-md-6">
...
;(function( $ ){
		$.fn.extend({
				form_files_chart_usg: function( remote_server ){
		...
		$( document ).ready(function(e) {
            	$( "form[name=\"form_files_chart_usg\"]" )
					.form_files_chart_usg( "<?php echo @$update_action ?>" );
        	});
	})( jQuery );
//]]>
</script>
