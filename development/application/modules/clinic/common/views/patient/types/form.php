...
<div class="form-group">
    <label class="col-lg-3 control-label"><?php echo lang('patient_types:code_label') ?> <span class="text-danger">*</span></label>
    <div class="col-lg-6">
        <input type="text" id="code" name="f[code]" value="<?php echo @$item->code ?>" placeholder="" class="form-control" required>
    </div>
</div>
<div class="form-group">
    <label class="col-lg-3 control-label"><?php echo lang('patient_types:type_label') ?> <span class="text-danger">*</span></label>
    <div class="col-lg-6">
        <input type="text" id="type_name" name="f[type_name]" value="<?php echo @$item->type_name ?>" placeholder="" class="form-control" required>
    </div>
</div>
<div class="form-group">
    <label class="col-lg-3 control-label"><?php echo lang('patient_types:description_label') ?></label>
    <div class="col-lg-6">
        <textarea id="type_description" name="f[type_description]" placeholder="" wrap="virtual" class="form-control"><?php echo @$item->type_description ?></textarea>
    </div>
</div>
<div class="form-group">
