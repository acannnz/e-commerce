...
<div class="page-subtitle">
    ...
    <h3 class="text-primary"><?php echo lang('suppliers:general_subtitle') ?></h3>
	<p><?php echo lang('suppliers:general_subtitle_helper') ?></p>
</div>
<div class="form-group-one-unit margin-bottom-30">
    <div class="row">
        <div class="col-md-4">
            <div class="form-group form-group-custom">
            	<label class="control-label"><?php echo lang('suppliers:mr_number_label') ?> <span class="text-danger">*</span></label>
        ...
        <div class="col-md-4">
            <div class="form-group form-group-custom">
            	<label class="control-label"><?php echo lang('suppliers:type_label') ?> <span class="text-danger">*</span></label>
                <div class="form-control-clear-wrap">
                    <?php echo form_dropdown(
                            'f[type_id]', 
                            (array(0 => lang('suppliers:type_no_select')) + $options_type), 
                            @$item->type_id, 
        ...
        <div class="col-md-4">
            <div class="form-group form-group-custom">
                <label class="control-label"><?php echo lang('suppliers:state_label')?></label>
                <div class="form-control-clear-wrap">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="form-group form-group-custom form-control-clear">
                <label class="control-label"><?php echo lang('suppliers:name_label') ?> <span class="text-danger">*</span></label>
                <div class="form-control-clear-wrap">
    ...
    <div class="row">
        <div class="col-md-8">
            <div class="form-group form-group-custom">
                <label class="control-label"><?php echo lang('suppliers:referrer_label') ?></label>
        ...
        <div class="col-md-4">
            <div class="form-group form-group-custom">
                <label class="control-label"><?php echo lang('suppliers:is_member_label') ?></label>
                <div class="form-control-clear-wrap">
                    <div class="radio radio-inline">
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="form-group form-group-custom form-control-clear">
                <label class="control-label"><?php echo lang('suppliers:birth_date_label') ?></label>
                <div class="form-control-clear-wrap">
        ...
        <div class="col-md-2">
            <div class="form-group form-group-custom">
                <label class="control-label"><?php echo lang('suppliers:gender_label') ?></label>
                <div class="form-control-clear-wrap">
                    <div class="radio radio-inline">
        ...
        <div class="col-md-2">
            <div class="form-group form-group-custom">
                <label class="control-label"><?php echo lang('suppliers:age_label') ?></label>
                <div class="form-control-clear-wrap">
        ...
        <div class="col-md-4">
            <div class="form-group form-group-custom">
                <label class="control-label"><?php echo lang('suppliers:nationality_label') ?></label>
                <div class="form-control-clear-wrap">
					<?php echo form_dropdown(
                            'f[personal_nationality]', 
                            (array(0 => lang('suppliers:nationality_no_select')) + $options_nationality), 
...
<div class="page-subtitle">
    ...
    <h3 class="text-primary"><?php echo lang('suppliers:address_subtitle') ?></h3>
	<p><?php echo lang('suppliers:address_subtitle_helper') ?></p>
</div>
<div class="form-group-one-unit margin-bottom-30">
    <div class="row">
        <div class="col-md-12">
            <div class="form-group form-group-custom form-control-clear">
                <label class="control-label"><?php echo lang('suppliers:address_label') ?></label>
                <div class="form-control-clear-wrap">
                    ...
                    <?php /*?><textarea id="personal_address" name="f[personal_address]" placeholder="" wrap="virtual"../Copy of suppliers/ class="form-control"><?php echo @$item->personal_address ?></textarea><?php */?>
            	</div>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="form-group form-group-custom">
                <label class="control-label"><?php echo lang('suppliers:country_label') ?></label>
                <?php echo form_dropdown(
                        'f[country_id]', 
                        (array(0 => lang('suppliers:country_no_select')) + $options_country), 
                        @$item->country_id, 
        ...
        <div class="col-md-4">
            <div class="form-group form-group-custom">
                <label class="control-label"><?php echo lang('suppliers:province_label') ?></label>
                <div class="form-control-clear-wrap">
					<?php echo form_dropdown(
                            'f[province_id]', 
                            (array(0 => lang('suppliers:province_no_select')) + $options_province), 
                            @$item->province_id, 
        ...
        <div class="col-md-4">
            <div class="form-group form-group-custom">
                <label class="control-label"><?php echo lang('suppliers:county_label') ?></label>
                <div class="form-control-clear-wrap">
					<?php echo form_dropdown(
                            'f[county_id]', 
                            (array(0 => lang('suppliers:county_no_select')) + $options_county), 
                            @$item->county_id, 
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="form-group form-group-custom">
                <label class="control-label"><?php echo lang('suppliers:district_label') ?></label>
                <div class="form-control-clear-wrap">
					<?php echo form_dropdown(
                            'f[district_id]', 
                            (array(0 => lang('suppliers:district_no_select')) + $options_district), 
                            @$item->district_id, 
        ...
        <div class="col-md-8">
            <div class="form-group form-group-custom">
                <label class="control-label"><?php echo lang('suppliers:area_label') ?></label>
                <div class="form-control-clear-wrap">
					<?php echo form_dropdown(
                            'f[area_id]', 
                            (array(0 => lang('suppliers:area_no_select')) + $options_area), 
                            @$item->area_id, 
...
<div class="page-subtitle">
    ...
    <h3 class="text-primary"><?php echo lang('suppliers:contact_subtitle') ?></h3>
	<p><?php echo lang('suppliers:contact_subtitle_helper') ?></p>
</div>
<div class="form-group-one-unit margin-bottom-30">
    <div class="row">
        <div class="col-md-4">
            <div class="form-group form-group-custom form-control-clear">
                <label class="control-label"><?php echo lang('suppliers:phone_label') ?></label>
                <div class="form-control-clear-wrap">
        ...
        <div class="col-md-4">
            <div class="form-group form-group-custom form-control-clear">
                <label class="control-label"><?php echo lang('suppliers:email_label') ?></label>
                <div class="form-control-clear-wrap">
        ...
        <div class="col-md-4">
            <div class="form-group form-group-custom form-control-clear">
                <label class="control-label"><?php echo lang('suppliers:profession_label') ?></label>
                <div class="form-control-clear-wrap">
...
;(function( $ ){
		...
		$( document ).ready(function(){
				...
				$("#lookup_referrer").on("click", function( e ){					
					lookup_ajax_modal.show('<?php echo base_url("common/suppliers/lookup_referrer")?>')
				});
