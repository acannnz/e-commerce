...
<div class="table-responsive">
    <table id="dt-lookup-common-discount" class="table table-sm table-bordered table-striped" width="100%">
        <thead>
            <tr>
                <th></th>
                <th>ID Diskon</th>
...
(function( $ ){
		$.fn.extend({
				DT_Lookup_CommonDiscount: function(){
						var _this = this;
						...
						var _datatable = _this.DataTable( {
							...
							//scrollY: "200px",
							ajax: {
									url: "<?php echo base_url("common/discounts/datatable_collection") ?>",
									type: "POST",
		...
		var _datatable = $( "#dt-lookup-common-discount" ).DT_Lookup_CommonDiscount();
