...
<div class="page-subtitle">
    ...
    <h3 class="text-primary"><?php echo lang('customer_cooperations:general_subtitle') ?></h3>
	<p><?php echo lang('customer_cooperations:general_subtitle_helper') ?></p>
</div>
<div class="form-group-one-unit margin-bottom-30">
    <div class="row">
        <div class="col-md-4">
            <div class="form-group form-group-custom">
            	<label class="control-label"><?php echo lang('customer_cooperations:mr_number_label') ?> <span class="text-danger">*</span></label>
        ...
        <div class="col-md-4">
            <div class="form-group form-group-custom">
            	<label class="control-label"><?php echo lang('customer_cooperations:type_label') ?> <span class="text-danger">*</span></label>
                <div class="form-control-clear-wrap">
                    <?php echo form_dropdown(
                            'f[type_id]', 
                            (array(0 => lang('customer_cooperations:type_no_select')) + $options_type), 
                            @$item->type_id, 
        ...
        <div class="col-md-4">
            <div class="form-group form-group-custom">
                <label class="control-label"><?php echo lang('customer_cooperations:state_label')?></label>
                <div class="form-control-clear-wrap">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="form-group form-group-custom form-control-clear">
                <label class="control-label"><?php echo lang('customer_cooperations:name_label') ?> <span class="text-danger">*</span></label>
                <div class="form-control-clear-wrap">
    ...
    <div class="row">
        <div class="col-md-8">
            <div class="form-group form-group-custom">
                <label class="control-label"><?php echo lang('customer_cooperations:referrer_label') ?></label>
        ...
        <div class="col-md-4">
            <div class="form-group form-group-custom">
                <label class="control-label"><?php echo lang('customer_cooperations:is_member_label') ?></label>
                <div class="form-control-clear-wrap">
                    <div class="radio radio-inline">
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="form-group form-group-custom form-control-clear">
                <label class="control-label"><?php echo lang('customer_cooperations:birth_date_label') ?></label>
                <div class="form-control-clear-wrap">
        ...
        <div class="col-md-2">
            <div class="form-group form-group-custom">
                <label class="control-label"><?php echo lang('customer_cooperations:gender_label') ?></label>
                <div class="form-control-clear-wrap">
                    <div class="radio radio-inline">
        ...
        <div class="col-md-2">
            <div class="form-group form-group-custom">
                <label class="control-label"><?php echo lang('customer_cooperations:age_label') ?></label>
                <div class="form-control-clear-wrap">
        ...
        <div class="col-md-4">
            <div class="form-group form-group-custom">
                <label class="control-label"><?php echo lang('customer_cooperations:nationality_label') ?></label>
                <div class="form-control-clear-wrap">
					<?php echo form_dropdown(
                            'f[personal_nationality]', 
                            (array(0 => lang('customer_cooperations:nationality_no_select')) + $options_nationality), 
...
<div class="page-subtitle">
    ...
    <h3 class="text-primary"><?php echo lang('customer_cooperations:address_subtitle') ?></h3>
	<p><?php echo lang('customer_cooperations:address_subtitle_helper') ?></p>
</div>
<div class="form-group-one-unit margin-bottom-30">
    <div class="row">
        <div class="col-md-12">
            <div class="form-group form-group-custom form-control-clear">
                <label class="control-label"><?php echo lang('customer_cooperations:address_label') ?></label>
                <div class="form-control-clear-wrap">
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="form-group form-group-custom">
                <label class="control-label"><?php echo lang('customer_cooperations:country_label') ?></label>
                <?php echo form_dropdown(
                        'f[country_id]', 
                        (array(0 => lang('customer_cooperations:country_no_select')) + $options_country), 
                        @$item->country_id, 
        ...
        <div class="col-md-4">
            <div class="form-group form-group-custom">
                <label class="control-label"><?php echo lang('customer_cooperations:province_label') ?></label>
                <div class="form-control-clear-wrap">
					<?php echo form_dropdown(
                            'f[province_id]', 
                            (array(0 => lang('customer_cooperations:province_no_select')) + $options_province), 
                            @$item->province_id, 
        ...
        <div class="col-md-4">
            <div class="form-group form-group-custom">
                <label class="control-label"><?php echo lang('customer_cooperations:county_label') ?></label>
                <div class="form-control-clear-wrap">
					<?php echo form_dropdown(
                            'f[county_id]', 
                            (array(0 => lang('customer_cooperations:county_no_select')) + $options_county), 
                            @$item->county_id, 
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="form-group form-group-custom">
                <label class="control-label"><?php echo lang('customer_cooperations:district_label') ?></label>
                <div class="form-control-clear-wrap">
					<?php echo form_dropdown(
                            'f[district_id]', 
                            (array(0 => lang('customer_cooperations:district_no_select')) + $options_district), 
                            @$item->district_id, 
        ...
        <div class="col-md-8">
            <div class="form-group form-group-custom">
                <label class="control-label"><?php echo lang('customer_cooperations:area_label') ?></label>
                <div class="form-control-clear-wrap">
					<?php echo form_dropdown(
                            'f[area_id]', 
                            (array(0 => lang('customer_cooperations:area_no_select')) + $options_area), 
                            @$item->area_id, 
...
<div class="page-subtitle">
    ...
    <h3 class="text-primary"><?php echo lang('customer_cooperations:contact_subtitle') ?></h3>
	<p><?php echo lang('customer_cooperations:contact_subtitle_helper') ?></p>
</div>
<div class="form-group-one-unit margin-bottom-30">
    <div class="row">
        <div class="col-md-4">
            <div class="form-group form-group-custom form-control-clear">
                <label class="control-label"><?php echo lang('customer_cooperations:phone_label') ?></label>
                <div class="form-control-clear-wrap">
        ...
        <div class="col-md-4">
            <div class="form-group form-group-custom form-control-clear">
                <label class="control-label"><?php echo lang('customer_cooperations:email_label') ?></label>
                <div class="form-control-clear-wrap">
        ...
        <div class="col-md-4">
            <div class="form-group form-group-custom form-control-clear">
                <label class="control-label"><?php echo lang('customer_cooperations:profession_label') ?></label>
                <div class="form-control-clear-wrap">
...
;(function( $ ){
		...
		$( document ).ready(function(){
				...
				$("#lookup_referrer").on("click", function( e ){					
					lookup_ajax_modal.show('<?php echo base_url("common/customer_cooperations/lookup_referrer")?>')
				});
