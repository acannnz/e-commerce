...
<div class="page-subtitle">
    ...
    <h3 class="text-primary"><?php echo lang('sections:general_subtitle') ?></h3>
	<p><?php echo lang('sections:general_subtitle_helper') ?></p>
</div>
<div class="form-group-one-unit margin-bottom-30">
    <div class="row">
        <div class="col-md-4">
            <div class="form-group form-group-custom">
            	<label class="control-label"><?php echo lang('sections:mr_number_label') ?> <span class="text-danger">*</span></label>
        ...
        <div class="col-md-4">
            <div class="form-group form-group-custom">
            	<label class="control-label"><?php echo lang('sections:type_label') ?> <span class="text-danger">*</span></label>
                <div class="form-control-clear-wrap">
                    <?php echo form_dropdown(
                            'f[type_id]', 
                            (array(0 => lang('sections:type_no_select')) + $options_type), 
                            @$item->type_id, 
        ...
        <div class="col-md-4">
            <div class="form-group form-group-custom">
                <label class="control-label"><?php echo lang('sections:state_label')?></label>
                <div class="form-control-clear-wrap">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="form-group form-group-custom form-control-clear">
                <label class="control-label"><?php echo lang('sections:name_label') ?> <span class="text-danger">*</span></label>
                <div class="form-control-clear-wrap">
    ...
    <div class="row">
        <div class="col-md-8">
            <div class="form-group form-group-custom">
                <label class="control-label"><?php echo lang('sections:referrer_label') ?></label>
        ...
        <div class="col-md-4">
            <div class="form-group form-group-custom">
                <label class="control-label"><?php echo lang('sections:is_member_label') ?></label>
                <div class="form-control-clear-wrap">
                    <div class="radio radio-inline">
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="form-group form-group-custom form-control-clear">
                <label class="control-label"><?php echo lang('sections:birth_date_label') ?></label>
                <div class="form-control-clear-wrap">
        ...
        <div class="col-md-2">
            <div class="form-group form-group-custom">
                <label class="control-label"><?php echo lang('sections:gender_label') ?></label>
                <div class="form-control-clear-wrap">
                    <div class="radio radio-inline">
        ...
        <div class="col-md-2">
            <div class="form-group form-group-custom">
                <label class="control-label"><?php echo lang('sections:age_label') ?></label>
                <div class="form-control-clear-wrap">
        ...
        <div class="col-md-4">
            <div class="form-group form-group-custom">
                <label class="control-label"><?php echo lang('sections:nationality_label') ?></label>
                <div class="form-control-clear-wrap">
					<?php echo form_dropdown(
                            'f[personal_nationality]', 
                            (array(0 => lang('sections:nationality_no_select')) + $options_nationality), 
...
<div class="page-subtitle">
    ...
    <h3 class="text-primary"><?php echo lang('sections:address_subtitle') ?></h3>
	<p><?php echo lang('sections:address_subtitle_helper') ?></p>
</div>
<div class="form-group-one-unit margin-bottom-30">
    <div class="row">
        <div class="col-md-12">
            <div class="form-group form-group-custom form-control-clear">
                <label class="control-label"><?php echo lang('sections:address_label') ?></label>
                <div class="form-control-clear-wrap">
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="form-group form-group-custom">
                <label class="control-label"><?php echo lang('sections:country_label') ?></label>
                <?php echo form_dropdown(
                        'f[country_id]', 
                        (array(0 => lang('sections:country_no_select')) + $options_country), 
                        @$item->country_id, 
        ...
        <div class="col-md-4">
            <div class="form-group form-group-custom">
                <label class="control-label"><?php echo lang('sections:province_label') ?></label>
                <div class="form-control-clear-wrap">
					<?php echo form_dropdown(
                            'f[province_id]', 
                            (array(0 => lang('sections:province_no_select')) + $options_province), 
                            @$item->province_id, 
        ...
        <div class="col-md-4">
            <div class="form-group form-group-custom">
                <label class="control-label"><?php echo lang('sections:county_label') ?></label>
                <div class="form-control-clear-wrap">
					<?php echo form_dropdown(
                            'f[county_id]', 
                            (array(0 => lang('sections:county_no_select')) + $options_county), 
                            @$item->county_id, 
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="form-group form-group-custom">
                <label class="control-label"><?php echo lang('sections:district_label') ?></label>
                <div class="form-control-clear-wrap">
					<?php echo form_dropdown(
                            'f[district_id]', 
                            (array(0 => lang('sections:district_no_select')) + $options_district), 
                            @$item->district_id, 
        ...
        <div class="col-md-8">
            <div class="form-group form-group-custom">
                <label class="control-label"><?php echo lang('sections:area_label') ?></label>
                <div class="form-control-clear-wrap">
					<?php echo form_dropdown(
                            'f[area_id]', 
                            (array(0 => lang('sections:area_no_select')) + $options_area), 
                            @$item->area_id, 
...
<div class="page-subtitle">
    ...
    <h3 class="text-primary"><?php echo lang('sections:contact_subtitle') ?></h3>
	<p><?php echo lang('sections:contact_subtitle_helper') ?></p>
</div>
<div class="form-group-one-unit margin-bottom-30">
    <div class="row">
        <div class="col-md-4">
            <div class="form-group form-group-custom form-control-clear">
                <label class="control-label"><?php echo lang('sections:phone_label') ?></label>
                <div class="form-control-clear-wrap">
        ...
        <div class="col-md-4">
            <div class="form-group form-group-custom form-control-clear">
                <label class="control-label"><?php echo lang('sections:email_label') ?></label>
                <div class="form-control-clear-wrap">
        ...
        <div class="col-md-4">
            <div class="form-group form-group-custom form-control-clear">
                <label class="control-label"><?php echo lang('sections:profession_label') ?></label>
                <div class="form-control-clear-wrap">
...
;(function( $ ){
		...
		$( document ).ready(function(){
				...
				$("#lookup_referrer").on("click", function( e ){					
					lookup_ajax_modal.show('<?php echo base_url("common/sections/lookup_referrer")?>')
				});
