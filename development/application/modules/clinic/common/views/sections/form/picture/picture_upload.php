...
<div class="row">
    <div class="col-md-12">
        <?php echo form_open_multipart( @$upload_action, array('id' => 'form_upload_personal_picture', 'name' => 'form_upload_personal_picture', 'class' => 'drop-box text-center')); ?>
...
<div class="row">
    <div class="col-md-12">
        ...
        <a href="<?php echo @$picture_action ?>" data-toggle="ajax-modal" title="<?php echo lang("buttons:cancel") ?>" class="btn btn-block btn-cancel btn-danger"><i class="fa fa-times"></i> <?php echo lang("buttons:cancel") ?></a>
        <?php else: ?>
        <a href="<?php echo @$picture_action ?>" title="<?php echo lang("buttons:cancel") ?>" class="btn btn-block btn-cancel btn-danger"><i class="fa fa-times"></i> <?php echo lang("buttons:cancel") ?></a>
        <?php endif ?>
    </div>
</div>
...
;(function( $ ){
		...
		$.fn.extend({
				form_upload_personal_picture: function( remote_server ){
						...
						var show_files = function( files ){
							...
							uploaded_files = function( files ){
									try{
										<?php if( isset($is_ajax_request) ): ?>
										try{ ajax_modal.show( "<?php echo $success_action ?>" ); } catch(e){ /**/ }
										<?php else: ?>
										window.location = "<?php echo $success_action ?>";
										<?php endif ?>
									} catch(ex){}
								};
		...
		$( document ).ready(function(e) {
            	$( "form[name=\"form_upload_personal_picture\"]" )
					.form_upload_personal_picture( "<?php echo @$upload_action ?>" );
        	});
	})( jQuery );
//]]>
</script>
