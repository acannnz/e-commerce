...
<div class="table-responsive">
    <table id="dt-lookup-common-customers" class="table table-bordered table-striped" width="100%">
        <thead>
            <tr>
                <th></th>
...
(function( $ ){
		$.fn.extend({
				DT_Lookup_CommonCustomers: function(){
						var _this = this;
						...
						var _datatable = _this.DataTable( {
							...
							//scrollY: "200px",
							ajax: {
									url: "<?php echo base_url("common/customers/lookup_collection") ?>",
									type: "POST",
		...
		var _datatable = $( "#dt-lookup-common-customers" ).DT_Lookup_CommonCustomers();
