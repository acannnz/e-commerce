...
<div class="form-group">
    <label class="col-lg-3 control-label"><?php echo lang('zones:area_label') ?> <span class="text-danger">*</span></label>
    <div class="col-lg-6">
...
<div class="form-group">
    <label class="col-lg-3 control-label"><?php echo lang('zones:county_label') ?> <span class="text-danger">*</span></label>
    <div class="col-lg-6">
        <?php echo form_dropdown(
					'', 
					(array(0 => lang('zones:county_no_select')) + $options_county), 
					@$county_id, 
...
<div class="form-group">
    <label class="col-lg-3 control-label"><?php echo lang('zones:district_label') ?> <span class="text-danger">*</span></label>
    <div class="col-lg-6">
        <?php echo form_dropdown(
					'f[parent_id]', 
					(array(0 => lang('zones:district_no_select')) + $options_district), 
					@$item->parent_id, 
