                    ...
                    <div class="panel-body">
                        ...
                        <div class="tab-content">
                            <div id="service-tab1" class="tab-pane tab-pane-padding active">
                                <?php echo modules::run("{$nameroutes}/polies/service_polies/service_component", @$indexRow ) ?>
                            </div>
                            <div id="service-tab2" class="tab-pane tab-pane-padding">
                                <?php echo modules::run("{$nameroutes}/polies/service_polies/service_consumable", @$indexRow ) ?>
                            </div>
                        </div>
                    </div>
                </div>
