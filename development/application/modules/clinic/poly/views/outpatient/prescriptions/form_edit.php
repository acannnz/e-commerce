                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" id="prescriptionDoctorName" name="prescriptionDoctorName" class="form-control" value="<?php echo @$item->Nama_Supplier ?>" readonly />
            ...
            calculate_balance: function() {
                try {
                    ...
                    table_data.each(function(value, index) {
                        ...
                        Jumlah = mask_number.currency_ceil(Jumlah + parseFloat(value.Harga_Satuan) * value.Qty + value.BiayaResep);
