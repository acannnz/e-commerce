				...
				<div class="col-md-12">
					<div class="form-group">
						<div class="page-subtitle" style="margin-bottom: 0px!important;">
							...
							<h3 class="text-info">Dokter Obgyn</h3>
						</div>
					</div>
				</div>
				<div class="col-md-6">
					<div class="form-group">
						<label>HPHT</label>
						<input type="text" id="Hpht" name="v[Hpht]" value="<?php echo @$vital->Hpht ?>" placeholder="" class="form-control">
					</div>
				</div>
				<div class="col-md-6">
					<div class="form-group">
						<label>RIWAYAT MENSTRUASI</label>
						<input type="text" id="Rwt_Menstruasi" name="v[Rwt_Menstruasi]" value="<?php echo @$vital->Rwt_Menstruasi ?>" placeholder="" class="form-control">
					</div>
				</div>
				<div class="col-md-6">
					<div class="form-group">
						<label>RIWAYAT KEHAMILAN</label>
						<input type="text" id="Rwt_Kehamilan" name="v[Rwt_Kehamilan]" value="<?php echo @$vital->Rwt_Kehamilan ?>" placeholder="" class="form-control">
					</div>
				</div>
				<div class="col-md-6">
					<div class="form-group">
						<label>RIWAYAT PERSALINAN SEBELUMNYA</label>
						<input type="text" id="Rwt_Persalinan_Sebelumnya" name="v[Rwt_Persalinan_Sebelumnya]" value="<?php echo @$vital->Rwt_Persalinan_Sebelumnya ?>" placeholder="" class="form-control">
					</div>
				</div>
				<div class="col-md-6">
					<div class="form-group">
						<label>RIWAYAT KB</label>
						<input type="text" id="Rwt_KB" name="v[Rwt_KB]" value="<?php echo @$vital->Rwt_KB ?>" placeholder="" class="form-control">
					</div>
				</div>
			</div>
		</div>
			...
			<div class="col-md-12">
				<div class="col-md-12">
					<div class="form-group">
						<div class="page-subtitle" style="margin-bottom: 0px!important;">
							<i class="fa fa-stethoscope pull-left text-info" style="font-size: 25px!important;"></i>
							<h3 class="text-info">Status Lokalis</h3>
						</div>
					</div>
				</div>
				<div class="col-md-12">
					<div class="form-group">
						...
						<input type="text" id="StatusLokalis" name="v[StatusLokalis]" value="<?php echo @$vital->StatusLokalis ?>" placeholder="" class="form-control">
					</div>
				</div>
			</div>
		</div> -->
...
- HPHT : ${Hpht}
- Riwayat Menstruasi : ${Rwt_Menstruasi}
- Riwayat Kehamilan : ${Rwt_Kehamilan}
- Riwayat Persalinan Sebelumnya : ${Rwt_Persalinan_Sebelumnya}
- Riwayat KB : ${Rwt_KB}
