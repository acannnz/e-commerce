...
class Nurse extends Admin_Controller
{
	...
	protected $nameroutes = 'poly/inpatients/nurse';
	...
	{
		$data = array(
				"collection" => $this->poly_m->get_nurse( array("NoBukti" => @$item->NoBukti ), $is_edit ),
				"form" => TRUE,
				'datatables' => TRUE,
		...
		$this->load->view( 'inpatient/form/nurses', $data );		
	}
	...
	public function lookup_nurse( $is_ajax_request=false )
	{
		...
		{
			$this->load->view( 'inpatient/lookup/nurses' );
		} 
	}
