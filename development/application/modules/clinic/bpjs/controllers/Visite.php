...
class Visite extends ADMIN_Controller
{
	...
	public function checkout($NoReg)
	{
		...
		$this->data['datas'] = bpjs_helper::get_registration_outpatient($NoReg);
		// $this->data['data'] = bpjs_helper::get_registration_outpatient($NoReg);
		// var_dump($this->data['data']->NoReg);
		// exit;
