...
<div class="modal-body">
    ...
    function lookupbox_row_selected( response ){
        ...
        if( _response ){
            ...
            try {
                ...
                $("#KodeICDBPJS").val( _response.kdDiag );
	...
	<div class="table-responsive">
		<table id="dt-icd-bpjs" class="table table-sm table-bordered table-hover" width="100%">
			<thead>
				<tr>
					<th></th>
					<th><?php echo lang('label:code') ?></th>
					<th><?php echo lang('label:name') ?></th>
					<th><?php echo lang('label:non_specialist') ?></th>
				</tr>
			</thead>
			<tbody>
			</tbody>
	...
	(function( $ ){
			$.fn.extend({
					dataTableInit: function(){
							...
							var _datatable = _this.DataTable( {
								...
								scrollCollapse: true,
								ajax: {
										url: "<?php echo config_item('bpjs_api_baseurl')."/diagnosa/a/1000000" ?>",
										type: "GET",
			...
			var _datatable = $( "#dt-icd-bpjs" ).dataTableInit();
			...
			$('#dt-icd-bpjs').on( 'page.dt', function (e) {
