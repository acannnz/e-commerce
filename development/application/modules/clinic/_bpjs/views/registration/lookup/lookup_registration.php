...
<div class="modal-body">
	...
	<div class="table-responsive">
		<table id="dt-registration-bpjs" class="table table-sm table-bordered table-hover" width="100%">
			<thead>
				<tr>
					<th></th>
	...
	(function( $ ){
			...
			var _datatable = $( "#dt-registration-bpjs" ).dataTableInit();
			...
			$('#dt-registration-bpjs').on( 'page.dt', function () {
