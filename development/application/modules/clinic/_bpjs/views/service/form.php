...
<div class="form-group">
	<?php echo form_label(lang('label:code_bpjs'), 'JasaIDBPJS', ['class' => 'control-label col-md-3']) ?>
	<div class="col-md-9">
		<div class="input-group">
			<?php echo form_input([
						'type' => 'text',
						'name' => 'f[JasaIDBPJS]',
						'value' => set_value('f[JasaIDBPJS]', @$mapping->code, TRUE),
						'id' => 'JasaIDBPJS',
			...
			<span class="input-group-btn">
				...
				<a href="javascript:;" data-target-class="service_bpjs"  class="btn btn-default btn-clear-bpjs" ><i class="fa fa-times"></i></a>
			</span>
		</div>
	</div>
</div>
