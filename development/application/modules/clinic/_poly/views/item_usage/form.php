...
<div class="panel panel-info">
	<div class="panel-heading">
		<h3 class="panel-title"><?php echo 'Buat Pemakain Barang Baru' ?></h3>
	</div>
	<div class="panel-body">
		<div class="row">
			...
			<div class="col-md-6">
				<div class="form-group">
					...
					<div class="col-lg-9">
						...
						<input type="text" id="SectionName" name="f[SectionName]" value="<?php echo @$section->SectionName ?>" class="form-control" readonly>
					</div>
				</div>
				<div class="form-group">
			...
			<div class="col-md-12">
				<div class="page-subtitle">
					<h3 class="text-primary"><i class="fa fa-cubes"></i> Detail Barang</h3>
				</div>
			</div>
			<div class="col-md-12">
				<div class="form-group">				
		...
		<div class="form-group text-right">
			...
			<a href="<?php echo $create_url ?>" class="btn btn-default"><b><i class="fa fa-plus"></i> <?php echo lang("buttons:create") ?></b></a>
				...
				$("#form_item_usage").on("submit", function(e){
					...
					$.post( $(this).prop("action"), data_post, function( response, status, xhr ){
						...
						setTimeout(function(){
							...
							document.location.href = "<?php echo base_url("poly/item-usage/view/{$type}"); ?>/"+ response.NoBukti;
