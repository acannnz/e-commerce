...
(function( $ ){
		...
		var ListHargaID = service.ListHargaID;
		...
		var _datatable_actions = {
				...
				calculate_balance: function(){
					...
					console.log(total);
					$("#Tariff").val(Number(total).toFixed(2));
		...
		$( document ).ready(function(e) {
				...
				{
					service.component_temp = <?php print_r(json_encode(@$collection, JSON_NUMERIC_CHECK));?>;
				}

            	$("#dt_service_component" ).dt_service_component();
				$("#dt_service_component").DataTable().clear().draw();
				$("#dt_service_component").DataTable().rows.add( service.component_temp ).draw();
