			...
			function lookupbox_row_selected( response ){
				...
				if( _response ){
					...
					try {					
							...
							if ( _response.PasienBaru == 1 ) $("#PasienBaru").prop("checked", true);
							...
							$("#TglLahir").val( _response.TanggalLahir.substr(0, 10) );

							age = getAge( _response.TanggalLahir.substr(0, 10) );
