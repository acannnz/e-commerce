            ...
            <div class="row form-group">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <input type="text" id="Tariff" name="Tariff" class="form-control mask-number"  readonly="readonly" />
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="panel-body">
                        ...
                        <div class="tab-content">
                            <div id="service-tab1" class="tab-pane tab-pane-padding active">
                                <?php echo modules::run("{$nameroutes}s/service_outpatient/service_component", @$indexRow ) ?>
                            </div>
                            <div id="service-tab2" class="tab-pane tab-pane-padding">
                                <?php echo modules::run("{$nameroutes}s/service_outpatient/service_consumable", @$indexRow ) ?>
                            </div>
                        </div>
                    </div>
                </div>
...
(function( $ ){
		...
		$( document ).ready(function(e) {
			...
			$("#Tariff").val(mask_number.currency_add(data_service.Tarif));
		});
