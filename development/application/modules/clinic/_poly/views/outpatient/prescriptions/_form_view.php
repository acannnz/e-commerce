						...
						_datatable = _this.DataTable( {
								...
								columns: [
										...
										{ data: "Harga_Satuan", className: "text-right",
											render:function(val, type, row)
											{
												var Jumlah =  mask_number.currency_ceil(row.Harga_Satuan * Number(row.Qty))
												return mask_number.currency_add(Jumlah)
											}
										},
										
										{ data: "Stok", className: "text-center" },
										{ data: "BiayaResep", className: "text-right",
											render:function(val, data, row)
											{
