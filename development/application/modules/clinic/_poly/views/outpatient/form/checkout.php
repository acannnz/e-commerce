	...
	<div class="col-md-6">
			...
			<div id="PxKeluar_PulangOption"> <!--style="display:none"-->
				<div class="col-md-9">
					<div class="input-group">
						...
						<input type="text" id="TglCekUp" name="f[checkout]" value="<?php echo @$item->TindakLanjutCekUpUlang ? @$item->TglCekUp : NULL ?>" class="form-control datetimepicker" placeholder="Tanggal CheckUp Kembali" autocomplete="off">
		...
		<div class="form-group">
			...
			<div id="PxMeninggalOption" style="display:none">
				<div class="col-md-2">
					<div class="radio">
						<input type="radio" id="MeninggalSblm48" name="PxMeninggalOption" value="1" <?php echo @$item->MeninggalSblm48 == 1 ? "Checked" : NULL ?> class=""><label for="MeninggalSblm48">
							< 48 Jam</label>
					</div>
				</div>
				<div class="col-md-2">
	...
	(function($) {
		...
		var _datatable_actions = {
			...
			get_queue: function(params, scope) {
				...
				$.post("<?php echo $get_queue ?>", {
					"SectionID": params.Konsul_SectionID,
					"DokterID": params.Konsul_DOkterID,
		...
		$(document).ready(function(e) {
			...
			$('#TglCekUp').datetimepicker({
				format: 'YYYY-MM-DD HH:mm',
				// Tambahan konfigurasi lainnya jika diperlukan
			});
