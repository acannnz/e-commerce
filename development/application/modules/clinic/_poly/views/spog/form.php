...
<div class="panel panel-success">
	...
	<div class="panel-body">
		...
		<ul id="tab-poly" class="nav nav-tabs nav-justified">
			...
			<li><a href="#poly-tab3" data-toggle="tab"><i class="fa fa-user-o"></i> Perawat</a></li>
			...
			<li><a href="#poly-tab8" data-toggle="tab"><i class="fa fa-files-o"></i> Medical Record</a></li>
		...
		<div class="tab-content">
			...
			<div id="poly-tab2" class="tab-pane tab-pane-padding">
				<?php echo modules::run("{$nameroutes}/polies/service_polies/index", @$item, @$is_edit ) ?>
			</div>
			<div id="poly-tab3" class="tab-pane tab-pane-padding">
				<?php echo modules::run("{$nameroutes}/polies/nurse/index", @$item, @$is_edit ) ?>
			</div>
			...
			<div id="poly-tab8" class="tab-pane tab-pane-padding">
				<?php echo $this->load->view("{$viewroutes}/medical_record");?>
			</div>
...
<div class="form-group">
    <div class="col-lg-12 text-right">
    	<button type="submit" class="btn btn-primary" id="js-btn-submit"><?php echo lang( 'buttons:submit' ) ?></button>
		<?php if(@$is_edit):?>
				...
				$("form[name=\"form_poly\"]").on("submit", function(e){
					...
					try{
						...
						var rj = {
								...
								UmurKehamilan: $("#UmurKehamilan").val(),
								HariPertamaHaidTerakhir: $("#HariPertamaHaidTerakhir").val(),
								TekananDarah: $("#TekananDarah").val(),
								BeratBadan: $("#BeratBadan").val(),
								LingkarLengan: $("#LingkarLengan").val(),
								HB: $("#HB:checked").val() || 0,
								PPIA: $("#PPIA:checked").val() || 0,
								HBSAG: $("#HBSAG:checked").val() || 0,
								SPILIS: $("#SPILIS:checked").val() || 0,
								ImunisasiTD: $("#ImunisasiTD:checked").val() || 0,
								KunjunganTrisemester: $("#KunjunganTrisemester").val(),
								RiwayatPersalinan: $("#RiwayatPersalinan").val(),
								ResikoKehamilan: $("#ResikoKehamilan").val(),
								KomplikasiPersalinan: $("#KomplikasiPersalinan").val(),
							}
