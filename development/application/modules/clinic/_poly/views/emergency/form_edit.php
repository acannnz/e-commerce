...
<div class="row form-group">
	<div class="col-md-6">
        <div class="form-group">
        	...
        	<input type="hidden" id="PasienKTP" name="f[PasienKTP]" value="<?php echo @$item->PasienKTP ?>" />
				...
				$("form[name=\"form_poly\"]").on("submit", function(e){
					...
					try{
						...
						var rj = {
								...
								"Emergency" : $("#Emergency:checked").val() || 0,
						...
						{					
							...
							dt_services.each(function (value, index) {
								...
								if ( service_component_temp[ value.ListHargaID ] )
								{
									// service component
									$.each(service_component_temp[ value.ListHargaID ], function (key, val) {
										data_post['service_component'][key] = {
											"NoBukti" : $("#NoBukti").val(),
											"JasaID" : val.JasaID,
								...
								if ( service_consumable_temp[ value.JasaID ] )
								{
									...
									$.each(service_consumable_temp[ value.JasaID ], function (key, val) {
										data_post['service_consumable'][key] = {
											"NoBUkti" : $("#NoBukti").val(),
											"JasaID" : val.JasaID,
						...
						$.post($(this).attr("action"), data_post, function( response, status, xhr ){
							...
							setTimeout(function(){
								...
								document.location.href = "<?php echo base_url("{$nameroutes}/edit"); ?>/"+ NoBukti;
