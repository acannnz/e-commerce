...
class Service_outpatient extends Admin_Controller
{
	protected $_translation = 'poly';	
	protected $_model = 'poly_m';
	protected $nameroutes = 'poly/outpatients/service_outpatient';
	...
	public function index( $item = NULL, $is_edit = FALSE )
	{
		...
		$this->load->view( 'outpatient/form/service_outpatient', $data );		
	}
	...
	public function lookup_service( $is_ajax_request=false )
	{
		...
		{
			$this->load->view( 'outpatient/lookup/service_outpatient' );
		} 
	}
	...
	public function lookup_service_consumable( $is_ajax_request=false )
	{
		if( $this->input->is_ajax_request() || $is_ajax_request !== false )
		{
			$this->load->view( 'outpatient/service_outpatient/lookup/service_consumable' );
		} 
	}
	...
	public function item_view( $indexRow = NULL, $JasaID = NULL )
	{
		...
		{	
			...
			$this->load->view( 'outpatient/service_outpatient/form_detail', $data );
	...
	public function service_component( $indexRow = NULL )
	{
		...
		$this->load->view( 'outpatient/service_outpatient/table/service_component', $data );		
	}
	...
	public function service_consumable( $indexRow = NULL )
	{
		...
		$this->load->view( 'outpatient/service_outpatient/table/service_consumable', $data );		
	}			
