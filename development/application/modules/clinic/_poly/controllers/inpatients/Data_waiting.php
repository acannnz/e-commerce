...
class Data_waiting extends Admin_Controller
{
	...
	protected $nameroutes = 'poly/inpatients/data_waiting';
	...
	public function index()
	{
		...
		$this->load->view('inpatient/datatable/waiting', $data);
	}
	...
	public function datatable_collection()
    {
		...
		$db_where['b.RawatInap'] = 1;
		$db_where['b.StatusPeriksa !='] = 'CO';
		$db_where['a.Batal'] = 0;		
		
		if ($this->input->post("date_from"))
		{
			$db_where['a.Tanggal >='] = $this->input->post("date_from");
			unset($db_where['b.StatusPeriksa !=']);
		}
