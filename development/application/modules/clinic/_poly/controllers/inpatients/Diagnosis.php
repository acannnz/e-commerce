...
class Diagnosis extends Admin_Controller
{
	...
	protected $nameroutes = 'poly/inpatients/diagnosis';
	...
	public function index( $NoReg = NULL )
	{
		$data = [
			"collection" => poly_helper::get_registration_diagnosis($NoReg),
			'nameroutes' => $this->nameroutes,
			"lookup_icd" => base_url("{$this->nameroutes}/lookup_icd")
		];

		$this->load->view( 'inpatient/form/diagnosis', $data );		
	}
	
	public function lookup_icd( $is_ajax_request=false )
	{
		if( $this->input->is_ajax_request() || $is_ajax_request !== false )
		{
			$this->load->view( 'inpatient/lookup/icd' );
		} 
	}
