...
class Memo extends Admin_Controller
{
	...
	{
		$data = array(
				"collection" => $this->poly_m->get_memo_data( array("NOReg" => !empty($item->NoReg) ? @$item->NoReg : @$item->RegNo ) ),
				"form" => TRUE,
				'datatables' => TRUE,
				'nameroutes' => $this->nameroutes,
				'create_memo' => base_url("{$this->nameroutes}/memo/item_create"),
				'delete_memo' => base_url("{$this->nameroutes}/memo/item_delete"),
				'view_memo' => base_url("{$this->nameroutes}/memo/item_view"),
			);

		$this->load->view( 'polies/form/memo', $data );		
	}
	...
	public function item_create()
	{
		...
		if( $this->input->is_ajax_request() )
		{
			...
			$this->load->view( 'polies/memo/form', $data );
		} 
	}
	...
	public function item_view( $NoUrut )
	{
		...
		if( $this->input->is_ajax_request() )
		{
			...
			$this->load->view( 'polies/memo/form_view', $data );
		} 
	}
}