...
EOSQL;
        ...
        {				
			...
			$HargaGrading = $this->db->query("Select * from GetHargaObatNew_WithStok($JenisKerjasamaID,'xx',1,$row->Barang_ID,$CustomerKerjasamaID,'". $section_pharmacy['section_id'] ."',0)")->row();					
