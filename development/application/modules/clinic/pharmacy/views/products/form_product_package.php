...
<div class="row form-group">
    <div class="col-md-6">
        <div class="form-group">
            ...
            <div class="col-md-9">
                <input type="text" id="KodePaket" name="f[KodePaket]" class="form-control" value="<?php echo @$item->KodePaket?>"  readonly="readonly" />
            </div>
        </div>
        <div class="form-group">
            <label class="control-label col-md-3">Nama Paket</label>
            <div class="col-md-9">
                <input type="text" id="NamaPaket" name="f[NamaPaket]" class="form-control" value="<?php echo @$item->NamaPaket ?>" />
            </div>
        </div>
        <div class="form-group">
				...
				$("form[id=\"form_product_package\"]").on("submit", function(e){
					...
					var data_post = { };
						data_post['f'] = {
							...
							"LastUpdate" : '<?php echo date("Y-m-d")?>',
							"Supplier_ID" : 0,
							"Puyer" : 0,
					...
					$.post($(this).attr("action"), data_post, function( response, status, xhr ){
						...
						setTimeout(function(){
							...
							document.location.href = "<?php echo base_url("pharmacy/products/product_package_edit"); ?>/"+ response.KodePaket;
