...
<div class="page-subtitle margin-bottom-20">
	<div class="row">
        ...
        <div class="col-md-6">
            <a href="<?php echo base_url("pharmacy/products/product_package_create") ?>" title="Tambah Paket Obat Baru" class="btn btn-success pull-right"><i class="fa fa-plus-circle"></i> <span>Tambah Paket Obat</span></a>
        </div>
	</div>
</div>
		...
		$.fn.extend({
				DataTable_Registrations: function(){
						...
						var _datatable = _this.DataTable( {
							...
							ajax: {
									url: "<?php echo base_url("pharmacy/products/datatable_product_package_collection") ?>",
									type: "POST",
									...
									{ 
										...
										render: function ( val, type, row ){
												var buttons = "<div class=\"btn-group pull-right\" role=\"group\">";
													buttons += "<a href=\"<?php echo base_url("pharmacy/products/product_package_edit") ?>/" + val + "\" title=\"<?php echo lang( "buttons:edit" ) ?>\" class=\"btn btn-default btn-xs\"> <i class=\"fa fa-pencil\"></i> <?php echo lang( "buttons:edit" ) ?> </a>";
