		...
		$.fn.extend({
				DataTable_DataCheckups: function(){
						...
						var _datatable = _this.DataTable( {
							...
							ajax: {
									url: "<?php echo base_url("pharmacy/pharmacies/data_close_bhp/datatable_collection") ?>",
									type: "POST",
							...
							columns: [
									...
									{ 
										data: "Realisasi_Farmasi", 
										class: "text-center", 
										render: function(val, type, row){
											if(row.Realisasi_Farmasi == 1){
												return '<span class="btn btn-success btn-xs">Sudah Realisasi</span>'
											}
											if(row.Batal == 1){
											...
											return '<span class="btn btn-default btn-xs">Sudah Bayar</span>'
										}
									},
									{ 
										data: "NoBukti",
										...
										render: function ( val, type, row ){
												var buttons = "<div class=\"btn-group pull-right\" role=\"group\">";
													buttons += "<a href=\"<?php echo base_url("pharmacy/selling_view_bhp") ?>/" + val + "\" title=\"Detail BHP\" class=\"btn btn-primary btn-xs\"><b><i class=\"fa fa-eye\"></i> Lihat</b></a>";
												buttons += "</div>";
