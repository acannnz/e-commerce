...
<div class="panel panel-info">
	<div class="panel-heading">
		<h3 class="panel-title">Realisasi BHP</h3>
	</div>
	<div class="panel-body">
		<div class="row">
			<div class="col-md-12">
				<div class="page-subtitle">
					<h3 class="text-primary">Data BHP Pasien</h3>
					<p>Informasi Data BHP Pasien</p>
				</div>
			</div>
				...
				<div class="form-group">
					...
					<div class="col-lg-9">
						<div class="input-group">
							...
							<span class="input-group-btn">
								<a href="<?php echo @$lookup_products_bhp ?>" id="lookup_products" data-toggle="lookup-ajax-modal" class="btn btn-default" ><i class="fa fa-search"></i> <sup>(f3)</sup></a>
		...
		<?php echo modules::run("pharmacy/pharmacies/details_bhp/index", @$item ) ?>
		<div class="form-group">
					...
					try{
						...
						dt_details.each(function (value, index) { 
							var detail = {
								...
								Satuan	: value.Satuan,
								Qty : value.JmlObat,
								Disc_Persen : value.Disc,
								Stok : value.Stok,
								HargaSatuan : value.Harga || 0,
                                Plafon : 0,
                                KomisiDokter : 0,
								...
								HExt : "0.00",
								Total : value.JmlObat * value.Harga,
							}
						...
						$.post($(this).attr("action"), data_post, function( response, status, xhr ){
							...
							setTimeout(function(){
								document.location.href = "<?php echo base_url("pharmacy/selling_view_bhp"); ?>/"+ NoBukti;								
							}, 300 );
