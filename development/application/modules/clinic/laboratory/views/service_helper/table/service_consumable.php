...
(function( $ ){
		...
		$( document ).ready(function(e) {
				...
				if ( $.isEmptyObject(service_selected.consumable_temp) )
				{
					...
					$.post("<?php echo $get_service_consumable ?>", data_post, function( response, status, xhr ){
						...
						if( response.collection ){
							...
							$("#dt_service_consumable").DataTable().rows.add(service_selected.consumable_temp).draw();				
						}
				...
				console.log("BHP: ", service_selected.consumable_temp);
