...
<div class="panel panel-info">
	<div class="panel-heading">
		<h3 class="panel-title"><?php echo 'Lihat Retur Mutasi' ?></h3>
		<ul class="panel-btn">
			<li><a href="<?php echo $create_url ?>" class="btn btn-info" title="Kelola Mutasi"><b><i class="fa fa-plus"></i> <?php echo 'Retur Mutasi Baru' ?></b></a></li>
		</ul>
	</div>
		...
		<div class="row">
			<div class="col-md-6">
				<div class="form-group">
					...
					<div class="col-lg-9">
						<input type="text" id="NoBukti" name="f[NoBukti]" value="<?php echo (!empty(@$item->NoBukti)) ? @$item->NoBukti : @$item->No_Bukti ?>" placeholder="" class="form-control" readonly>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-lg-9">
						<input type="text" id="tanggal" name="f[tanggal]" value="<?php echo (!empty(@$item->Tanggal)) ? @$item->Tanggal : @$item->Tgl_Mutasi ?>" placeholder="" class="form-control datepicker">
					</div>
				</div>
				<div class="form-group">
			...
			<div class="col-md-6">
				<div class="form-group">
					...
					<div class="col-lg-9">
						<input type="text" id="SectionName" name="f[SectionName]" value="<?php echo (!empty(@$section->SectionTujuan)) ? @$section->SectionTujuan : @$item->SectionTujuan ?>" placeholder="" class="form-control inquiry" readonly>
					</div>
				</div>
				<div class="form-group">
