...
class Detail_mutation_returns extends Admin_Controller
{
	...
	public function index( $item = NULL )
	{
		...
		$this->load->view( 'inquiries/form/detail_mutation_returns', $data );		
	}

	public function view( $item = NULL )
	{
		$data = array(
				"collection" => inquiry_helper::get_mutation_return_detail( $item->No_Bukti ),
			);
			
		$this->load->view( 'inquiries/form/view_detail_mutation_returns', $data );		
	}
