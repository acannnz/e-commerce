...
<div class="panel panel-info">
	<div class="panel-heading">
		<h3 class="panel-title"><?php echo lang('heading:clerk_create') ?></h3>
	</div>
	<div class="panel-body">
		<div class="row">
			...
			<div class="col-md-offset-3 col-md-6 col-sm-offset-3 col-sm-6 col-xs-12">
				<?php if(!isset($item->StatusClerk)):?>
				
					<div class="alert alert-danger">
						<h4><i class="fa fa-exclamation-circle"></i> Info...</h4>
						<?php echo lang('message:clerk_start')?>
					</div>
					<label>Jumlah Awal Uang Kasir</label>
					<?php echo form_input([
						'type' => 'text',
						'name' => 'JumlahAwalUangKasir',
						'id' => 'JumlahAwalUangKasir', 
						'placeholder' => 'Uang Awal Kasir',
					...
					<?php echo form_button([
						...
						'type' => 'submit',
						'content' => "<i class='fa fa-dot-circle-o fa-spin'></i> <b>". lang('label:clerk_start') ."</b>",
						'data-type' => 'start',
				...
				<?php else:?>
					...
					<div class="alert alert-success">
						...
						<?php echo ($item->StatusClerk == 0) ? lang('message:allowed_transaction') : ''?>
					</div>	
						...
						_form.on("submit", function(e){
							...
							if(_type == 'start'){
								var params = {f: {
										...
										JumlahAwalUangKasir: mask_number.currency_remove($('#JumlahAwalUangKasir').val())
									}};
							}else if (_type == 'end'){
