...
{ 
	...
	public function pay( $NoFarmasi = NULL )
	{
		...
		$pharmacy->JenisKerjasama = @$pharmacy->KerjasamaID;
		$pharmacy->TipePasien = $this->db->where("JenisKerjasamaID", $pharmacy->KerjasamaID)->get("SIMmJenisKerjasama")->row()->JenisKerjasama;
		...
		$item = (object) array(
			...
			'tipe' => 'OBAT BEBAS',
			'KodeCustomerPenjamin' => $pharmacy->KodePerusahaan
		);
	...
	public function view( $NoFarmasi = 0 )
	{
		...
		$pharmacy->TipePasien = $pharmacy->JenisKerjasama;
		...
		if( $this->input->is_ajax_request() )
		{
			$data = array(
					...
					"print_billing_link" => base_url("pharmacy/pharmacy/print_billing/"),
