...
{ 
	...
	public function index()
	{
		...
		{
			echo "<script language=\"javascript\">window.location=\"".base_url("pharmacy/reports/recap-stocks")."\";</script>";
			exit();
		} else
		{
			redirect( "pharmacy/reports/recap-stocks/dialog" );
		}
	}
	...
	public function dialog ( $is_ajax = FALSE)
	{
		...
		$data = array(
				...
				"datepicker" => true,
				"form" => true,
				"lookup_products" => base_url("pharmacy/reports/recap-stocks/lookup_products")
			);
		...
		} else
		{
			$this->template
				...
				->set_breadcrumb( lang("reports:patient_reservation_page"), base_url("pharmacy/reports/recap-stocks") )
	...
	public function lookup_products( $is_ajax_request=false )
	{
		...
		{
			redirect( base_url( "pharmacy/reports/recap-stocks" ) );
		}
	}	
