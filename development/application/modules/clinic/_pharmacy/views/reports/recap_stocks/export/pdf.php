    ...
    <div class="row" style="margin:0 !important;">
    	<div class="col-lg-12" style="margin:0 !important;">
        	...
        	<div class="row text-center" style="margin:0 !important;">
            	<h4>
                    <?php echo sprintf("%s %s %s", lang('reports:recap_stock_heading'), lang("reports:section_label"), @$section->SectionName ); ?><br>
                            ...
                            <table class="table_header">
                                <thead>
                                    <tr>
                                        ...
                                        <th align="center"><?php echo lang('reports:code_label'); ?></th>
                                        <th align="center"><?php echo lang('reports:item_label'); ?></th>
                                        <th align="center"><?php echo lang('reports:unit_label'); ?></th>
                                        <th align="right"><?php echo lang('reports:beginning_balance_label'); ?></th>
                                        <th align="right"><?php echo lang('reports:in_label'); ?></th>
                                        <th align="right"><?php echo lang('reports:out_label'); ?></th>
                                        <th align="right"><?php echo lang('reports:ending_balance_label'); ?></th>
                                    </tr> 
                                </thead>
                                <tbody>	
                                    ...
                                    <tr>
                                        ...
                                        <td align="center" width="100px"><?php echo @$row->Satuan_Stok ?></td>
                                        <td align="right" width="100px"><?php echo @$row->SA ?></td>
                                        <td align="right" width="100px"><?php echo @$row->MASUK ?></td>
                                        <td align="right" width="100px"><?php echo @$row->KELUAR ?></td>
                                        <td align="right" width="100px"><?php echo ($row->SA + $row->MASUK - $row->KELUAR) ?></td>
                                    </tr>
                                    <?php endforeach; else: ?>
                                    <tr>
