            ...
            <div class="row" style="border-bottom:1px solid #000; margin:0 !important;">
                ...
                <?php if ($report_logo = $this->config->item("report_logo")) :  ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12">
                            <?php echo sprintf("%s : %s", 'Jenis Obat', (!empty(@$type->KelompokJenis)) ? @$type->KelompokJenis : 'Semua'); ?>
                        </div>
                    </div>
                    <br>
                    <?php $i = 1;
                    $grandtotal = 0;
                    if (!empty($collection['data'])) : foreach ($collection['data'] as $key => $transaction) :   ?>
                            <div class="row">
                                <div class="col-sm-12">
                        ...
                        <!-- <div class="row">
                            <div class="col-sm-12">
                                <table class="table_header" style="width: 50%!important;">
                                    ...
                                    <tbody>
                                        <?php $_total_payment = 0;
                                        if (!empty($collection['payment'])) : foreach ($collection['payment'] as $type => $val) :
                                                $_total_payment += $val;
                                        ?>
                        ...
                        <!-- <div class="row">
                            <div class="col-sm-12">
                                <table class="table_header" style="width: 50%!important;">
                                    ...
                                    <tbody>
                                        <?php $_total_merchan = 0;
                                        if (!empty($collection['merchan'])) : foreach ($collection['merchan'] as $pay) :
