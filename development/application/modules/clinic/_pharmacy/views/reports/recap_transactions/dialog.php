...
<?php echo form_open(base_url("pharmacy/reports/recap-transactions/export"), array("target" => "_blank")); ?>
<div class="col-md-offset-2 col-md-8">
	<div class="panel panel-info">
		<div class="panel-heading">
			<h3 class="panel-title"><?php echo 'Laporan Transaksi Obat' ?></h3>
		</div>
		<div class="panel-body">
			<div class="col-md-12">
				...
				<div class="row">
					...
					<div class="form-group">
						<label class="col-md-3 control-label"><?php echo 'Jenis Obat' ?></label>
						<div class="col-md-9">
							<select id="kelompokjenis" name="f[kelompokjenis]" class="form-control">
								<option value="">-- Semua --</option>
								<?php foreach ($option_type_drug as $val) : ?>
									<option value="<?php echo $val->KelompokJenis ?>"><?php echo $val->KelompokJenis ?></option>
								<?php endforeach; ?>
							</select>
						</div>
					</div>
