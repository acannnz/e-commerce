    ...
    <div class="row" style="margin:0 !important;">
    	<div class="col-lg-12" style="margin:0 !important;">
        	...
        	<div class="row text-center" style="margin:0 !important;">
            	<h4>
                    <?php echo sprintf("%s ", 'Laporan Penggunaan Obat'); ?><br>
			...
			<?php $i = 1 ; if(!empty($collection)) : foreach ($collection as $key => $value) :   ?>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <?php echo sprintf("%s %s",'Section : ', $key );?>
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-12">
                            <table class="table_header">
                                <thead>
                                    <tr>
                                        ...
                                        <th align="center"><?php echo 'Kode Obat'; ?></th>
                                        <th align="center"><?php echo 'Nama Obat'; ?></th>
                                        <th align="center"><?php echo 'HNA'; ?></th>
                                        <th align="right"><?php echo 'Qty'; ?></th>
                                        <th align="right"><?php echo 'CN On Faktur'; ?></th>
                                        <th align="right"><?php echo 'CN Off Faktur'; ?></th>
                                        <th align="right"><?php echo 'Total CN'; ?></th>
                                    </tr> 
                                </thead>
                                <tbody>	
                                    ...
                                    <tr>
                                        ...
                                        <td align="right"><?php echo number_format(@$row->HNA,2) ?></td>
                                        <td align="right"><?php echo @$row->Jumlah ?></td>
                                        <td align="right"><?php echo number_format(@$row->CNOnFaktur,2) ?></td>
                                        <td align="right"><?php echo number_format(@$row->CNOffFaktur,2) ?></td>
                                        <td align="right"><?php echo number_format(@$row->CNOnFaktur + @$row->CNOffFaktur, 2) ?></td>
                                    </tr>
                                    <?php endforeach; else: ?>
                                    <tr>
                                        <td colspan="9" align="center"><?php echo lang("reports:none_data_label"); ?></td>
                                    </tr>
                                    <?php endif; ?>
                                </tbody>
                            </table>
