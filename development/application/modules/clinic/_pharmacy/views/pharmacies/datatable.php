...
<div class="panel panel-info">
	<div class="panel-heading">
		<h3 class="panel-title">Daftar Realisasi Obat</h3>
		<ul class="panel-btn">
	...
	<div class="panel-body">
		...
		<div class="tab-content">
			<div id="pharmacy-tab1" class="tab-pane tab-pane-padding active">
				<?php echo modules::run("pharmacy/pharmacies/data_open/index" ) ?>
			</div>
			<div id="pharmacy-tab2" class="tab-pane tab-pane-padding">
				<?php echo modules::run("pharmacy/pharmacies/data_close/index" ) ?>
			</div>
		</div>
	</div>
</div>