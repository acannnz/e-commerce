		...
		<div class="row">
			...
			<div class="col-md-6">
				...
				<div class="form-group">
					...
					<div class="col-lg-9">
						<input type="text" id="DIterimaDari" name="f[DIterimaDari]" value="<?php echo @$item->DIterimaDari ?>" placeholder="" class="form-control" readonly>
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="col-lg-9">
						<input type="text" id="Nilai" name="f[Nilai]" value="<?php echo number_format(@$item->Nilai, 2, ".", ",") ?>" placeholder="" class="form-control text-right" readonly>
					</div>
				</div>
				<div class="form-group">
		...
		<div class="row">
			...
			<div class="col-md-6">
				...
				<div class="col-md-offset-3 col-md-7">
					<h3 class="text-danger">PENERIMAAN NON INVICE INI SUDAH DI POSTING!</h3>
				</div>
				<?php elseif ($item->Batal == 1): ?>
				<div class="col-md-offset-3 col-md-7">
					<h3 class="text-danger">PENERIMAAN NON INVICE INI SUDAH DIBATALKAN!</h3>
				</div>
				<?php endif; ?>
			</div>
		</div>
		<div class="row form-group">
			...
			<div class="col-lg-6">
				<div class="form-group text-right"> 
					<a href="<?php echo base_url("cashier/non-invoice-receipt/create")?>" class="btn btn-default"><b><i class="fa fa-plus"></i> <?php echo lang( 'buttons:create' ) ?></b></a>
				</div>
			</div>
		</div>
	</div>
