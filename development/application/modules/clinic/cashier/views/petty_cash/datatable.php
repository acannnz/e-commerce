...
<div class="panel panel-success">
	<div class="panel-heading">
		<h3 class="panel-title"><?php echo lang('petty_cash:list_subtitle') ?></h3>
		<ul class="panel-btn">
			<li><a href="<?php echo base_url("cashier/petty-cash/create") ?>" title="<?php echo lang('buttons:create') ?>" class="btn btn-info pull-right"><i class="fa fa-plus-circle"></i> <span><?php echo lang('buttons:create') ?></span></a></li>
		</ul>
	</div>
	<div class="panel-body">
		...
		<div class="table-responsive">
			<table id="dt-petty-cash" class="table table-sm" width="100%">
				<thead>
					<tr>
						<th><?php echo lang("petty_cash:evidence_number_label")?></th>
						<th><?php echo lang("petty_cash:date_label")?></th>
						<th><?php echo lang("petty_cash:income_label")?></th>
						<th><?php echo lang("petty_cash:expense_label")?></th>
						<th><?php echo lang("petty_cash:description_label")?></th>
						<th><?php echo lang("petty_cash:account_label")?></th>
						<th><?php echo lang("petty_cash:user_label")?></th>
						<th></th>
					</tr>
				</thead>
				<tbody>
...
(function( $ ){
	var search_datatable = {
			...
			reload_table : function(){
					$( "#dt-petty-cash" ).DataTable().ajax.reload();
				}
		};
		...
		$.fn.extend({
				DataTable_DrugPaymens: function(){
						...
						var _datatable = _this.DataTable( {
							...
							ajax: {
									url: "<?php echo base_url("cashier/petty-cash/datatable_collection") ?>",
									type: "POST",
									...
									{ 
										...
										render: function ( val, type, row ){
												var buttons = "<div class=\"btn-group pull-right\" role=\"group\">";
													buttons += "<a href=\"<?php echo base_url("cashier/petty-cash/edit") ?>/" + val + "\" title=\"Lihat Detail\" class=\"btn btn-info btn-xs\"><b><i class=\"fa fa-eye\"></i> Lihat</b></a>";
												buttons += "</div>";
					...
					$( "#dt-petty-cash_length select, #dt-petty-cash_filter input" )
		...
		$( document ).ready(function(e) {
            	$( "#dt-petty-cash" ).DataTable_DrugPaymens();
