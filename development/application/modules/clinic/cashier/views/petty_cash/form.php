...
<div class="panel panel-success">
	<div class="panel-heading">
		<h3 class="panel-title"><?php echo lang('petty_cash:pay_heading') ?></h3>
		<ul class="panel-btn">
	...
	<div class="panel-body">
		<div class="row">
			<div class="col-md-6">
				...
				<div class="form-group">
					<label class="col-lg-3 control-label"><?php echo 'Shift' ?></label>
					<div class="col-lg-7">
						<input type="text" id="Shift" name="p[Shift]" value="<?php echo @$shift->Deskripsi ?>" placeholder="" class="form-control" readonly>
					</div>
				</div>
			</div>    
			...
			<div class="col-md-6">
				...
				<div class="form-group">
					...
					<div class="col-lg-9">
						<input type="text" id="Debet" name="f[Debet]" value="<?php echo number_format(@$item->Debet, 2, '.', ',') ?>" placeholder="" class="form-control text-right" autofocus>
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					<label class="col-lg-3 control-label"><?php echo lang('petty_cash:toward_label') ?>/Dari</label>
					<div class="col-lg-9">
				...
				<div class="form-group">
					...
					<div class="col-lg-9">
						<textarea id="Deskripsi" name="f[Deskripsi]" placeholder="" class="form-control" required><?php echo @$item->Deskripsi ?></textarea>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="row form-group">
			...
			<div class="col-lg-6">
				<div class="form-group text-right"> 
					...
					<?php endif; ?>
					<a href="<?php echo base_url("cashier/petty-cash/create")?>" class="btn btn-info"><i class="fa fa-file"></i> <?php echo lang( 'buttons:create' ) ?></a>
