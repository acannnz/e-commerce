...
class Contract_service_component_model extends CI_Model
{
	public $table = 'SIMdKontrakDetailKomponen';
	public $index_key = 'CustomerKerjasamaID';
	public $rules;
	...
	public function __construct()
	{
		$this->rules = [
			'insert' => [
				...
				[
					'field' => 'StartDate',
                	'label' => lang('label:date_start'),
               		'rules' => "required"
				],
				[
					'field' => 'EndDate',
                	'label' => lang('label:date_end'),
               		'rules' => "required"
				],
			],
			'update' => [
