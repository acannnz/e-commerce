	...
	<div class="col-md-12">
		<div class="panel panel-default">
            <div class="panel-heading">  
				<div class="row">
					<div class="col-md-6">
		                <h3 class="panel-title"><?php echo lang('heading:customer_list'); ?></h3>
					</div>
					<div class="col-md-6">
				...
				<div class="row">
					<div class="col-md-12">
						<div class="form-group">
							<table id="dt_customer" class="table table-bordered table-hover" width="100%" cellspacing="0">
								<thead>
									<tr>
...
(function( $ ){
		...
		$( document ).ready(function(e) {
				...
				_form.find("button[name=\"btn_search\"]").on("click", function(e){
						$( "#dt_customer" ).DataTable().ajax.reload();
				});					
					
				$("#dt_customer").DataTableInit();
