	...
	<div class="col-md-offset-2 col-md-8">
		<div class="panel panel-default">
            <div class="panel-heading">                
                ...
                <h3 class="panel-title"><?php echo (@$is_edit) ? lang('heading:service_type_update') : lang('heading:service_type_create'); ?></h3>
            </div>
            <div class="panel-body table-responsive">
          		<div class="row">
            		<div class="col-md-12 col-xs-12">
                        <div class="form-group">
                        <?php echo form_label(lang('label:service_type').' *', 'JenisLayanan', ['class' => 'control-label col-md-3']) ?>
                        <div class="col-md-9">
							<?php echo form_input('f[JenisLayanan]', set_value('f[JenisLayanan]', @$item->JenisLayanan, TRUE), [
									'id' => 'JenisLayanan', 
									'placeholder' => '', 
									'class' => 'form-control'
								]); ?>
