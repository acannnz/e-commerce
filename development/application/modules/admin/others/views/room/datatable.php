	...
	<div class="col-md-offset-1 col-md-10">
		<div class="panel panel-default">
            <div class="panel-heading">  
				<div class="row">
					<div class="col-md-6">
		                <h3 class="panel-title"><?php echo lang('heading:room_list'); ?></h3>
					</div>
					<div class="col-md-6">
			...
			<div class="panel-body">
				<div class="row">
					<div class="col-md-12">
						<div class="form-room">
							<table id="dt_room" class="table table-bordered table-hover" width="100%" cellspacing="0">
								<thead>
									<tr>
										...
										<th><?php echo lang('label:room_number') ?></th>
										<th><?php echo lang('label:sal') ?></th>
										<th><?php echo lang('label:bed_amount') ?></th>
										<th><?php echo lang('label:floor_number') ?></th>
										<th><?php echo lang('label:class') ?></th>
										<th><?php echo lang('label:added') ?></th>
...
(function( $ ){
		...
		$( document ).ready(function(e) {
				...
				_form.find("button[name=\"btn_search\"]").on("click", function(e){
						$( "#dt_room" ).DataTable().ajax.reload();
				});					
					
				$("#dt_room").DataTableInit();
