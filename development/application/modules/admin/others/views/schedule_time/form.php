...
<?php echo form_open( $form_action, [
		'id' => 'form_schedule_time', 
		'name' => 'form_schedule_time', 
		'rule' => 'form', 
		'class' => ''
	]); ?>
	...
	<div class="col-md-offset-2 col-md-8">
		<div class="panel panel-default">
            <div class="panel-heading">                
                ...
                <h3 class="panel-title"><?php echo (@$is_edit) ? lang('heading:schedule_time_update') : lang('heading:schedule_time_create'); ?></h3>
            </div>
            <div class="panel-body table-responsive">
          		<div class="row">
            		<div class="col-md-12 col-xs-12">
                        <div class="form-group">
							<?php echo form_label(lang('label:description').' *', 'NamaWaktu', ['class' => 'control-label col-md-3']) ?>
							<div class="col-md-9">
								<?php echo form_input('f[NamaWaktu]', set_value('f[NamaWaktu]', @$item->NamaWaktu, TRUE), [
										'id' => 'NamaWaktu', 
										'placeholder' => '', 
										'class' => 'form-control'
									]); ?>
						...
						<div class="form-group">
							<?php echo form_label(lang('label:from_hour').' *', 'FromJam', ['class' => 'control-label col-md-3']) ?>
							<div class="col-md-9">
								<?php echo form_input('f[FromJam]', set_value('f[FromJam]', @$item->FromJam, TRUE), [
										'id' => 'FromJam', 
										'placeholder' => '', 
						...
						<div class="form-group">
							<?php echo form_label(lang('label:till_hour').' *', 'ToJam', ['class' => 'control-label col-md-3']) ?>
							<div class="col-md-9">
								<?php echo form_input('f[ToJam]', set_value('f[ToJam]', @$item->ToJam, TRUE), [
										'id' => 'ToJam', 
										'placeholder' => '', 
										'class' => 'form-control timepicker'
									]); ?>
