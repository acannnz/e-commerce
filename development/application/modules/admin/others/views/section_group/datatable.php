	...
	<div class="col-md-offset-2 col-md-8">
		<div class="panel panel-default">
            <div class="panel-heading">  
				<div class="row">
					<div class="col-md-6">
		                <h3 class="panel-title"><?php echo lang('heading:section_group_list'); ?></h3>
					</div>
					<div class="col-md-6">
			...
			<div class="panel-body">
				<div class="row">
					<div class="col-md-12">
						<div class="form-section_group">
							<table id="dt_section_group" class="table table-bordered table-hover" width="100%" cellspacing="0">
								<thead>
									<tr>
										...
										<th><?php echo lang('label:profit_center') ?></th>
...
(function( $ ){
				...
				DataTableInit: function(){
						...
						var _datatable = _this.DataTable( {		
							...
							columns: [
									...
									{ 
										data: 'KelompokSection',
										render: function ( val, type, row, meta ) {
											var sanitized = $.fn.dataTable.render.text().display(val, type, row, meta);
									...
									{ 
										...
										render: function ( val ) {
											return '<span class="btn btn-xs btn-'+ ( val ? 'success' : 'default') +'">'+ ( val ? '<?php echo lang('global:yes')?>' : '<?php echo lang('global:no')?>') +'</span>';
										}
									},
									{ 
										data: 'KelompokSectionID',
										className: "text-center",
										orderable: false,
										width: "150px",
		...
		$( document ).ready(function(e) {
				...
				_form.find("button[name=\"btn_search\"]").on("click", function(e){
						$( "#dt_section_group" ).DataTable().ajax.reload();
				});					
					
				$("#dt_section_group").DataTableInit();
