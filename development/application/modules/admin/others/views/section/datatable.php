	...
	<div class="col-md-12">
		<div class="panel panel-default">
            <div class="panel-heading">  
				<div class="row">
					<div class="col-md-6">
		                <h3 class="panel-title"><?php echo lang('heading:section_list'); ?></h3>
					</div>
					<div class="col-md-6">
				...
				<div class="row">
					<div class="col-md-12">
						<div class="form-section">
							<table id="dt_section" class="table table-bordered table-hover" width="100%" cellspacing="0">
								<thead>
									<tr>
										...
										<th><?php echo lang('label:service_type') ?></th>
										<th><?php echo lang('label:section_group') ?></th>
...
(function( $ ){
				...
				DataTableInit: function(){
						...
						var _datatable = _this.DataTable( {		
							...
							columns: [
									...
									{ data: 'SectionName'},
									{ data: 'TipePelayanan'},
									{ data: 'KelompokSection', className:'text-center'},
									{ 
										data: 'StatusAktif',
										render: function( val ){
											return (val == 1) 
												? '<span class="btn btn-success btn-xs"><?php echo lang('global:active') ?></span>'
												: '<span class="btn btn-default btn-xs"><?php echo lang('global:inactive') ?></span>'
										}
									},
									{ 
										data: 'SectionID',
		...
		$( document ).ready(function(e) {
				...
				_form.find("button[name=\"btn_search\"]").on("click", function(e){
						$( "#dt_section" ).DataTable().ajax.reload();
				});					
					
				$("#dt_section").DataTableInit();
