    ...
    function lookupbox_row_selected( response ){
        ...
        if( _response ){
            ...
            try {
				...
				$('#KomponenBiayaID').val( _response.KomponenBiayaID );
				$('#KomponenName').val( _response.KomponenName );
			...
			$.fn.extend({
					dataTableInit: function(){
							...
							var _datatable = _this.DataTable( {
								...
								scrollCollapse: true,
								ajax: {
										url: "<?php echo base_url("service/service_component/lookup_collection") ?>",
										type: "POST",
								...
								columns: [
										{ 
											...
											render: function ( val, type, row ){
													var data = {'KomponenBiayaID' : row.KomponenBiayaID, 'KomponenName': row.KomponenName};
