	...
	<div class="col-md-offset-1 col-md-10">
		<div class="panel panel-default">
            <div class="panel-heading">  
				<div class="row">
					<div class="col-md-6">
		                <h3 class="panel-title"><?php echo lang('heading:drug_commission_list'); ?></h3>
					</div>
				</div>
			</div>
				...
				<div class="row">
					<div class="col-md-12">
						<div class="form-group">
							<table id="dt_drug_commission" class="table table-bordered table-hover" width="100%" cellspacing="0">
								<thead>
									<tr>
...
(function( $ ){
		...
		$( document ).ready(function(e) {
				...
				_form.find("button[name=\"btn_search\"]").on("click", function(e){
						$( "#dt_drug_commission" ).DataTable().ajax.reload();
				});					
					
				$("#dt_drug_commission").DataTableInit();
