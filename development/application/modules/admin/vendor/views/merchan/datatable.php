	...
	<div class="col-md-12">
		<div class="panel panel-default">
            <div class="panel-heading">  
				<div class="row">
					<div class="col-md-6">
		                <h3 class="panel-title"><?php echo lang('heading:merchan_list'); ?></h3>
					</div>
					<div class="col-md-6">
				...
				<div class="row">
					<div class="col-md-12">
						<div class="form-group">
							<table id="dt_merchan" class="table table-bordered table-hover" width="100%" cellspacing="0">
								<thead>
									<tr>
										...
										<th><?php echo lang('label:addcharge_d') ?></th>
										<th><?php echo lang('label:addcharge_k') ?></th>
										<th><?php echo lang('label:discount') ?></th>
...
(function( $ ){
				...
				DataTableInit: function(){
						...
						var _datatable = _this.DataTable( {		
							...
							columns: [
									...
									{data: 'AddCharge_Debet'},
									{data: 'AddCharge_Kredit'},
									{
										data: 'Diskon',
										render: function( val, type, row ){
											return val +'%';
		...
		$( document ).ready(function(e) {
				...
				_form.find("button[name=\"btn_search\"]").on("click", function(e){
						$( "#dt_merchan" ).DataTable().ajax.reload();
				});					
					
				$("#dt_merchan").DataTableInit();
