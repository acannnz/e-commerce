...
?>
<?php echo form_open( $submit_url, array("name" => "form_cash_bank_income") ); ?>
<div class="panel panel-info">
	<div class="panel-heading">
		<h3 class="panel-title"><?php echo lang('cash_bank_income:invoice_page'); ?></h3>
	</div>
	<div class="panel-body">
		<div class="row">
			<div class="col-md-6">
				<div class="form-group">
					<label class="col-lg-3 control-label"><?php echo lang('cash_bank_income:date_label') ?> <span class="text-danger">*</span></label>
					<div class="col-lg-9">
				...
				<?php if ( @$is_edit ): ?>
				<div class="form-group">
					<label class="col-lg-3 control-label"><?php echo lang('cash_bank_income:evidence_number_label') ?> <span class="text-danger">*</span></label>
					<div class="col-lg-9">
				...
				<?php endif; ?>
				<div class="form-group">
					<label class="col-lg-3 control-label"><?php echo lang('cash_bank_income:description_label') ?> <span class="text-danger">*</span></label>
					<div class="col-lg-9">
			...
			<div class="col-md-6"> 
				<div class="form-group">
					<label class="col-lg-3 control-label"><?php echo lang('cash_bank_income:type_label') ?> <span class="text-danger">*</span></label>
					<div class="col-lg-9">
						<select id="Type_Transaksi" name="Type_Transaksi" class="form-control">
							<option value="BKM" <?php echo ($item->Type_Transaksi == 'BKM') ? 'selected' : NULL ?> data-type="<?php echo $lookup_accounts ?>/GC-Cash">Kas Masuk</option>
							<option value="BBM" <?php echo ($item->Type_Transaksi == 'BBM') ? 'selected' : NULL ?> data-type="<?php echo $lookup_accounts ?>/GC-Bank">Bank Masuk</option>
						</select>
					</div>
				</div>
				<div class="form-group">
					<label class="col-lg-3 control-label"><?php echo lang('cash_bank_income:account_label') ?> <span class="text-danger">*</span></label>
				...
				<?php /*?><div class="form-group">
					<label class="col-lg-3 control-label"><?php echo lang('cash_bank_income:due_date_label') ?> <span class="text-danger">*</span></label>
					<div class="col-lg-9">
				...
				<div class="form-group">
					<div class="col-lg-offset-3 col-lg-9">
						<?php if (@$item->Posted) : ?>
							<h3  class="text-danger"><?php echo lang("cash_bank_income:posted_data")?></h3>
						<?php endif;
							if (@$item->Status_Batal) :?>
							<h3  class="text-danger"><?php echo lang("cash_bank_income:cancel_data")?></h3>
						<?php endif; ?>
					</div>
				</div>        
			</div>
		...
		<div class="row">
			<div class="col-md-12">
				<h4 class="text-primary"><b><?php echo lang("cash_bank_income:invoice_detail_subtitle")?></b></h4>
			</div>
		</div>
		<div class="row">
			<?php echo  modules::run("general_cashier/cash_bank_income/invoices/detail", @$item, @$is_edit) ?>
		</div>
		
		<div class="row">
			<div class="col-lg-12 text-right">
				<button type="submit" id="btn-submit" class="btn btn-primary"  <?php echo (@$is_edit || @$item->Posted == 1 || @$item->Status_Batal == 1 )? "disabled" : NULL ?>><?php echo lang( 'buttons:submit' ) ?></button>
