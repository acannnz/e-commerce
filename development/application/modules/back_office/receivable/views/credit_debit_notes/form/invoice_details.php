...
<div class="modal-dialog modal-lg">
    <div class="modal-content">
        <div class="modal-header"> 
            ...
            <h4 class="modal-title"><?php echo lang('credit_debit_notes:form_invoice_title') ?></h4>
        </div>
        <div class="modal-body">
            <div class="col-md-6">
                <div class="form-group">
                    <label class="control-label col-md-4"><?php echo lang("credit_debit_notes:invoice_number_label")?></label>
                    <div class="col-md-8">
