...
<div class="row">
	<div class="col-md-6">
        ...
        <div class="form-group">
            ...
            <div class="col-lg-9">
                <input type="text" id="No_Faktur" name="No_Faktur" value="<?php echo @$item->No_Faktur ?>" placeholder="" class="form-control" readonly="readonly"  required>
            </div>
        </div>
        <div class="form-group">
            <label class="col-lg-3 control-label"><?php echo lang('facturs:customer_label') ?> <span class="text-danger">*</span></label>
        ...
        <div class="form-group">
            ...
            <div class="col-lg-9">
                <select id="JenisPiutang_ID" name="JenisPiutang_ID" class="form-control"  required>
                	<?php  if ( !empty( $options_type ) ) : foreach($options_type as $row) : ?>
                    <option value="<?php echo $row->TypePiutang_ID ?>" data-accountid="<?php echo $row->Akun_ID ?>" data-accountno="<?php echo $row->Akun_No ?>" data-accountname="<?php echo $row->Akun_Name ?>" <?php echo ($row->TypePiutang_ID == @$item->JenisPiutang_ID ) ? "selected" : NULL ?> ><?php echo $row->Nama_Type ?></option>
    ...
    <div class="col-md-6">
        <div class="form-group">
            <label class="col-lg-3 control-label"><?php echo lang('facturs:card_number_label') ?> </label>
            <div class="col-lg-9">
                <input type="text" id="NoKartu" name="NoKartu" value="<?php echo @$item->NoKartu ?>" placeholder="" class="form-control"  <?php echo (@$is_edit) ? "readonly" : NULL ?>>
            </div>
        </div>        
        <div class="form-group">
            <label class="col-lg-3 control-label"><?php echo lang('facturs:diagnosis_label') ?></label>
            <div class="col-lg-9">
                <textarea id="Diagnosa" name="Diagnosa"placeholder="" class="form-control"  <?php echo (@$is_edit) ? "readonly" : NULL ?>><?php echo @$item->Diagnosa ?></textarea>
            </div>
        </div>        
        <div class="form-group">
...
<div class="row">
	<?php echo  modules::run("receivable/factur/details", @$item, @$is_edit) ?>
</div>
