...
class Cash_flow_account_m extends CI_Model
{
	public $table = 'TBCF_Detail'; 
	protected $index_key = 'Akun_id';
	...
	public function __construct()
	{
		$this->rules = [
			'insert' => [
				[
					'field' => 'Akun_id',
					'label' => lang( 'cash_flow:account_name_label' ),
					'rules' => 'required'
				],[
					'field' => 'GroupII_id',
					'label' => lang( 'cash_flow:subgroup_label' ),
					'rules' => 'required'
				],[
					'field' => 'Normal_Pos',
					'label' => lang( 'cash_flow:normal_pos_label' ),
					'rules' => 'required'
				],
			],
		];
	...
	public function dropdown($first_label = '')
	{
		$option = [];		
		if ($items = $this->get_all())
		{
			...
			{
				$option[ $item->Group_Name ] = $item->Group_Name;
			}
		}
