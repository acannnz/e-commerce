...
<?php echo form_open( base_url("payable/postings/posting_cancel"), array("id" => "form_posting_cancel")) ?>
		...
		$.fn.extend({
				DataTableGeneralLedgerPostings: function(){
						...
						var _datatable = _this.DataTable( {
							...
							responsive: true,
							ajax: {
									url: "<?php echo base_url("payable/postings/datatable_collection_cancel") ?>",
									type: "POST",
									data: function( params ){
										
										params.date_start = $("#date_start").val();
										params.date_end = $("#date_end").val();
										params.Supplier_ID = $("#supplier_id").val() || null;
									}
								},
