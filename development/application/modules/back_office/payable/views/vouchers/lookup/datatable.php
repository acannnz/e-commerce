...
<div class="table-responsive">
    <table id="dt-lookup-payable-vouchers" class="table table-bordered table-striped" width="100%">
        <thead>
            <tr>
                <th></th>
...
(function( $ ){
		...
		var _datatable = $( "#dt-lookup-payable-vouchers" ).DT_Lookup_ReceivableVouchers();
