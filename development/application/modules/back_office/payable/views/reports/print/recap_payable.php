  ...
  <div class="row" style="margin:0 !important;">
    	<div class="col-lg-12" style="margin:0 !important;">
        	...
        	<div class="row text-center" style="margin:0 !important;">
            	<h4><?php echo lang('reports:recap_payable_label')?></h4>
					...
					<table class="table reports-table"  style="border:1px solid black; font-size:10px">
						<thead>
							<tr style="border:1px solid black;">
								...
								<th style="border:1px solid black; padding:2px;"><?php echo lang("reports:supplier_label") ?></th>
						...
						<tbody>	
							...
							<?php if(!empty( $v )): foreach( $v as $item ): 
								...
								$ending_balance = $item->SaldoAwal + $item->Kredit - $item->Debet;
							...
							?>
								<tr>
									...
									<td align="right" style="border:1px solid black; padding:2px;"><?php echo date("d-m-Y", strtotime(substr($item->Tanggal, 0, 10))) ?></td>
									<td align="center" style="border:1px solid black; padding:2px;"><?php echo $item->Kode_Supplier ?></td>
									<td align="left" style="border:1px solid black; padding:2px;"><?php echo $item->Nama_Supplier ?></td>
