...
<div class="panel panel-info">
	<div class="panel-heading">
		<h3 class="panel-title"><?php echo lang('facturs:list_heading'); ?></h3>
		<ul class="panel-btn">
			<li><a href="<?php echo base_url("payable/factur/create")?>"  class="btn btn-info pull-right"><b><i class="fa fa-plus"></i> <?php echo lang( 'buttons:create' ) ?></b></a></li>
		</ul>
	</div>
		...
		<div class="row">
			<div class="col-md-3">
				<div class="form-group">
					<label class="control-label"><?php echo lang('facturs:periode_label') ?></label>
			...
			<div class="col-md-3">
				<div class="form-group">
					<label class="control-label"><?php echo lang('facturs:supplier_label') ?></label>
					<div class="input-group">
					...
					<div class="row">
						<div class="col-md-6">
							<div class="checkbox" style="margin-top:0">
								...
								<label for="factur_cancel"><?php echo lang('facturs:cancel_factur_label')?></label>
							</div>
						</div>
					</div>
					<a href="javascript:;" id="btn-search" class="btn btn-primary btn-block"><b><i class="fa fa-search"></i> <?php echo lang("facturs:find_factur_list_label") ?></b></a>
				</div>
			</div>
		</div>
		
		<div class="table-responsive">
			<table id="dt-payable-facturs" class="table table-sm" width="100%">
				<thead>
					<tr>
						...
						<th><?php echo lang('facturs:supplier_label') ?></th>
...
(function( $ ){
		$.fn.extend({
				DataTableReceivableFacturs: function(){
						...
						var _datatable = _this.DataTable( {
							...
							responsive: true,
							ajax: {
									url: "<?php echo base_url("payable/factur/datatable_collection") ?>",
									type: "POST",
							...
							columns: [
									...
									{ 
										...
										orderable: false,
										render: function ( val, type, row ){							
												buttons = "<a href=\"<?php echo base_url("payable/factur/edit") ?>/?No_Faktur=" + encodeURIComponent(val) + "\" title=\"<?php echo lang( "buttons:view" ) ?>\" class=\"label label-info\"><i class=\"fa fa-eye\"></i> <?php echo lang( "buttons:view" ) ?></a>";
												return buttons
											}
									}
								],
					...
					$( "#dt-payable-facturs_length select, #dt-payable-facturs_filter input" )
		...
		$( document ).ready(function(e) {
            	$( "#dt-payable-facturs" ).DataTableReceivableFacturs();
				
				$("#btn-search").on("click", function(e){
					e.preventDefault();
					
					$( "#dt-payable-facturs" ).DataTable().ajax.reload();
				});
