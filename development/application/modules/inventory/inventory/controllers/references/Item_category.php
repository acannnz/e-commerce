...
class Item_category extends ADMIN_Controller
{
	...
	public function __construct()
	{
		...
		$this->data['nameroutes'] = $this->nameroutes = 'inventory/references/item_category'; 
	...
	public function index()
	{
		$this->template
			...
			->build("references/item_category/index", $this->data);
	}
	
	public function create()
	{
		$this->data['item'] = (object)['Kode_Kategori' => inventory_helper::gen_item_category_code()];
		$this->data['form_action'] = $form_action = site_url("{$this->nameroutes}/create_post");
		$this->load->view('references/item_category/modal/create', $this->data);
	}
	...
	public function update($id = 0)
	{
		...
		$this->load->view('references/item_category/modal/update', $this->data);
	}
	...
	public function delete($id = 0)
	{
		...
		$this->load->view('references/item_category/modal/delete', $this->data);
	}
	...
	public function create_post()
	{
		if( $this->input->post() ) 
		{
			...
			$this->form_validation->set_rules([
					['field' => 'Kode_Kategori', 'label' => lang('label:code'), 'rules' => 'required'],
					['field' => 'Nama_Kategori', 'label' => lang('label:category'), 'rules' => 'required'],
				]);
	...
	public function collection()
	{
		...
		$this->datatables
			->select("Kategori_ID,Kode_Kategori,Nama_Kategori,CN_Faktur", false)
			->from($this->get_model()->table);
		
		$this->datatables->add_column("actions", $action, "Kategori_ID");		
	...
	{
		return $this->item_category_model;
	}
}
