...
<input type="hidden" id="permintaan_id" value="<?php echo $permintaan_id ?>" name="h[Permintaan_ID]" />
<div class="row">
	<div class="col-md-12">
		<div class="panel panel-default">
            ...
            <div class="form-group">
                    ...
                    <?php echo form_input('f[Tgl_Permintaan]', set_value('f[Tgl_Permintaan]', $tgl_permintaan, TRUE), [
                            'id' => 'input_date', 
                            'placeholder' => '', 
                            'required' => 'required',
                    ...
                    <div class="form-group">
                        ...
                        <?php echo form_input('f[No_Permintaan]', set_value('f[No_Permintaan]', $gen_code, TRUE), [
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <?php echo form_input('h[grand_total]', set_value('h[grand_total]', '', TRUE), [
                                        'id' => 'input_total', 
                                        'placeholder' => '',
                                        'required' => 'required', 
                                        'class' => 'form-control'
                ...
                <div class="form-group">
                	<!--<div class="row">-->
                        ...
                        <button class="btn btn-default" type="button" onclick="window.location='<?php echo base_url("{$nameroutes}/receipt") ?>';") ?>">Close</button> 
                    <!--</div>-->
                </div>
            </div>
        </div>
...
(function( $ ){
		...
		$( document ).ready(function(e) {
            	$( "#dt_trans_purchase_request_detail" ).dt_services();
				
								
				$("form[name=\"form_create_purchase_request\"]").on("submit", function(e){
					e.preventDefault();	
					...
					$.post($(this).attr("action"), data_post, function( response, status, xhr ){
						...
						//setTimeout(function(){
							...
							//idocument.location.href = "<?php echo base_url("{$nameroutes}/edit"); ?>/"+ inserted_id;
