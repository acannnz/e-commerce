...
<div class="row">
	<div class="col-md-12">
		...
		<div class="row form-group">
			<table id="dt_trans_goods_receipt_open" class="table table-bordered table-hover" width="100%" cellspacing="0">
				<thead>
					<tr>
...
(function( $ ){
		$( document ).ready(function(e) {
				...
				_form.find("button[name=\"btn_search\"]").on("click", function(e){
						$( "#dt_trans_goods_receipt_open" ).DataTable().ajax.reload();
				});
				
				//function code for custom search
				$( "#dt_trans_goods_receipt_open" ).DataTable({
					processing: true,
					serverSide: true,								
					paginate: true,
					ordering: true,
