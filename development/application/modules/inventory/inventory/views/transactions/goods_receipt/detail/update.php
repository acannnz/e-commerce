...
<?php echo form_open($form_action, [
    ...
    <div class="form-group" style="margin: 27px 0px;">
    	<p style="margin-bottom: 0;line-height: 100%;font-size: 14px;">Apakah Anda ingin Mengubah Status Stok ini ?</p>   
...
<div class="modal-footer">
	...
	<?php echo form_button([
			...
			'value' => '',
			'type' => 'submit',
			'content' => '<i class="fa fa-trash-o" aria-hidden="true"></i> ' . lang('button:update'),
