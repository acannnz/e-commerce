	...
	<div class="col-md-8 col-md-offset-2">
		<div class="panel panel-default">
            ...
            <div class="panel-body table-responsive">
                <table id="dt_ref_section" class="table table-bordered table-hover" width="100%" cellspacing="0">
                    <thead>
                        <tr>
                            ...
                            <th><?php echo 'Layanan' ?></th>
                            <th><?php echo 'Penanggung Jawab' ?></th>
