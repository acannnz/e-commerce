...
<div class="modal-body">
	<div class="form-group">
        ...
        <div class="col-sm-8 col-xs-12">
			<?php echo form_input('f[KelompokJenis]', set_value('f[KelompokJenis]', '', TRUE), [
                    'id' => 'input_type', 
                    'placeholder' => '', 
                    'class' => 'form-control'
                ]); ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8 col-xs-12">
            <?php echo form_dropdown('f[JenisPengadaanID]', $populate_precurement, set_value('f[JenisPengadaanID]', 0, TRUE), [
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8 col-xs-12">
			<?php echo form_input('f[Akun_ID]', set_value('f[Akun_ID]', '', TRUE), [
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8 col-xs-12">
			<?php echo form_input('f[Akun_ID_Mutasi]', set_value('f[Akun_ID_Mutasi]', '', TRUE), [
    ...
    <div class="form-group">
		<div class="col-sm-8 col-sm-offset-4 col-xs-12">
            ...
            <?php echo form_checkbox([
                    ...
                    'value' => 1,
                    'checked' => (1 == @$config['TidakPostingMutasi']),
                    'class' => 'checkbox'
