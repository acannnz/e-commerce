...
<div class="modal-body">
    ...
    <div class="form-group">
        ...
        <?php echo form_input('f[Nama_Kategori]', set_value('f[Nama_Kategori]', $item->Nama_Kategori, TRUE), [
				'id' => 'input_name', 
				'placeholder' => '', 
				'class' => 'form-control'
			]); ?>
	...
	<div class="form-group">
		<?php echo form_label(lang('label:cn_factur').' (%) *', 'input_name', ['class' => 'control-label']) ?>
        <?php echo form_input('f[CN_Faktur]', set_value('f[CN_Faktur]', $item->CN_Faktur, TRUE), [
				'type' => 'number',
				'id' => 'input_name', 
				'placeholder' => '', 
				'class' => 'form-control',
