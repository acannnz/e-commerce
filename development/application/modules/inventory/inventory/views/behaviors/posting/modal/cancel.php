...
<div class="modal-body">
    <div class="form-group" style="margin: 27px 0px;">
    	<p style="margin-bottom: 0;line-height: 100%;font-size: 14px;"><?php echo lang('confirm:cancel_posting')?></p>   
				...
				$("#btn-submit").on("click", function(e){
					...
					var data_post = {};
						...
						data_post['additional'] = {
								'location_id' : _form_section.find('option:selected').val(),
								'section_name' : _form_section.find('option:selected').html(),
							};	
