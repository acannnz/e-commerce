...
class Spog extends Inquiry
{
	...
	public function request( )
	{
		...
		$this->template
			->set( "heading", "Amprah Barang Poli Kandungan & Kebidanan" )
			->set_breadcrumb( "Amprahan", base_url("inquiry/spog/request") )
			->set_breadcrumb( "Amprah Barang Poli Kandungan & Kebidanan" )
			;

		$this->request_( "SEC008" );
	}

	public function request_list( )
	{

		$section = $this->inquiry_m->get_row_data("SIMmSection", array("SectionID" => "SEC008" ));
		...
		$data = array(
				...
				"form" => TRUE,
				'datatables' => TRUE,
				'create_link' => base_url("inquiry/spog/request"),
			);
		
		$this->template
			->set( "heading", "List Amprahan Poli Kandungan & Kebidanan" )
			->set_breadcrumb( lang("inquiry:breadcrumb") )
			->set_breadcrumb( "Amprahan Poli Kandungan & Kebidanan", current_url() )
	...
	{
		$this->template
			->set( "heading", "Stok Opname Poli Kandungan & Kebidanan" )
			->set_breadcrumb( "Stok Opname", current_url() )
			->set_breadcrumb( "Stok Opname Poli Kandungan & Kebidanan" )
			;
			
		$this->stock_opname_( "SEC008" );
	}
	...
	public function stock_opname_view( $No_Bukti )
	{
		...
		$this->stock_opname_view_( "SEC008", $No_Bukti );
	}
	...
	public function stock_opname_list()
	{
		...
		$data = array(
				...
				"form" => TRUE,
				'datatables' => TRUE,
				"create_link" => base_url("inquiry/spog/stock-opname")
			);
		
		$this->template
			->set( "heading", "List Stok Opname Poli Kandungan & Kebidanan" )
			->set_breadcrumb( "Stok Opname" )
			->set_breadcrumb( "Stok Opname Poli Kandungan & Kebidanan", current_url() )
