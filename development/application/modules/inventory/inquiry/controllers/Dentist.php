...
class Dentist extends Inquiry
{
	...
	public function request( )
	{
		...
		$this->template
			->set( "heading", "Amprah Barang Poli Gigi" )
			->set_breadcrumb( "Amprahan", base_url("inquiry/dentist/request") )
			->set_breadcrumb( "Amprah Barang Poli Gigi" )
			;

		$this->request_( "SEC002" );
	}

	public function request_list( )
	{

		$section = $this->inquiry_m->get_row_data("SIMmSection", array("SectionID" => "SEC002" ));
		...
		$data = array(
				...
				"form" => TRUE,
				'datatables' => TRUE,
				'create_link' => base_url("inquiry/dentist/request"),
			);
		
		$this->template
			->set( "heading", "List Amprahan Poli Gigi" )
			->set_breadcrumb( lang("inquiry:breadcrumb") )
			->set_breadcrumb( "Amprahan Poli Gigi", current_url() )
	...
	{
		$this->template
			->set( "heading", "Stok Opname Poli Gigi" )
			->set_breadcrumb( "Stok Opname", current_url() )
			->set_breadcrumb( "Stok Opname Poli Gigi" )
			;
			
		$this->stock_opname_( "SEC002" );
	}
	...
	public function stock_opname_view( $No_Bukti )
	{
		...
		$this->stock_opname_view_( "SEC002", $No_Bukti );
	}
	...
	public function stock_opname_list()
	{
		...
		$data = array(
				...
				"form" => TRUE,
				'datatables' => TRUE,
				"create_link" => base_url("inquiry/dentist/stock-opname")
			);
		
		$this->template
			->set( "heading", "List Stok Opname Poli Gigi" )
			->set_breadcrumb( "Stok Opname" )
			->set_breadcrumb( "Stok Opname Poli Gigi", current_url() )
