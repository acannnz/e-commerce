...
<div class="page-subtitle margin-bottom-20">
	<div class="row">
        <div class="col-md-6">
            <h3 class="text-info">List Data Mutasi</h3>
            <p>Data Mutasi akan diolah disini.</p>
        </div>
	</div>
</div>
<div class="row">
    ...
    <div class="col-md-6">
		<div class="form-group">
        	...
        	<a href="<?php echo $create_link ?>" class="btn btn-primary pull-right"><b><i class="fa fa-plus"></i> Mutasi Baru</b></a>
		</div>    	
    </div>
</div>
