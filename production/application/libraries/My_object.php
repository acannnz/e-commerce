    ...
    */
    ...
    public function getData($key='', $index=null)
    {
        ...
        if (strpos($key,'/')) {
            ...
            foreach ($keyArr as $i=>$k) {
                ...
                if (is_array($data)) {
                    ...
                    $data = $data[$k];
                } elseif ($data instanceof MY_Object) {
                    $data = $data->getData($k);
                } else {
                    return $default;
                }
        ...
        if (isset($this->_data[$key])) {
            ...
            } elseif ($value instanceof MY_Object) {
...
//	{
//		$var = $this->_underscore($var);		
//		if( is_callable( array($this,'isset'.(string)$var) ) )
//		{
//			return call_user_func( array($this,'isset'.(string)$var) );
//		}
//	}
//	
...
//	{
//		$var = $this->_underscore($var);
//		if( is_callable( array($this,'unset'.(string)$var) ) )
//		{
//			call_user_func( array($this,'unset'.(string)$var) );
//		}
//	}
//	
...
//	}
//	
//	public static function __setStatic($name, $arguments)
//	{
//		//
//	}
//	
//	public static function __getStatic($name, $arguments)
//	{
//		//
//	}
...
class CI_Object extends MY_Object{}
class CI_Library_Object extends CI_Object{}
