...
class MY_Controller extends MX_Controller
{
	...
	// use the protected keyword over the private keyword for methods and vars
     ...
     public function __construct()
	 {
		...
		{
			$this->load->add_package_path( SITE_PATH, FALSE );
		}

		// Register modern theme as a package path
		$this->load->add_package_path(APPPATH . 'themes/modern/', FALSE);
		...
		if($this->user !== NULL)
		{
			// Optional: Refresh permissions if needed
			// $this->_assign_group();
