...
<div class="row">
	<div class="col-md-6">
        ...
        <div class="form-group">
            ...
            <div class="col-lg-9">
                <input type="text" id="Nama_Supplier" name="f[Nama_Supplier]" value="<?php echo @$item->Nama_Supplier ?>" placeholder="" class="form-control" required>
            </div>
        </div>
        <div class="form-group">
            <label class="col-lg-3 control-label"><?php echo lang('schedules:specialist_label') ?></label>
            <div class="col-lg-9">
                <input type="text" id="Specialist" name="f[Specialist]" value="<?php echo @$item->SpesialisName ?>" class="form-control">
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="form-group"> 
                <div class="panel panel-danger">
                    <div class="panel-heading bg-default">
                    	<div class="col-md-3">
                        	<div class="checkbox">
                              <input type="checkbox" id="Senin" name="Mon[Senin]" value="1" <?php echo @$item->Senin ? "checked" : ''?>><label style="color:#FFF" for="Senin"><?php echo lang('schedules:monday_label') ?></label>
                            </div> 
                        </div>
                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-9">
                                        <select id="SeninRuangan" name="Mon[Ruangan]" class="form-control">
											<?php for($i = 1; $i <= 6 ; $i++):?>
                                            <option value="<?php echo $i ?>" <?php echo $i == @$item->Ruangan ? "selected" : NULL  ?>><?php echo $i ?></option>
                                            <?php endfor; ?>
                                        </select>
                                    </div>        
                                </div>        
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-3">
                                        <select id="Senin_WaktuPagiID" name="Mon[Senin_WaktuPagiID]" class="form-control">
                                            ...
                                            <option value="<?php echo $row->WaktuID ?>" <?php echo $row->WaktuID == @$item->Senin_WaktuPagiID ? "selected" : NULL  ?>><?php echo $row->Keterangan ?></option>
                                            <?php endforeach; endif;?>
                                        </select>
                                    </div>        
                                    ...
                                    <div class="col-lg-3">
                                        <select id="Senin_WaktuSoreID" name="Mon[Senin_WaktuSoreID]" class="form-control">
                                        	<option value="1">NONE</option>
											<?php if(!empty($option_times)): foreach($option_times as $row):?>
                                            <option value="<?php echo $row->WaktuID ?>" <?php echo $row->WaktuID == @$item->Senin_WaktuSoreID ? "selected" : NULL  ?>><?php echo $row->Keterangan ?></option>
                                            <?php endforeach; endif;?>
                                        </select>
                                    </div>        
                                </div> 
            ...
            <div class="form-group"> 
                <div class="panel panel-danger">
                    <div class="panel-heading bg-default">
                    	<div class="col-md-3">
                        	<div class="checkbox">
                              <input type="checkbox" id="Selasa" name="Thu[Selasa]" value="1" <?php echo @$item->Selasa ? "checked" : ''?>><label style="color:#FFF" for="Selasa"><?php echo lang('schedules:tuesday_label') ?></label>
                            </div> 
                        </div>
                    </div>
                    <div class="panel-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-3">
                                        <select id="Selasa_WaktuPagiID" name="Thu[Selasa_WaktuPagiID]" class="form-control">
                                        	<option value="1">NONE</option>
											<?php if(!empty($option_times)): foreach($option_times as $row):?>
                                            <option value="<?php echo $row->WaktuID ?>" <?php echo $row->WaktuID == @$item->Selasa_WaktuPagiID ? "selected" : NULL  ?>><?php echo $row->Keterangan ?></option>
                                            <?php endforeach; endif;?>
                                        </select>
                                    </div>        
                                    <label class="col-lg-3 control-label text-center"><?php echo lang('schedules:afternoon_label') ?></label>
                                    <div class="col-lg-3">
                                        <select id="Selasa_WaktuSoreID" name="Thu[Selasa_WaktuSoreID]" class="form-control">
                                        	<option value="1">NONE</option>
											<?php if(!empty($option_times)): foreach($option_times as $row):?>
                                            <option value="<?php echo $row->WaktuID ?>" <?php echo $row->WaktuID == @$item->Selasa_WaktuSoreID ? "selected" : NULL  ?>><?php echo $row->Keterangan ?></option>
                                            <?php endforeach; endif;?>
                                        </select>
                                    </div>        
                                </div> 
            ...
            <div class="form-group"> 
                <div class="panel panel-danger">
                    <div class="panel-heading bg-default">
                    	<div class="col-md-3">
                        	<div class="checkbox">
                              <input type="checkbox" id="Rabu" name="Wed[Rabu]" value="1" <?php echo @$item->Rabu ? "checked" : ''?>><label style="color:#FFF" for="Rabu"><?php echo lang('schedules:wednesday_label') ?></label>
                            </div> 
                        </div>
                    </div>
                    <div class="panel-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-3">
                                        <select id="Rabu_WaktuPagiID" name="Wed[Rabu_WaktuPagiID]" class="form-control">
                                        	<option value="1">NONE</option>
											<?php if(!empty($option_times)): foreach($option_times as $row):?>
                                            <option value="<?php echo $row->WaktuID ?>" <?php echo $row->WaktuID == @$item->Rabu_WaktuPagiID ? "selected" : NULL  ?>><?php echo $row->Keterangan ?></option>
                                            <?php endforeach; endif;?>
                                        </select>
                                    </div>        
                                    <label class="col-lg-3 control-label text-center"><?php echo lang('schedules:afternoon_label') ?></label>
                                    <div class="col-lg-3">
                                        <select id="Rabu_WaktuSoreID" name="Wed[Rabu_WaktuSoreID]" class="form-control">
                                        	<option value="1">NONE</option>
											<?php if(!empty($option_times)): foreach($option_times as $row):?>
                                            <option value="<?php echo $row->WaktuID ?>" <?php echo $row->WaktuID == @$item->Rabu_WaktuSoreID ? "selected" : NULL  ?>><?php echo $row->Keterangan ?></option>
                                            <?php endforeach; endif;?>
                                        </select>
                                    </div>        
                                </div> 
            ...
            <div class="form-group"> 
                <div class="panel panel-danger">
                    <div class="panel-heading bg-default">
                    	<div class="col-md-3">
                        	<div class="checkbox">
                              <input type="checkbox" id="Kamis" name="Thi[Kamis]" value="1" <?php echo @$item->Kamis ? "checked" : ''?>><label style="color:#FFF" for="Kamis"><?php echo lang('schedules:thursday_label') ?></label>
                            </div> 
                        </div>
                    </div>
                    <div class="panel-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-3">
                                        <select id="Kamis_WaktuPagiID" name="Thi[Kamis_WaktuPagiID]" class="form-control">
                                        	<option value="1">NONE</option>
											<?php if(!empty($option_times)): foreach($option_times as $row):?>
                                            <option value="<?php echo $row->WaktuID ?>" <?php echo $row->WaktuID == @$item->Kamis_WaktuPagiID ? "selected" : NULL  ?>><?php echo $row->Keterangan ?></option>
                                            <?php endforeach; endif;?>
                                        </select>
                                    </div>        
                                    <label class="col-lg-3 control-label text-center"><?php echo lang('schedules:afternoon_label') ?></label>
                                    <div class="col-lg-3">
                                        <select id="Kamis_WaktuSoreID" name="Thi[Kamis_WaktuSoreID]" class="form-control">
                                        	<option value="1">NONE</option>
											<?php if(!empty($option_times)): foreach($option_times as $row):?>
                                            <option value="<?php echo $row->WaktuID ?>" <?php echo $row->WaktuID == @$item->Kamis_WaktuSoreID ? "selected" : NULL  ?>><?php echo $row->Keterangan ?></option>
                                            <?php endforeach; endif;?>
                                        </select>
                                    </div>        
                                </div> 
            ...
            <div class="form-group"> 
                <div class="panel panel-danger">
                    <div class="panel-heading bg-default">
                    	<div class="col-md-3">
                        	<div class="checkbox">
                              <input type="checkbox" id="Jumat" name="Fri[Jumat]" value="1" <?php echo @$item->Jumat ? "checked" : ''?>><label style="color:#FFF" for="Jumat"><?php echo lang('schedules:friday_label') ?></label>
                            </div> 
                        </div>
                    </div>
                    <div class="panel-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-3">
                                        <select id="Jumat_WaktuPagiID" name="Fri[Jumat_WaktuPagiID]" class="form-control">
                                        	<option value="1">NONE</option>
											<?php if(!empty($option_times)): foreach($option_times as $row):?>
                                            <option value="<?php echo $row->WaktuID ?>" <?php echo $row->WaktuID == @$item->Jumat_WaktuPagiID ? "selected" : NULL  ?>><?php echo $row->Keterangan ?></option>
                                            <?php endforeach; endif;?>
                                        </select>
                                    </div>        
                                    <label class="col-lg-3 control-label text-center"><?php echo lang('schedules:afternoon_label') ?></label>
                                    <div class="col-lg-3">
                                        <select id="Jumat_WaktuSoreID" name="Fri[Jumat_WaktuSoreID]" class="form-control">
                                        	<option value="1">NONE</option>
											<?php if(!empty($option_times)): foreach($option_times as $row):?>
                                            <option value="<?php echo $row->WaktuID ?>" <?php echo $row->WaktuID == @$item->Jumat_WaktuSoreID ? "selected" : NULL  ?>><?php echo $row->Keterangan ?></option>
                                            <?php endforeach; endif;?>
                                        </select>
                                    </div>        
                                </div> 
            ...
            <div class="form-group"> 
                <div class="panel panel-danger">
                    <div class="panel-heading bg-default">
                    	<div class="col-md-3">
                        	<div class="checkbox">
                              <input type="checkbox" id="Sabtu" name="Sat[Sabtu]" value="1" <?php echo @$item->Sabtu ? "checked" : ''?>><label style="color:#FFF" for="Sabtu"><?php echo lang('schedules:saturday_label') ?></label>
                            </div> 
                        </div>
                    </div>
                    <div class="panel-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-3">
                                        <select id="Sabtu_WaktuPagiID" name="Sat[Sabtu_WaktuPagiID]" class="form-control">
                                        	<option value="1">NONE</option>
											<?php if(!empty($option_times)): foreach($option_times as $row):?>
                                            <option value="<?php echo $row->WaktuID ?>" <?php echo $row->WaktuID == @$item->Sabtu_WaktuPagiID ? "selected" : NULL  ?>><?php echo $row->Keterangan ?></option>
                                            <?php endforeach; endif;?>
                                        </select>
                                    </div>        
                                    <label class="col-lg-3 control-label text-center"><?php echo lang('schedules:afternoon_label') ?></label>
                                    <div class="col-lg-3">
                                        <select id="Sabtu_WaktuSoreID" name="Sat[Sabtu_WaktuSoreID]" class="form-control">
                                        	<option value="1">NONE</option>
											<?php if(!empty($option_times)): foreach($option_times as $row):?>
                                            <option value="<?php echo $row->WaktuID ?>" <?php echo $row->WaktuID == @$item->Sabtu_WaktuSoreID ? "selected" : NULL  ?>><?php echo $row->Keterangan ?></option>
                                            <?php endforeach; endif;?>
                                        </select>
                                    </div>        
                                </div> 
            ...
            <div class="form-group"> 
                <div class="panel panel-danger">
                    <div class="panel-heading bg-default">
                    	<div class="col-md-3">
                        	<div class="checkbox">
                              <input type="checkbox" id="Minggu" name="Sun[Minggu]" value="1" <?php echo @$item->Minggu ? "checked" : ''?>><label style="color:#FFF" for="Minggu"><?php echo lang('schedules:sunday_label') ?></label>
                            </div> 
                        </div>
                    </div>
                    <div class="panel-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-3">
                                        <select id="Minggu_WaktuPagiID" name="Sun[Minggu_WaktuPagiID]" class="form-control">
                                        	<option value="1">NONE</option>
											<?php if(!empty($option_times)): foreach($option_times as $row):?>
                                            <option value="<?php echo $row->WaktuID ?>" <?php echo $row->WaktuID == @$item->Minggu_WaktuPagiID ? "selected" : NULL  ?>><?php echo $row->Keterangan ?></option>
                                            <?php endforeach; endif;?>
                                        </select>
                                    </div>        
                                    <label class="col-lg-3 control-label text-center"><?php echo lang('schedules:afternoon_label') ?></label>
                                    <div class="col-lg-3">
                                        <select id="Minggu_WaktuSoreID" name="Sun[Minggu_WaktuSoreID]" class="form-control">
                                        	<option value="1">NONE</option>
											<?php if(!empty($option_times)): foreach($option_times as $row):?>
                                            <option value="<?php echo $row->WaktuID ?>" <?php echo $row->WaktuID == @$item->Minggu_WaktuSoreID ? "selected" : NULL  ?>><?php echo $row->Keterangan ?></option>
                                            <?php endforeach; endif;?>
                                        </select>
                                    </div>        
                                </div> 
...
<div class="form-group">
    <div class="col-lg-12 text-right">
        ...
        <a href="<?php echo base_url("schedules/create")?>" class="btn btn-default"><b><i class="fa fa-plus"></i> Buat Baru</b></a>
