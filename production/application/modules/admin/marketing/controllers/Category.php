...
{
	protected $nameroutes = 'marketing/category';
	...
	{
		$this->template
			->title(lang('heading:customer_category'), lang('heading:customer'))
			->set_breadcrumb(lang('heading:customer') )
			->set_breadcrumb(lang('heading:customer_category_list'), site_url($this->nameroutes))
	...
	public function create()
	{
		...
		$item = (object) [
			'Kode_Kategori' => customer_helper::gen_category_number(),
			'Kategori_Name' => NULL,
		];
		...
		$this->template
			->title(lang('heading:customer_category_create'),lang('heading:customer'))
			->set_breadcrumb(lang('heading:customer_category_list'), site_url($this->nameroutes))
			->set_breadcrumb(lang('heading:customer_category_create'))
	...
	public function update($id = 0)
	{
		...
		$this->template
			->title(lang('heading:customer_category'),lang('heading:customer'))
			->set_breadcrumb(lang('heading:customer_category_list'), site_url($this->nameroutes))
			->set_breadcrumb(lang('heading:customer_category_update'))
			->build("category/form", $this->data);
	}
	...
	{
			$config['upload_path'] = realpath(FCPATH . '../../assets/category-customer/photos');
			...
			if( $personal_picture && file_exists( realpath(FCPATH . "../../assets/category-customer/photos/{$personal_picture}") ) )
			{
