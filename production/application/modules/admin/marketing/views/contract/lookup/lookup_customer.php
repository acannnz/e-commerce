    ...
    function lookupbox_row_selected( response ){
        ...
        if( _response ){
            ...
            try {
                ...
                $("#CustomerID").val( _response.Customer_ID );
				$("#NamaCustomer").val( _response.Kode_Customer+' - '+_response.Nama_Customer );
			...
			$.fn.extend({
					dataTableInit: function(){
							...
							var _datatable = _this.DataTable( {
								...
								//scrollY: "200px",
								ajax: {
										url: "<?php echo base_url("marketing/customer/lookup_collection") ?>",
										type: "POST",
