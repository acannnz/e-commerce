	...
	<div class="col-md-offset-2 col-md-8">
		<div class="panel panel-default">
            <div class="panel-heading">  
				<div class="row">
					<div class="col-md-6">
		                <h3 class="panel-title"><?php echo lang('heading:discount_list'); ?></h3>
					</div>
					<div class="col-md-6">
				...
				<div class="row">
					<div class="col-md-12">
						<div class="form-group">
							<table id="dt_discount" class="table table-bordered table-hover" width="100%" cellspacing="0">
								<thead>
									<tr>
										...
										<th><?php echo lang('label:account') ?></th>
										<th><?php echo lang('label:with_operator') ?></th>
...
(function( $ ){
						...
						var _datatable = _this.DataTable( {		
							...
							columns: [
									...
									{ 
										data: 'Akun_No',
										render: function( val, type, row ){
											return ( row.Akun_No != null )
													? row.Akun_No +' - '+ row.Akun_Name
													: '';
										}
									},
									{ 
										...
										render: function( val ){
											return val == 'T' 
													? '<span class="label label-info"><?php echo lang('global:yes')?></span>'
													: '<span class="label label-default"><?php echo lang('global:no')?></span>';
										}
									},
									{ 
										data: 'IDDiscount',
		...
		$( document ).ready(function(e) {
				...
				_form.find("button[name=\"btn_search\"]").on("click", function(e){
						$( "#dt_discount" ).DataTable().ajax.reload();
				});					
					
				$("#dt_discount").DataTableInit();
