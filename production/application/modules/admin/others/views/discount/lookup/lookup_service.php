...
<div class="modal-body">
    ...
    function lookupbox_row_selected( response ){
        ...
        if( _response ){
            ...
            try {
                ...
                $("#dt_form_discount_service").DataTable().row.add( _row ).draw();
	...
	<div class="table-responsive">
		<table id="dt-service" class="table table-sm table-bordered table-hover" width="100%">
			<thead>
				<tr>
					<th></th>
	...
	(function( $ ){
			$.fn.extend({
					dataTableInit: function(){
							...
							var _datatable = _this.DataTable( {
								...
								//scrollY: "200px",
								ajax: {
										url: "<?php echo base_url("others/service/lookup_collection") ?>",
										type: "POST",
								...
								columns: [
										{ 
											...
											render: function ( val, type, row ){
													var data = {'JasaID' : row.JasaID, 'JasaName': row.JasaName};
			...
			var _datatable = $( "#dt-service" ).dataTableInit();
