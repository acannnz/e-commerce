    ...
    function lookupbox_row_selected( response ){
        ...
        if( _response ){
            ...
            try {
                ...
                $("#PendapatanObatAkun_ID").val( _response.Akun_ID );
				$("#NamaPendapatanObatAkun_ID").val( _response.Akun_No+' - '+_response.Akun_Name );
			...
			$.fn.extend({
					dataTableInit: function(){
							...
							var _datatable = _this.DataTable( {
								...
								//scrollY: "200px",
								ajax: {
										url: "<?php echo base_url("others/account/lookup_collection") ?>",
										type: "POST",
								...
								columns: [
										{ 
											...
											render: function ( val, type, row ){
													var data = {'Akun_ID' : row.Akun_ID, 'Akun_No' : row.Akun_No, 'Akun_Name': row.Akun_Name};
