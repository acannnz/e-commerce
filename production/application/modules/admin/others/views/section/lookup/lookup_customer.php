...
<div class="modal-body">
    ...
    function lookupbox_row_selected( response ){
        ...
        if( _response ){
            ...
            try {
				...
				$("#NamaCustomer_ID").val( _response.Kode_Customer+' - '+_response.Nama_Customer );
	...
	<div class="table-responsive">
		<table id="dt-account" class="table table-sm table-bordered table-hover" width="100%">
			<thead>
				<tr>
					<th></th>
	...
	(function( $ ){
			$.fn.extend({
					dataTableInit: function(){
							...
							var _datatable = _this.DataTable( {
								...
								//scrollY: "200px",
								ajax: {
										url: "<?php echo base_url("others/customer/lookup_collection") ?>",
										type: "POST",
								...
								columns: [
										{ 
											...
											render: function ( val, type, row ){
													var data = {'Customer_ID' : row.Customer_ID, 'Kode_Customer': row.Kode_Customer, 'Nama_Customer' : row.Nama_Customer};
										...
										{data: "Kode_Customer",className: "text-center",width: "120px",},
										{data: "Nama_Customer"},
										{data: "Alamat_1", render:function(val){return val.substr(0, 45)}}
									]
							} );
			...
			var _datatable = $( "#dt-account" ).dataTableInit();
