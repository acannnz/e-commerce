	...
	<div class="col-md-offset-2 col-md-8">
		<div class="panel panel-default">
            <div class="panel-heading">  
				<div class="row">
					<div class="col-md-6">
		                <h3 class="panel-title"><?php echo lang('heading:schedule_time_list'); ?></h3>
					</div>
					<div class="col-md-6">
			...
			<div class="panel-body">
				<div class="row">
					<div class="col-md-12">
						<div class="form-schedule_time">
							<table id="dt_schedule_time" class="table table-bordered table-hover" width="100%" cellspacing="0">
								<thead>
									<tr>
										...
										<th><?php echo lang('label:from_hour') ?></th>
										<th><?php echo lang('label:till_hour') ?></th>
...
(function( $ ){
		...
		$( document ).ready(function(e) {
				...
				_form.find("button[name=\"btn_search\"]").on("click", function(e){
						$( "#dt_schedule_time" ).DataTable().ajax.reload();
				});					
					
				$("#dt_schedule_time").DataTableInit();
