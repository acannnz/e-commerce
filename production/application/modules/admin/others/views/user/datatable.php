	...
	<div class="col-md-offset-2 col-md-8">
		<div class="panel panel-default">
            <div class="panel-heading">  
				<div class="row">
					<div class="col-md-6">
		                <h3 class="panel-title"><?php echo lang('heading:user_list'); ?></h3>
					</div>
					<div class="col-md-6">
			...
			<div class="panel-body">
				<div class="row">
					<div class="col-md-12">
						<div class="form-user">
							<table id="dt_user" class="table table-bordered table-hover" width="100%" cellspacing="0">
								<thead>
									<tr>
										...
										<th><?php echo lang('label:nick_name') ?></th>
						...
						var _datatable = _this.DataTable( {		
							...
							columns: [
									...
									{ 
										...
										render: function ( val ) {
											return '<span class="btn btn-xs btn-'+ ( val ? 'success' : 'default') +'">'+ ( val ? '<?php echo lang('global:active')?>' : '<?php echo lang('global:inactive')?>') +'</span>';
										}
									},
									{ 
										data: 'User_ID',
