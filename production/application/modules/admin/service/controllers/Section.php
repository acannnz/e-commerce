...
{
	protected $nameroutes = 'service/section';
	...
	public function datatable_collection()
	{
		...
		$db_where['a.UnitBisnisID'] = '1';
		$db_where_in['a.TipePelayanan'] = ['RI', 'RJ', 'PENUNJANG'];
		...
		if( !empty($db_where_in) ){ $this->db->where_in( 'a.TipePelayanan', $db_where_in['a.TipePelayanan'] ); }
