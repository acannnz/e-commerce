	...
	<div class="col-md-offset-2 col-md-8">
		<div class="panel panel-default">
            <div class="panel-heading">  
				<div class="row">
					<div class="col-md-6">
		                <h3 class="panel-title"><?php echo lang('heading:class_list'); ?></h3>
					</div>
					<div class="col-md-6">
				...
				<div class="row">
					<div class="col-md-12">
						<div class="form-class">
							<table id="dt_class" class="table table-bordered table-hover" width="100%" cellspacing="0">
								<thead>
									<tr>
...
(function( $ ){
						...
						var _datatable = _this.DataTable( {		
							...
							columns: [
									...
									{data: 'NamaKelas'},
									{
										...
										render: function( val ){
											return val == 1 
												? '<span class="label label-success"><?php echo lang('global:active')?></span>'
												: '<span class="label label-default"><?php echo lang('global:inactive')?></span>';
										}
									},
									{ 
										data: 'KelasID',
		...
		$( document ).ready(function(e) {
				...
				_form.find("button[name=\"btn_search\"]").on("click", function(e){
						$( "#dt_class" ).DataTable().ajax.reload();
				});					
					
				$("#dt_class").DataTableInit();
