	...
	<div class="col-md-offset-2 col-md-8">
		<div class="panel panel-default">
            <div class="panel-heading">                
                ...
                <h3 class="panel-title"><?php echo (@$is_edit) ? lang('heading:injury_type_update') : lang('heading:injury_type_create'); ?></h3>
            </div>
            <div class="panel-body table-responsive">
          		<div class="row">
            		<div class="col-md-12 col-xs-12">
                        <div class="form-group">
							<?php echo form_label(lang('label:code').' *', 'KodeLuka', ['class' => 'control-label col-md-3']) ?>
							<div class="col-md-9">
								<?php echo form_input('f[KodeLuka]', set_value('f[KodeLuka]', @$item->KodeLuka, TRUE), [
										'id' => 'KodeLuka', 
										'placeholder' => '', 
										'class' => 'form-control',
										'readonly' => (@$is_edit) ? 'readonly' : FALSE
									]); ?>
							</div>
                        </div>
						<div class="form-group">
