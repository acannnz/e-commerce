	...
	<div class="col-md-offset-2 col-md-8">
		<div class="panel panel-default">
            <div class="panel-heading">                
                ...
                <h3 class="panel-title"><?php echo (@$is_edit) ? lang('heading:service_devices_update') : lang('heading:service_devices_create'); ?></h3>
            </div>
            <div class="panel-body table-responsive">
          		<div class="row">
            		<div class="col-md-12 col-xs-12">
                        <div class="form-group">
                        <?php echo form_label(lang('label:code').' *', 'IDAlat', ['class' => 'control-label col-md-3']) ?>
                        <div class="col-md-9">
							<?php echo form_input('f[IDAlat]', set_value('f[IDAlat]', @$item->IDAlat, TRUE), [
									'id' => 'IDAlat', 
									'placeholder' => '', 
									'readonly' => 'readonly',
									'class' => 'form-control'
                        ...
                        <div class="form-group">
                            <?php echo form_label(lang('label:name').' *', 'NamaAlat', ['class' => 'control-label col-md-3']) ?>
							<div class="col-md-9">
								<?php echo form_input('f[NamaAlat]', set_value('f[NamaAlat]', @$item->NamaAlat, TRUE), [
										'id' => 'NamaAlat', 
										'required' => 'required',
										'class' => 'form-control'
									]); ?>
