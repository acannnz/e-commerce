	...
	<div class="col-md-12">
		<div class="panel panel-default">
            <div class="panel-heading">  
				<div class="row">
					<div class="col-md-6">
		                <h3 class="panel-title"><?php echo lang('heading:service_category_list'); ?></h3>
					</div>
					<div class="col-md-6">
				...
				<div class="row">
					<div class="col-md-12">
						<div class="form-category">
							<table id="dt_category" class="table table-bordered table-hover" width="100%" cellspacing="0">
								<thead>
									<tr>
										...
										<th><?php echo lang('label:international_name') ?></th>
										<th><?php echo lang('label:service_group') ?></th>
...
(function( $ ){
				...
				DataTableInit: function(){
						...
						var _datatable = _this.DataTable( {		
							...
							columns: [
									...
									{data: 'KategoriJasaName'},
									{data: 'NamaInternational'},
									{data: 'GroupJasaName'},
									{ 
										data: 'KategoriJasaID',
										className: "",
		...
		$( document ).ready(function(e) {
				...
				_form.find("button[name=\"btn_search\"]").on("click", function(e){
						$( "#dt_category" ).DataTable().ajax.reload();
				});					
					
				$("#dt_category").DataTableInit();
