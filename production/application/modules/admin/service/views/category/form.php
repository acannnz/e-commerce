	...
	<div class="col-md-offset-2 col-md-8">
		<div class="panel panel-default">
            <div class="panel-heading">                
                ...
                <h3 class="panel-title"><?php echo (@$is_edit) ? lang('heading:service_category_update') : lang('heading:service_category_create'); ?></h3>
            </div>
            <div class="panel-body table-responsive">
          		<div class="row">
            		<div class="col-md-12 col-xs-12">
                        <div class="form-group">
                        <?php echo form_label(lang('label:code').' *', 'KategoriJasaID', ['class' => 'control-label col-md-3']) ?>
                        <div class="col-md-9">
							<?php echo form_input('f[KategoriJasaID]', set_value('f[KategoriJasaID]', @$item->KategoriJasaID, TRUE), [
									'id' => 'KategoriJasaID', 
									'placeholder' => '', 
									'readonly' => 'readonly',
									'class' => 'form-control'
                        ...
                        <div class="form-group">
                            <?php echo form_label(lang('label:name').' *', 'KategoriJasaName', ['class' => 'control-label col-md-3']) ?>
							<div class="col-md-9">
								<?php echo form_input('f[KategoriJasaName]', set_value('f[KategoriJasaName]', @$item->KategoriJasaName, TRUE), [
										'id' => 'KategoriJasaName', 
										'required' => 'required',
										'class' => 'form-control'
									]); ?>
						...
						<div class="form-group">
                            <?php echo form_label(lang('label:service_group'), 'GroupJasa', ['class' => 'control-label col-md-3']) ?>
							<div class="col-md-9">
								<?php echo form_dropdown('f[GroupJasa]', $dropdown_service_group, set_value('f[GroupJasa]', @$item->GroupJasa, TRUE), [
										'id' => 'GroupJasa', 
										'class' => 'form-control'
									]); ?>
							</div>
