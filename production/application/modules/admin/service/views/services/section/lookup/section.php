    ...
    function lookupbox_row_selected( response ){
        ...
        if( _response ){
            ...
            try {
				...
				$('#dt_form_section').DataTable().row.add( _response ).draw();                                                                
			...
			$.fn.extend({
					dataTableInit: function(){
							...
							var _datatable = _this.DataTable( {
								...
								scrollCollapse: true,
								ajax: {
										url: "<?php echo base_url("service/section/lookup_collection") ?>",
										type: "POST",
								...
								columns: [
										{ 
											...
											render: function ( val, type, row ){
													var data = {'SectionID' : row.SectionID, 'SectionName': row.SectionName};
