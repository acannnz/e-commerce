    ...
    function lookupbox_row_selected( response ){
        ...
        if( _response ){
            ...
            try {
				...
				$('#NamaDokter').val( _response.Nama_Supplier );
			...
			$.fn.extend({
					dataTableInit: function(){
							...
							var _datatable = _this.DataTable( {
								...
								scrollCollapse: true,
								ajax: {
										url: "<?php echo base_url("service/supplier/lookup_collection") ?>",
										type: "POST",
										data: function( params ){
											params["doctor_only"] = 1;
										}
									},
								columns: [
										{ 
											...
											render: function ( val, type, row ){
													var data = {'Kode_Supplier' : row.Kode_Supplier, 'Nama_Supplier': row.Nama_Supplier};
