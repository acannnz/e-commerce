				...
				DataTableInit: function(){
						...
						var _datatable = _this.DataTable( {		
							...
							columns: [
									...
									{ data: 'CreatedAt', name: 'a.CreatedAt', className: 'text-center'},
									{ data: 'NoUrut', name: 'a.NoUrut', className: 'text-center'},
									{ data: 'NRM', name: 'c.NRM', className: 'text-center'},
									{ data: 'NamaPasien', name: 'c.NamaPasien',},
									{ data: 'SectionName', name: 'd.SectionName',},
									{ data: 'DokterName', name: 'e.Supplier_Name',},
									{ 
										data: 'NoReg',
										className: "text-center",
										orderable: false,
