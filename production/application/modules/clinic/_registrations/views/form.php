				...
				_datatable = _this.DataTable({
					...
					columns: [{
							...
							render: function(val, type, row, meta) {
								return String("<a href=\"javascript:;\" title=\"<?php echo lang("buttons:remov") ?>\" class=\"btn btn-danger btn-remove\"><i class=\"fa fa-times\"></i></a>")
							}
						},
						{
							data: "SectionName",
						...
						},
						{
							...
							render: function(val, type, row, meta) {
								...
								return val.substr(10, 10); // Mengembalikan val Waktu jika ada
							}
						},
						// {
						// 	data: "Keterangan",
