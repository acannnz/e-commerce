...
class Data_open extends Admin_Controller
{
	...
	public function index()
	{
		$data = [
			...
			'cek_resep_url' =>  base_url("pharmacy/pharmacies/data_open/cek_resep")
		];
		
		$this->load->view('pharmacies/datatable/open', (isset($data) ? $data : NULL));
	}
	...
	public function cek_resep()
	{
		if ($this->input->is_ajax_request()) {
			...
			$queue_left = $this->db
				->select("COUNT(NoResep) as queue_left")
				->where([
					"Realisasi" => 0,
					"Tanggal >=" => $params->date_from,
					"Tanggal <=" => $params->date_till
