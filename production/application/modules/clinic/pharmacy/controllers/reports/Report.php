...
{ 
	...
	public function transaction_recap_by_section_doctor()
	{
		...
		$this->template
				->set( "heading", 'Laporan Rekap Pendapatan Section &amp; Dokter' )
				->set_breadcrumb( lang("reports:page") )
				->set_breadcrumb( 'Laporan Rekap Pendapatan Section &amp; Dokter', base_url("{$this->nameroutes}/transaction_recap_by_section_doctor") )
	...
	public function transaction_recap_by_service_group()
	{
		...
		$this->template
				->set( "heading", 'Laporan Rekap Pendapatan Section &amp; Dokter Dengan Grup Jasa' )
				->set_breadcrumb( lang("reports:page") )
				->set_breadcrumb( 'Laporan Rekap Pendapatan Section &amp; Dokter Dengan Grup Jasa', base_url("{$this->nameroutes}/transaction_recap_by_service_group") )
