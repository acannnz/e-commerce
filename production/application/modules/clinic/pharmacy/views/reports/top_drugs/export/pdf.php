    ...
    <div class="row" style="margin:0 !important;">
    	<div class="col-lg-12" style="margin:0 !important;">
        	...
        	<div class="row text-center" style="margin:0 !important;">
            	<h4>
                    <?php echo sprintf("%s ", 'Laporan Top 10  Penggunaan Obat'); ?><br>
                        ...
                        <table class="table_header">
                            <thead>
                                <tr>
                                    ...
                                    <th align="center"><?php echo 'Jumlah Obat Terpakai'; ?></th>
                                </tr> 
                            </thead>
                            <tbody>	
                                ...
                                <tr>
                                    ...
                                    <td align="center"><?php echo @$row->NamaResepObat ?></td>
                                    <td align="center"><?php echo @$row->Jumlah ?></td>
                                </tr>
                                <?php endforeach; else: ?>
                                <tr>
                                    <td colspan="3" align="center"><?php echo lang("reports:none_data_label"); ?></td>
                                </tr>
                                <?php endif; ?>
                            </tbody>
                        </table>
