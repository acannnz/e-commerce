	...
	<div class="panel-body">
		<div class="row">
			...
			<div class="col-md-4">
				...
				<div class="form-group">
					<label class="col-lg-3 control-label"><?php echo "Pasien Reg" ?></label>
					<div class="col-lg-9">
				...
				<div class="form-group">
					<label class="col-lg-3 control-label"><?php echo "Master Pasien" ?></label>
					<div class="col-lg-9">
						<div class="input-group">
							<input type="text" id="Nama" name="f[Nama]" placeholder="" class="form-control patient">
							<span class="input-group-btn">
								<a href="<?php echo @$lookup_patient ?>" data-toggle="lookup-ajax-modal" class="btn btn-default"><i class="fa fa-search"></i></a>
								<a href="javascript:;" id="prescription" class="btn btn-default btn-clear"><i class="fa fa-times"></i></a>
							</span>
						</div>
					</div>
				...
				<div class="form-group">
					...
					<div class="col-lg-9">
						<input type="text" id="Phone" name="f[Phone]" value="<?php echo @$item->Phone ?>" placeholder="" class="form-control">
					</div>
				</div>
			</div>
			<div class="col-md-4">
			...
			$("form[name=\"form_pharmacy\"]").on("submit", function(e) {
				...
				try {
					...
					var farmasi = {
						...
						JenisPewatan: "RJ",
						Keterangan: $("#NamaPasien").val() || $("#Nama").val(), //|| $("#Nama").val()
