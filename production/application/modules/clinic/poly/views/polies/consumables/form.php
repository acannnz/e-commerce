            ...
            <div class="row form-group">
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                        	<select id="Farmasi_SectionID" name="Farmasi_SectionID" class="form-control">
                           		<option value="<?php config_item('section_id')?>" >Poli Umum</option>
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                        	<input type="text" id="bhpDoctorName" name="Nama_Supplier" value="<?php echo @$doctor->Nama_Supplier?>" class="form-control" readonly />
                        </div>
                    </div>
                    <div class="form-group">
		...
		$.fn.extend({
				dt_products: function(){
						...
						_datatable = _this.DataTable( {
								...
								columnDefs  : [
										{
											"targets": ["HargaOrig", "HargaPersediaan"],
											"visible": false,
											"searchable": false
										}
									],
				...
				$("form[id=\"form_consumables\"]").on("submit", function(e){
					...
					var data_post = { };
						data_post['f'] = {
							...
							"SectionAsalID" : "<?php echo config_item('section_id'); ?>",
							...
							"KomisiDokter" : '0,00',
							"SectionInput" : "<?php config_item('section_id')?>",
							"TipeTransaksi" : "POP",
