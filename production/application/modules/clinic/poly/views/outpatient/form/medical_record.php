		...
		<div class="row">
			...
			<div class="col-md-6">                        
				<div class="form-group">
					...
					<div class="form-group input-group">
						<input type="number" id="vitalHeight" name="v[Height]" value="<?php echo @$vital->Height ?>" min="0" step="0.01" placeholder="" class="form-control">
			...
			<div class="col-md-6">                        
				<div class="form-group">
					...
					<div class="form-group input-group">
						<input type="number" id="vitalWeight" name="v[Weight]" value="<?php echo @$vital->Weight ?>" min="0"  step="0.01" placeholder="placeholder" class="form-control">
		...
		<div class="row">
			<div class="col-md-6">                        
				<div class="form-group">
					...
					<div class="form-group input-group">
						<input type="number" id="vitalTemperature" name="v[Temperature]" value="<?php echo @$vital->Temperature != 0 ? @$vital->Temperature : 36.5  ?>" min="0" step="0.01" placeholder="" class="form-control">
			...
			<div class="col-md-6">                        
				<div class="form-group">
					...
					<div class="form-group input-group">
						<input type="number" id="vitalSystolic" name="v[Systolic]" value="<?php echo @$vital->Systolic != 0 ? @$vital->Systolic : 120;  ?>" step="0.01" placeholder="" class="form-control" />
						<span class="input-group-addon">/</span>
						<input type="number" id="vitalDiastolic" name="v[Diastolic]" value="<?php echo @$vital->Diastolic != 0 ? @$vital->Diastolic : 74; ?>" step="0.01" placeholder="" class="form-control" />
		...
		<div class="row">
			<div class="col-md-6">                        
				<div class="form-group">
					...
					<div class="form-group input-group">
						<input type="number" id="vitalHeartRate" name="v[HeartRate]" value="<?php echo @$vital->HeartRate != 0 ? @$vital->HeartRate : 60; ?>" placeholder="" class="form-control">
			...
			<div class="col-md-6">                        
				<div class="form-group">
					...
					<div class="form-group input-group">
						<input type="number" id="vitalRespiratoryRate" name="v[RespiratoryRate]" value="<?php echo @$vital->RespiratoryRate != 0 ? @$vital->RespiratoryRate : 20 ?>" placeholder="" class="form-control">
		...
		<div class="row">
			<div class="col-md-6">                        
				<div class="form-group">
					...
					<div class="form-group">
						<textarea id="soapSubjective" name="soap[Subjective]" placeholder="" rows="5" class="form-control"><?php echo @$soap->Subjective ?></textarea>
					</div>
				</div>
			</div>
			<div class="col-md-6">                        
				<div class="form-group">
					...
					<div class="form-group">
						<textarea id="soapObjective" name="soap[Objective]" placeholder="" rows="5" class="form-control"><?php echo @$soap->Objective ?></textarea>
					</div>
				</div>
			</div>
		</div>
		<div class="row">
			<div class="col-md-6">                        
				<div class="form-group">
					...
					<div class="form-group">
						<textarea id="soapAssessment" name="soap[Assessment]" placeholder="" rows="5" class="form-control"><?php echo @$soap->Assessment ?></textarea>
					</div>
				</div>
			</div>
			<div class="col-md-6">                        
				<div class="form-group">
					...
					<div class="form-group">
						<textarea id="soapPlan" name="soap[Plan]" placeholder="" rows="5" class="form-control"><?php echo @$soap->Plan ?></textarea>
					</div>
				</div>
			</div>
		</div>
