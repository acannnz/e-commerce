...
class Helpers extends Admin_Controller
{
	...
	public function index( $item = NULL )
	{
		$data = array(
				...
				"get_helper_number" => base_url("{$this->nameroutes}/helpers/get_helper_number"),
				"get_helper_section" => base_url("{$this->nameroutes}/helpers/get_helper_section"),
			);

		$this->load->view( 'polies/form/helpers', $data );		
	}
