...
<?php echo form_open( base_url("registrations/reports/polyclinic-registrations/export"), array("target" => "_blank") ); ?>
		...
		<div class="form-group">
			...
			<div class="col-md-9">
				<div class="input-group">
					<input type="hidden" name="f[DokterID]" id="DokterID" value="" placeholder="" class="doctor">
					<input type="text" id="DokterName" value="" placeholder="" class="form-control doctor" readonly>
					<span class="input-group-btn">
						<a href="<?php echo @$lookup_doctor ?>" data-toggle="lookup-ajax-modal" class="btn btn-success" ><i class="fa fa-search"></i></a>
						<a href="javascript:;" id="" class="btn btn-danger btn-clear" data-target=".doctor" ><i class="fa fa-times"></i></a>
					</span>
				</div>
			</div>
        </div>
