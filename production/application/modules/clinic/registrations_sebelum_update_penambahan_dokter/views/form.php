						...
						<div class="row">
							...
							<div class="col-md-3">
								<div class="form-group">
									...
									<div class="form-group input-group">
										<input type="number" id="vitalOxygenSaturationLingkarPerut=" v[OxygenSaturation]" value="<?php echo $vital->OxygenSaturation ?>" placeholder="" class="form-control">
							...
							<div class="col-md-2">
								<div class="form-group">
									...
									<div class="form-group input-group">
										<input type="number" id="vitallingkarPerut" name="v[lingkarPerut]" value="<?php echo $vital->lingkarPerut ?>" placeholder="" class="form-control">
										<span class="input-group-addon help-block"> CM </span>
									</div>
								</div>
							</div>
						...
						<div class="row">
							...
							<div class="col-md-6">
								...
								<div class="form-group">
									<div class="row">
										<div class="col-md-6">
											<label class="control-label"><?php echo "Riwayat Alergi" ?></label>
											<textarea id="RiwayatAlergi" name="p[RiwayatAlergi]" placeholder="" class="form-control patient" rows="5"><?php echo @$patient->RiwayatAlergi ?></textarea>
										</div>
										<div class="col-md-6">
											<label class="control-label"><?php echo "Catatan Pasien" ?></label>
											<textarea id="CatatanPatient" name="p[CatatanPatient]" placeholder="" class="form-control patient" rows="5"><?php echo @$patient->CatatanPatient ?></textarea>
										</div>
									</div>
								</div>
							</div>
