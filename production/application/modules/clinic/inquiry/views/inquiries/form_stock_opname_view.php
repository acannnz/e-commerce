	...
	<div class="panel-body">
			...
			<div class="row">
				<div class="col-md-6">
					...
					<div class="form-group">
						...
						<div class="col-lg-9">
							<input type="text" id="tanggal" name="f[tanggal]" value="<?php echo @$item->Tgl_Opname ?>" placeholder="" class="form-control" readonly>
						</div>
					</div>
				</div>
				<div class="col-md-6">
		...
		<div class="row">
			...
			<div class="col-lg-6 text-right">
				...
				<a href="<?php echo @$print_stock_opname ?>" target="_blank" class="btn btn-info"><b><i class="fa fa-print"></i> Print</b></a>
				<?php if(@$item->Posted): ?>
				<a href="<?php echo @$print_stock_opname ?>/1" target="_blank" class="btn btn-info"><b><i class="fa fa-print"></i> Print Dengan Harga</b></a>
				<?php endif; ?>
