            	...
            	<div class="col-sm-12" style="padding:0;font-size:12px;">
                    <table id="detail_table" class="table" style="font-size:12px">
                        <tr>
							...
							<?php endif;?>
							<th align="center">Harga Rata-Rata</th>
							<th align="center">Total</th>
                        </tr>
						<?php $total_system = $total_physical = $total_gap = 0; $total = 0; ?>
                       	<?php $i=1; foreach($collection as $row): ?>
						<?php $total = $total + $row->Harga_Rata * $row->Qty_Opname; ?>
                        <tr>
							...
							<td align="right"><?php echo number_format( ($row->Harga_Rata * $row->Qty_Opname), 2, ',', '.') ?></td>
                        </tr>
						<?php
