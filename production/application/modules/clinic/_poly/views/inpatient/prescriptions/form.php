            ...
            <div class="row">
				<div class="col-md-3">
                    <div class="form-group">
						...
						<input type="text" id="NoResep" name="NoResep" value="<?php echo @$item->NoResep ?>" class="form-control" />
					</div>
				</div>
                <div class="col-md-3">
                    <div class="form-group">
				...
				<div class="col-md-3">
                    <div class="form-group">
                    	<label class="control-label">DokterID</label>
						<div class="input-group">
							<input type="hidden" id="prescriptionDokterID" name="DokterID" class="form-control" value="<?php echo @$item->DokterID ?>" />
							<input type="text" id="prescriptionDoctorName" name="prescriptionDoctorName" class="form-control" value="<?php echo @$item->NamaDokter ?>" />
                    ...
                    <div class="form-group">	
						...
						<label class="col-md-4">
                            <div class="checkbox" style="margin-top:0 !important">
                                ...
                                <input type="checkbox" id="IncludeJasa" name="IncludeJasa" value="1" <?php echo @$item->IncludeJasa == 1 ? "Checked" : NULL ?> class=""><label for="IncludeJasa">IncludeJasa</label>
                            </div>
                        </label>
						<label class="col-md-4">
                            <div class="checkbox" style="margin-top:0 !important">
						...
						<div class="input-group">
							...
							<span class="input-group-btn">
								<a href="javascript:;" id="BtnTambahRacikan" class="btn btn-default disabled"><i class="fa fa-plus"> Racikan</i></a>
							</span>
						</div>
                    </div>
				</div>
				<div class="col-md-3">
                    <div class="form-group">
						...
						<div class="input-group">
							...
							<span class="input-group-btn">
								<a href="<?php echo @$lookup_product ?>" data-toggle="lookup-ajax-modal" class="btn btn-info" title="Cari obat..."><i class="fa fa-search"></i></a>
								<a href="javascript:;" id="detail_form" class="btn btn-danger" title="Bersihkan info obat..."><i class="fa fa-times"></i></a>
							</span>
						</div>
					</div>
				</div>
		...
		var _datatable_actions = {
				init: function(){
						...
						$("#add_product").on("click", function(e){
							...
							{
								$.alert_warning('Pilih Obat Sebelum ditambahkan kedalam resep');
								return false;
							}
						...
						$("#detail_form").on("click", function(e){
							$('.detail_form').val('');
							$("#product_object").data("product", {});
						});
								...
								columns: [
										{ 
											...
											render: function( val, type, row, meta ){
													return String("<a href=\"javascript:;\" title=\"<?php echo lang( "buttons:remove" ) ?>\" class=\"btn btn-danger btn-remove\"><i class=\"fa fa-trash\"></i></a>")
												} 
										},
										{ 
											data: "Kode_Barang", 
