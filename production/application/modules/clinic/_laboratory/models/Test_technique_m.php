...
class Test_technique_m extends Public_Model
{
	public $table = 'LISmTeknikPemeriksaan'; 
	public $index_key = 'TeknikPemeriksaan';
	...
	public function __construct()
	{
		$this->rules = array('insert' => array(
			array(
					'field' => 'TeknikPemeriksaan',
					'label' => 'Nama Teknik Pemeriksaan',
					'rules' => 'required'
				),
			array(
					'field' => 'Aktif',
	...
	{
		$result = array();
		$this->db->select('TeknikPemeriksaan');
		$this->db->from('LISmTeknikPemeriksaan');
		$query = $this->db->get();
