...
{
	protected $nameroutes = 'medical_record/reports';
	...
	public function medical_records()
	{
		...
		$this->template
			->build('medical_record/reports/medical_records/datatable', $data);
	}
...
EOSQL;
	...
	public function group_by_icd()
	{
		...
		$this->template
			->build('medical_record/reports/group_by_icd/datatable', $data);
	}
...
EOSQL;
	...
	public function daily_registration()
	{
		...
		$this->template
			...
			->build('medical_record/reports/daily_registration/datatable', $data);
	}
	...
	public function patient_certificate($NoReg = NULL)
	{
		...
		if ($this->input->is_ajax_request()) {
			$data = array(
				...
				"is_modal" => TRUE,
				"lookup_registration" => base_url("medical_record/reports/lookup_registration"),
			...
			$this->template
				...
				->set_breadcrumb("Surat Keterangan Pasien", base_url("medical_record/patient_certificate"))
				->set_breadcrumb(lang("reports:pay_heading"))
				->build('medical_record/reports/patient_certificate/datatable', $data);
		}
	}
...
EOSQL;
	...
	public function average_age_patient()
	{
		...
		$this->template
				->set( "heading", "Laporan Usia Rata-Rata Pasien" )
				->set_breadcrumb( "Laporan Usia Rata-Rata Pasien" )
				->build("medical_record/reports/average_age_patient/index", $data);
	}
	...
	public function average_age_patient_collection()
	{
		...
		$AnakFemale = $this->db
			...
			->where_in("StatusPeriksa", ["Sudah","CO"])
			->where(['a.UmurThn <=' => 18,
					'a.Batal' => 0,
					'JenisKelamin' => 'F',
