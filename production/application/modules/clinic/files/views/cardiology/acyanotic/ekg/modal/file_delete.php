...
<div class="modal-dialog">
    <div class="modal-content">
        <?php echo form_open(current_url(), array("id" => "form_files_cardiology_acyanotic_ekg_file_delete", "name" => "form_files_cardiology_acyanotic_ekg_file_delete")); ?>
...
;(function( $ ){
		$.fn.extend({
				form_files_cardiology_acyanotic_ekg_file_delete: function(){
		...
		$( document ).ready(function(e) {
            	$( "form[name=\"form_files_cardiology_acyanotic_ekg_file_delete\"]" )
					.form_files_cardiology_acyanotic_ekg_file_delete();
        	});
	})( jQuery );
//]]>
</script>
