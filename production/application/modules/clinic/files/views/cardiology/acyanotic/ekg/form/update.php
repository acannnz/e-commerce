...
?>
<?php echo form_open_multipart(current_url(), array('id' => 'form_files_cardiology_acyanotic_ekg', 'name' => 'form_files_cardiology_acyanotic_ekg')); ?>
    <h5><?php echo lang( "acyanotic:ekg_subtitle" ) ?></h5>
    <div class="form-group">
        <label class="col-md-12"><?php echo lang("acyanotic:ekg_label") ?></label>
        <div class="col-md-12">
...
;(function( $ ){
		$.fn.extend({
				form_files_cardiology_acyanotic_ekg: function( remote_server ){
		...
		$( document ).ready(function(e) {
            	$( "form[name=\"form_files_cardiology_acyanotic_ekg\"]" )
					.form_files_cardiology_acyanotic_ekg( "<?php echo @$update_action ?>" );
        	});
	})( jQuery );
//]]>
</script>
