...
<div class="row">
    <div class="col-md-12">
        <?php echo form_open_multipart(current_url(), array('id' => 'form_files_cardiology_acyanotic_roentgen_upload', 'name' => 'form_files_cardiology_acyanotic_roentgen_upload', 'class' => 'drop-box text-center')); ?>
...
;(function( $ ){
		...
		$.fn.extend({
				form_files_cardiology_acyanotic_roentgen_upload: function( remote_server ){
		...
		$( document ).ready(function(e) {
            	$( "form[name=\"form_files_cardiology_acyanotic_roentgen_upload\"]" )
					.form_files_cardiology_acyanotic_roentgen_upload( "<?php echo @$form_action ?>" );
        	});
	})( jQuery );
//]]>
</script>
