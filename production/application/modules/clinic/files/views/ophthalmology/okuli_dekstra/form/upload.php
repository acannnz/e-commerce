...
<div class="row">
    <div class="col-md-12">
        <?php echo form_open_multipart(current_url(), array('id' => 'form_files_ophthalmology_od_upload', 'name' => 'form_files_ophthalmology_od_upload', 'class' => 'drop-box text-center')); ?>
...
;(function( $ ){
		...
		$.fn.extend({
				form_files_ophthalmology_od_upload: function( remote_server ){
						...
						var show_files = function( files ){
							...
							uploaded_files = function( files ){
									try{
										var _form_v = $( "form#form_files_ophthalmology_od" );
										...
										img.attr( "src", "<?php echo base_url( "resource/patients/ophthalmology" ) ?>/" + (files.file_name || "default_picture_od.jpg") + "?rund=" + (new Date()).getTime() );											
		...
		$( document ).ready(function(e) {
            	$( "form[name=\"form_files_ophthalmology_od_upload\"]" )
					.form_files_ophthalmology_od_upload( "<?php echo @$form_action ?>" );
        	});
	})( jQuery );
//]]>
</script>
