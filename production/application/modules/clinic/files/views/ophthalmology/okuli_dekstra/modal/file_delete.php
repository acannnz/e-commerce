...
<div class="modal-dialog">
    <div class="modal-content">
        <?php echo form_open(current_url(), array("id" => "form_files_ophthalmology_od_file_delete", "name" => "form_files_ophthalmology_od_file_delete")); ?>
...
;(function( $ ){
		$.fn.extend({
				form_files_ophthalmology_od_file_delete: function(){
								...
								try{
									...
									$.post( form_action, form_data, function( response, status, xhr ){
											...
											try{
												...
												img.attr( "src", "<?php echo base_url( "resource/patients/ophthalmology" ) ?>/default_picture.jpg?rund=" + (new Date()).getTime() );											
		...
		$( document ).ready(function(e) {
            	$( "form[name=\"form_files_ophthalmology_od_file_delete\"]" )
					.form_files_ophthalmology_od_file_delete();
        	});
	})( jQuery );
//]]>
</script>
