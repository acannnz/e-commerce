...
<div class="row">
	<div class="col-md-3">
        <div class="profile margin-bottom-0">
            <div class="profile-info">
                ...
                <?php endif ?>
                <a href="<?php echo base_url( "common/suppliers/picture/{$profile->id}" ) ?>" data-toggle="ajax-modal" title="<?php echo lang("buttons:update_picture") ?>" class="btn btn-block btn-primary"><?php echo lang("buttons:update_picture") ?></a>
            </div>
    ...
    <div class="col-md-9">
    	<div class="page-subtitle">
            ...
            <p><?php echo lang('suppliers:general_ov_subtitle_helper') ?></p>
        </div>
        <div class="row margin-bottom-30 profile-grid">
        	<div class="col-md-6">
            	<div class="row">
                	<div class="col-md-4 caption"><strong><?php echo lang('suppliers:mr_number_label') ?> :</strong></div>
                    <div class="col-md-8"><?php echo @$profile->mr_number ?></div>
                </div>
            </div>
            <div class="col-md-6">
            	<div class="row">
                	<div class="col-md-4 caption"><strong><?php echo lang('suppliers:type_label') ?> :</strong></div>
                    <div class="col-md-8"><?php echo @$profile->type_name ?></div>
                </div>
            </div>
            <div class="col-md-6">
            	<div class="row">
                	<div class="col-md-4 caption"><strong><?php echo lang('suppliers:name_label') ?> :</strong></div>
                    <div class="col-md-8"><?php echo @$profile->personal_name ?></div>
                </div>
            </div>
            <div class="col-md-6">
            	<div class="row">
                	<div class="col-md-4 caption"><strong><?php echo lang('suppliers:gender_label') ?> :</strong></div>
                    <div class="col-md-8"><?php echo lang(sprintf("gender:%s", strtolower(@$profile->personal_gender))) ?></div>
                </div>
            </div>
            <div class="col-md-6">
            	<div class="row">
                	<div class="col-md-4 caption"><strong><?php echo lang('suppliers:birth_date_label') ?> :</strong></div>
                    <div class="col-md-8"><?php echo strftime(lang("global:format_date"), strtotime(@$profile->personal_birth_date)) ?></div>
                </div>
            </div>
            <div class="col-md-6">
            	<div class="row">
                	<div class="col-md-4 caption"><strong><?php echo lang('suppliers:age_label') ?> :</strong></div>
            ...
            <div class="col-md-6">
            	<div class="row">
                	<div class="col-md-4 caption"><strong><?php echo lang('suppliers:nationality_label') ?> :</strong></div>
        ...
        <div class="page-subtitle">
            ...
            <p><?php echo lang('suppliers:address_ov_subtitle_helper') ?></p>
        </div>
        <div class="row margin-bottom-30 profile-grid">
        	<div class="col-md-6">
            	<div class="row">
                	<div class="col-md-4 caption"><strong><?php echo lang('suppliers:address_label') ?> :</strong></div>
                    <div class="col-md-8"><?php echo @$profile->personal_address ?></div>
                </div>
            </div>
            <div class="col-md-6">
            	<div class="row">
                	<div class="col-md-4 caption"><strong><?php echo lang('suppliers:area_label') ?> :</strong></div>
                    <div class="col-md-8"><?php echo (@$profile->area_name) ? @$profile->area_name : "n/a" ?></div>
                </div>
            </div>
            <div class="col-md-6">
            	<div class="row">
                	<div class="col-md-4 caption"><strong><?php echo lang('suppliers:district_label') ?> :</strong></div>
                    <div class="col-md-8"><?php echo (@$profile->district_name) ? @$profile->district_name : "n/a" ?></div>
                </div>
            </div>
            <div class="col-md-6">
            	<div class="row">
                	<div class="col-md-4 caption"><strong><?php echo lang('suppliers:county_label') ?> :</strong></div>
                    <div class="col-md-8"><?php echo (@$profile->county_name) ? @$profile->county_name : "n/a" ?></div>
                </div>
            </div>
            <div class="col-md-6">
            	<div class="row">
                	<div class="col-md-4 caption"><strong><?php echo lang('suppliers:province_label') ?> :</strong></div>
                    <div class="col-md-8"><?php echo (@$profile->province_name) ? @$profile->province_name : "n/a" ?></div>
                </div>
            </div>
            <div class="col-md-6">
            	<div class="row">
                	<div class="col-md-4 caption"><strong><?php echo lang('suppliers:country_label') ?> :</strong></div>
        ...
        <div class="page-subtitle">
            ...
            <p><?php echo lang('suppliers:contact_ov_subtitle_helper') ?></p>
        </div>
        <div class="row margin-bottom-30 profile-grid">
        	<div class="col-md-6">
            	<div class="row">
                	<div class="col-md-4 caption"><strong><?php echo lang('suppliers:phone_label') ?> :</strong></div>
                    <div class="col-md-8"><?php echo (@$profile->phone_number) ? @$profile->phone_number : "n/a" ?></div>
                </div>
            </div>
            <div class="col-md-6">
            	<div class="row">
                	<div class="col-md-4 caption"><strong><?php echo lang('suppliers:email_label') ?> :</strong></div>
                    <div class="col-md-8"><?php echo (@$profile->email_address) ? @$profile->email_address : "n/a" ?></div>
                </div>
            </div>
            <div class="col-md-6">
            	<div class="row">
                	<div class="col-md-4 caption"><strong><?php echo lang('suppliers:profession_label') ?> :</strong></div>
