...
<div class="table-responsive">
    <table id="dt-lookup-common-suppliers" class="table table-bordered table-striped" width="100%">
        <thead>
            <tr>
                <th></th>
...
(function( $ ){
		$.fn.extend({
				DT_Lookup_CommonSuppliers: function(){
						var _this = this;
		...
		var _datatable = $( "#dt-lookup-common-suppliers" ).DT_Lookup_CommonSuppliers();
