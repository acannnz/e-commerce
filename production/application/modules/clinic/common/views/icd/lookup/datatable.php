...
<div class="table-responsive">
    <table id="dt-lookup-common-icd" class="table table-sm table-bordered table-hover table-icd" width="100%">
        <thead>
            <tr>
                <th></th>
...
(function( $ ){
				...
				DT_Lookup_CommonICD: function(){
						...
						var _datatable = _this.DataTable( {
							...
							columns: [
									...
									{ data: "Descriptions", orderable: true, searchable: true}									
								]
						} );
		...
		var _datatable = $( "#dt-lookup-common-icd" ).DT_Lookup_CommonICD();
