...
<div class="table-responsive">
    <table id="dt-lookup-nurses" class="table table-sm table-bordered table-striped" width="100%">
        <thead>
            <tr>
                <th></th>
                <th>Kode Perawat</th>
...
(function( $ ){
		$.fn.extend({
				DT_Lookup_Nurses: function(){
						...
						var _datatable = _this.DataTable( {
							...
							//scrollY: "200px",
							ajax: {
									url: "<?php echo base_url("common/nurses/lookup_collection") ?>",
									type: "POST",
		...
		var _datatable = $( "#dt-lookup-nurses" ).DT_Lookup_Nurses();

		$('#dt-lookup-nurses tbody').on( 'click', 'tr', function () {
			if ( $(this).hasClass('selected') ) {
				$(this).removeClass('selected');
			}else {
				$('#dt-lookup-nurses tbody tr.selected').removeClass('selected');
