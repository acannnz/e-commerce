						...
						_this.on( "submit", function(e){
								...
								Webcam.snap( function( data_uri ) {
										...
										$.post( post_remote, post_data, function( data, status, xhr ){
												<?php if( isset($is_ajax_request) ): ?>
												try{
													ajax_modal.show( "<?php echo base_url( "common/customer_cooperations/picture_crop/{$profile_id}" ) ?>" );
												} catch(e){}
												<?php else: ?>
												window.location = "<?php echo base_url( "common/customer_cooperations/picture_crop/{$profile_id}" ) ?>";
												<?php endif ?>									
											} );
									} );
