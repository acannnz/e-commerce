...
<div class="table-responsive">
    <table id="dt-lookup-common-customer_cooperations" class="table table-bordered table-striped" width="100%">
        <thead>
            <tr>
                <th></th>
...
(function( $ ){
		$.fn.extend({
				DT_Lookup_CommonCustomer_cooperations: function(){
						var _this = this;
						...
						var _datatable = _this.DataTable( {
							...
							//scrollY: "200px",
							ajax: {
									url: "<?php echo base_url("common/customer_cooperations/lookup_collection") ?>",
									type: "POST",
							...
							columns: [
									{ 
										...
										render: function ( val, type, row ){
												var data = {'id': row.id, 'mr_number': row.mr_number, 'personal_name': row.personal_name};
									...
									{ data: "personal_name", orderable: true},
									{ data: "type_name", width: "90px", orderable: false}									
								]
						} );
		...
		var _datatable = $( "#dt-lookup-common-customer_cooperations" ).DT_Lookup_CommonCustomer_cooperations();
