...
<div class="table-responsive">
    <table id="dt-lookup-common-sections" class="table table-bordered table-striped" width="100%">
        <thead>
            <tr>
                <th></th>
...
(function( $ ){
		$.fn.extend({
				DT_Lookup_CommonSections: function(){
						var _this = this;
						...
						var _datatable = _this.DataTable( {
							...
							//scrollY: "200px",
							ajax: {
									url: "<?php echo base_url("common/sections/lookup_collection") ?>",
									type: "POST",
		...
		var _datatable = $( "#dt-lookup-common-sections" ).DT_Lookup_CommonSections();
