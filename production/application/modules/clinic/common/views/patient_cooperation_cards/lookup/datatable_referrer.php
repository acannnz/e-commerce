...
<div class="table-responsive">
    <table id="dt-lookup-common-patient_cooperation_cards" class="table table-bordered table-striped" width="100%">
        <thead>
            <tr>
                <th></th>
...
(function( $ ){
		$.fn.extend({
				DT_Lookup_CommonPatient_cooperation_cards: function(){
						var _this = this;
		...
		var _datatable = $( "#dt-lookup-common-patient_cooperation_cards" ).DT_Lookup_CommonPatient_cooperation_cards();
