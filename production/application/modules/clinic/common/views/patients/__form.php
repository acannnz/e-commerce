            ...
            <div class="panel-body">
				<div class="row">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<label class="col-lg-3 control-label"><?php echo "Desa" ?></label>
							<div class="col-lg-9">
				...
				<div class="row">
					<div class="col-md-6">
						...
						<div class="form-group">
							...
							<div class="col-lg-9">
								<input type="hidden" id="CustomerKerjasamaID" name="f[CustomerKerjasamaID]" value="0" class="cooperation">
								<input type="hidden" id="CompanyID" name="f[CompanyID]" value="<?php echo @$item->CompanyID ?>"  class="cooperation">
								<div class="input-group">
									<input type="text" id="Nama_Customer" value="<?php echo @$item->Nama_Customer ?>" placeholder="" class="form-control cooperation" >
						...
						<div class="form-group">
							<label class="col-md-3 control-label"><?php echo "No Kartu" ?></label>
							<div class="col-md-9">
								<div class="input-group">
						...
						<div class="form-group">
							<label class="col-lg-3 control-label"><?php echo "No Anggota" ?></label>
							<div class="col-lg-6">
