...
<div class="table-responsive">
    <table id="dt-lookup-common-patients" class="table table-bordered table-striped" width="100%">
        <thead>
            <tr>
                <th></th>
...
(function( $ ){
		$.fn.extend({
				DT_Lookup_CommonPatients: function(){
						var _this = this;
		...
		var _datatable = $( "#dt-lookup-common-patients" ).DT_Lookup_CommonPatients();
