						...
						<div class="modal-body">
							<div class="img-container">
								...
								<div class="form-group" id="patient_nrm">
									...
									<div class="col-sm-9"> 
										<div class="input-group">
											<input type="hidden" id="NRM" name="f[NRM]" value="<?php echo @$item->NRM ?>" placeholder="" class="form-control" readonly>
											<input type="hidden" id="NoUrut" name="f[NoUrut]" value="<?php echo @$item->NoUrut ?>" placeholder="" class="form-control" readonly>
