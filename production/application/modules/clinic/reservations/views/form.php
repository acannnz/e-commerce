			...
			<div class="panel-body">
					...
					<div class="row">
						<div class="col-lg-6">
							...
							<div class="form-group">
								...
								<div class="col-lg-3">
									<input type="text" id="Waktu" name="f[Waktu]" value="<?php echo substr(@$item->Waktu, 11, 5) ?>" placeholder="" class="form-control">
								</div>
							</div>
							<div class="form-group" hidden>
				...
				<div class="form-group">
					<div class="col-lg-12 text-right">
						<?php if (@$is_edit) : ?>
							<a href="<?php echo @$cancel_link ?>" data-toggle="form-ajax-modal" class="btn btn-danger" <?= (@$item->Batal == 1) ? "disabled" : null ?>><i class="fa fa-trash"></i> <?php echo lang('buttons:cancel') ?></a>
						<?php endif; ?>
