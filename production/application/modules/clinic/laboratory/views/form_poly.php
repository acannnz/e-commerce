	...
	<div class="panel-body">
		<div class="row">
			...
			<div class="col-md-6">
				...
				<div class="form-group">
					<label class="col-lg-3 control-label"><?php echo lang('laboratory:company_code_label') ?></label>
					<div class="col-lg-9">
				...
				<div class="form-group">
					...
					<label class="col-lg-2 control-label text-center"><?php echo lang('laboratory:group_label') ?></label>
					<div class="col-lg-1">
...
<div class="panel panel-success">
	<div class="panel-heading">
		<h3 class="panel-title"><?php echo sprintf('%s: (%s) %s', lang('laboratory:examination_label'), @$item->NoBukti, @$patient->NamaPasien); ?></h3>
		<ul class="panel-btn">
	...
	<div class="panel-body">
		<div class="row">
			<div class="col-md-6">
				<div class="form-group">
					<label class="col-lg-3 control-label"><?php echo lang('laboratory:doctor_label') ?></label>
					<div class="col-lg-9">
		...
		<div class="tab-content">
			<div id="poly-tab1" class="tab-pane tab-pane-padding active">
				<?php echo modules::run("{$nameroutes}/helper/diagnosis/index", @$item ) ?>
			</div>
			<div id="poly-tab2" class="tab-pane tab-pane-padding">
				<?php echo modules::run("{$nameroutes}/helper/service_helper/index", @$item, @$is_edit ) ?>
			</div>
			<div id="poly-tab3" class="tab-pane tab-pane-padding">
				<?php echo modules::run("{$nameroutes}/helper/nurse/index", @$item, @$is_edit ) ?>
			</div>
			<div id="poly-tab4" class="tab-pane tab-pane-padding">
				<?php echo modules::run("{$nameroutes}/helper/prescriptions/index", @$item ) ?>
			</div>
			<div id="poly-tab5" class="tab-pane tab-pane-padding">
				<?php echo modules::run("{$nameroutes}/helper/helpers/index", @$item ) ?>
			</div>
			<div id="poly-tab6" class="tab-pane tab-pane-padding">
				<?php echo modules::run("{$nameroutes}/helper/consumables/index", @$item ) ?>
			</div>
			<div id="poly-tab7" class="tab-pane tab-pane-padding">
				<?php echo modules::run("{$nameroutes}/helper/memo/index", @$item ) ?>
			</div>
			<div id="poly-tab8" class="tab-pane tab-pane-padding">
				<?php echo modules::run("{$nameroutes}/helper/checkout/index", @$item ) ?>
			</div>
		</div>
	</div>
</div>
<?php if ( $item->Batal == 0 && ( @$registration->ProsesPayment == 0 || (!empty($registration->StatusBayar) && @$registration->StatusBayar != "Belum" )) ): ?>
<div class="form-group">
    <div class="col-lg-12 text-right">
    	<button type="submit" class="btn btn-primary"><?php echo lang( 'buttons:submit' ) ?></button>
		<?php if(@$is_edit):?>
    	<a href="<?php echo @$cancel_link ?>" class="btn btn-danger" data-toggle="lookup-ajax-modal"><?php echo lang( 'buttons:cancel' ) ?></a>
		<?php endif; ?>
