...
<div class="row">
    <div class="col-md-3">
        <div class="form-group">
            <label class="control-label"><?php echo lang('laboratory:date_from_label') ?></label>
	...
	<div class="col-md-3">
        <div class="form-group">
            <label class="control-label"><?php echo lang('laboratory:patient_label') ?></label>
            <div class="input-group">
				<span class="input-group-addon"><i class="fa fa-id-card-o"></i></span>
                <input type="text" id="NRM_w" class="form-control searchable_w mask_nrm" placeholder="<?php echo lang('laboratory:mr_number_label')?>" />
				<span class="input-group-addon"><i class="fa fa-wheelchair"></i></span>
                <input type="text" id="Nama_w" class="form-control searchable_w" placeholder="<?php echo lang('laboratory:name_label') ?>"/>
            </div>
        </div>
    </div>
    <div class="col-md-3">
        <div class="form-group">
            <label class="control-label"><?php echo lang('laboratory:doctor_label') ?></label>
	...
	<div class="col-md-3">
		<div class="form-group">
            <label class="control-label"><?php echo lang('laboratory:section_label') ?></label>
		...
		$.fn.extend({
				DataTable_DataWaitings: function(){
						...
						var _datatable = _this.DataTable( {
							...
							ajax: {
									url: "<?php echo base_url("{$nameroutes}/laboratories/data_waiting/datatable_collection") ?>",
									type: "POST",
									data: function( params ){
										params.date_from = $("#date_from_w").val();	
										params.date_till = $("#date_till_w").val();	
									...
									{ 
										...
										render: function ( val, type, row ){
												var buttons = '<div class="btn-group pull-right" role="group">';
													buttons += '<a href="<?php echo base_url("{$nameroutes}/create") ?>/'+ val +'/'+ row.SectionID +'" title="Periksa Pasien" class="btn btn-info btn-xs"> <i class="fa fa-stethoscope"></i> Periksa</a>';
												buttons += '</div>';
