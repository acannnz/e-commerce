...
.content:before {
  ...
  background-image: url("<?php echo base_url()?>resource/images/<?php echo config_item('login_bg')?>");
  width: 100%;
  height: 100%;
...
<section id="content" class="m-t-lg wrapper-md animated fadeInDown">
		...
		<a class="navbar-brand block" href="">
			...
			<?php } elseif ($this->config->item('logo_or_icon') == 'icon') { ?>
				<i class="fa <?php echo $this->config->item('site_icon')?>"></i>
			<?php } ?>
		...
		<strong><?php echo lang('sign_up_form')?> <?php echo $this->config->item('company_name')?></strong> </header>
		<?php 
	...
	<?php }
			...
			<div class="line line-dashed"></div> 
			 <button type="submit" class="btn btn-primary"><?php echo lang('sign_up')?></button>
			<div class="line line-dashed">
			</div>
			<p class="text-muted text-center"><small><?php echo lang('already_have_an_account')?></small></p> 
			<a href="<?php echo base_url()?>auth/login" class="btn btn-danger btn-block"><?php echo lang('sign_in')?></a>
