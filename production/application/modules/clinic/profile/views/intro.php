...
<p>Freelancer Office v.<?php echo $this->config->item('version')?> <?php echo $this->config->item('company_name')?> </p> </header> <section> <section class="hbox stretch"> 
<section> 
<section class="vbox"> 
...
<p>Powered by: Freelancer Office v.<?php echo $this->config->item('version')?></p> </footer> 
