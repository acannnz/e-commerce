...
<div class="row">
	<div class="col-md-12">
    	<div class="form-group">
        	<div class="col-md-6">
                <label class="col-md-3 control-label"><?php echo lang('general_payment:date_from_label') ?></label>
                <div class="col-md-3">
                    <input type="text" id="date_from" class="form-control searchable datepicker" value="<?php echo date("Y-m-d")?>" />
                </div>
                <label class="col-md-3 control-label text-center"><?php echo lang('general_payment:date_till_label') ?></label>
                <div class="col-md-3">
...
<div class="table-responsive">
    <table id="dt-lookup-registration" class="table table-sm table-bordered table-striped" width="100%">
        <thead>
            <tr>
                <th></th>
                <th><?php echo lang("general_payment:registration_number_label")?></th>
                <th><?php echo lang("general_payment:date_label")?></th>
                <th><?php echo lang("general_payment:nrm_label")?></th>
                <th><?php echo lang("general_payment:patient_name_label")?></th>
                <th><?php echo lang("general_payment:type_patient_label")?></th>                
