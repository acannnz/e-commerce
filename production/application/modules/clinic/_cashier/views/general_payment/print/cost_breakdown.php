...
<body>
    <div class="row" style="margin:0 !important;">
    	<div class="col-lg-12" style="margin:0 !important;">
        	...
        	<div class="row">
                <h5 align="center"><u><b>DETAIL RINCIAN BIAYA</b></u></h5>
            </div>
            <br>
            <div class="row">
            	<div class="col-sm-12">
                	<div class="" style="">
                        ...
                        <table class="border">
                            ...
                            <tbody>
                            	<?php $total=0; if(!empty($detail_data)): foreach($detail_data as $key => $row): ?>
                                    <tr class="border">
                                    	<!-- <td></td> -->
                                        <td class="bgdark pad5 bold" colspan="10"><?php echo "Group Biaya "." : ". $key  ?></td>
                                    </tr>
                                    <?php $grand_total=0; foreach($row as $k_row => $k_key): ?>
                                    	<tr class="border">
                                        	<td></td>
                                        	<td class="pad5 bold" colspan="9"><?php echo "Kategori Biaya"." : ". $k_row ?></td>
                                        </tr>
                                        <?php $sub_total = 0; $i=1; foreach($k_key as $h_row => $y_row): ?>
                                        <tr>
                                        ...
                                        <?php $sub_total = $sub_total + (currency_ceil($y_row->Nilai * $y_row->Qty + $y_row->BiayaResep)); endforeach; ?>
                                        <tr class="border">
                                        	<td class="right pad5 bold" colspan="7"><strong><?php echo "Sub Total Kategori Biaya ($k_row) :" ?></strong></td>
                                            <td class="right pad5 bold"><?php echo number_format($sub_total, 0, ',' ,'.') ?></td>
                                            <td></td>
		                                </tr>
                                    <?php $grand_total = $grand_total + $sub_total; endforeach; ?>
                                     	<tr class="border">
                                        	<td class="right pad5 bold" colspan="7"><strong><?php echo "Sub Total Group Biaya ($key) :" ?></strong></td>
                                            <td class="right pad5 bold"><?php echo number_format($grand_total, 0, ',', '.') ?></td>
		                                    <td></td>
                                        </tr>
                                <?php $total = $total + $grand_total; endforeach; endif;?>
                            </tbody>
                            <tfoot>
                            	<tr class="border">
                                 	<td class="pad5 right bold bgdark" colspan="7"><?php echo "GRAND TOTAL :" ?></td>
