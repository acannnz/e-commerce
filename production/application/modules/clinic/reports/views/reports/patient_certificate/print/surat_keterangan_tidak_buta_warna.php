            ...
            <div class="col-xs-7">
                ...
                <table class="table_head" width="90%">
                    <tbody>
                        ...
                        <tr>
                            <td style="font-size: 12px; padding-top:15px;" width="25%">Nama</td>
                            <td style="font-size: 12px; padding-top:15px;">: &nbsp; <?php echo @$item->NamaPasien ?></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td style="font-size: 12px; padding-top:6px; padding-bottom: 25px;">: &nbsp; <?php echo @$item->Alamat ?></td>
                        </tr>
                        <tr>
                            <td colspan="3" style="font-size: 12px;;">Memang telah diperiksa </td>
                            <td rowspan="6">
                                <img class="barcode" src="<?= base_url("resource/images/barcode_surat_keterangan.jpeg") ?>" alt="">
                            </td>
                        </tr>
                        <tr>
                            <td colspan="3" style="font-size: 12px; padding-top:3px;">menggunakan Ishihara Test, yang </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td colspan="3" style="font-size: 12px; padding-top:3px;">&nbsp;</td>
                        </tr>
                        <tr>
                            <td colspan="3" style="font-size: 12px; padding-top:3px;">&nbsp;</td>
                        </tr>
            ...
            <div class="col-lg-5 text-right">
                <table class="table_head">
                    <tbody>
                        ...
                        <tr>
                            <td colspan="3" align="center" style="padding-left:25px;"><u><?php echo $item->NamaDokter ?></td>
                        </tr>
                        <tr>
