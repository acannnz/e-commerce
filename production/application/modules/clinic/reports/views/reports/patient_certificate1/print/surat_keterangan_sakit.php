            ...
            <div class="col-xs-7">
                ...
                <table class="table_head" width="90%">
                    <tbody>
                        ...
                        <tr>
                            <td colspan="3" style="font-size: 12px; padding-top:30px;">Oleh karena sakit, maka memerlukan istirahat selama : <strong><?php echo @$post['Keterangan_Surat'] ?></strong></td>
                        </tr>
                        <tr>
                            <td colspan="3" style="font-size: 12px; padding-top:3px;">(<strong><?php echo @$post['Hari'] ?></strong>) hari, terhitung mulai tanggal <strong><?php echo @$post['date_start'] ?></strong> s/d <strong><?php echo @$post['date_start'] ?></strong></td>
                        </tr>
                        <tr>
                            <td colspan="3" style="font-size: 12px; padding-top:3px;">Harap menjadi maklum</td>
                        </tr>
                    </tbody>
                </table>
            </div>
