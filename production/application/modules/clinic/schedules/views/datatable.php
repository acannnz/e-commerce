...
<div class="panel panel-info">
	<div class="panel-heading">
		<h3 class="panel-title"><?php echo 'Daftar Jadwal Prakter Dokter' ?></h3>
		<ul class="panel-btn">
			<li><a href="<?php echo base_url("schedules/create") ?>" class="btn btn-info" title="<?php echo 'Buat Jadwal Praktek' ?>"><b><i class="fa fa-plus"></i> <?php echo 'Buat Jadwal Praktek' ?></b></a></li>
		</ul>
	</div>
							...
							columns: [
									...
									{ 
										...
										render: function (val)
										{
											if ( val )
											{
												return "<span class=\"label label-success\">Praktek</span>";
											}
											
											return "<span class=\"label label-danger\">Libur</span>"
										}
									},
									{ 
										data: "Selasa", 
