...
<div class="panel panel-info panel-collapsed">
	...
	<div class="panel-body">
		<input type="hidden" name="f[DokterID]" value="<?php echo $cashier->DokterID ?>" />
		<?php if (config_item('allow_change_transaction_date')) : ?>
			<input type="hidden" name="f[Tanggal]" value="<?php echo $cashier->Tanggal ?>" />
			<input type="hidden" name="f[Jam]" value="<?php echo $cashier->Jam ?>" />
		<?php endif; ?>
		<div class="col-md-12">
			<div class="col-md-6">
				...
				<div class="form-group">
					...
					<div class="col-lg-8">
						<input type="text" id="Jam" name="f[Jam]" value="<?php echo (config_item('allow_change_transaction_date')) ? substr(@$cashier->Jam, 0, 19) : date("Y-m-d H:m:s"); ?>" class="form-control" readonly />
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-lg-8">
						<input type="text" id="TanggalFarmasi" name="p[TanggalFarmasi]" value="<?php echo substr(@$cashier->Jam, 0, 19) ?>" placeholder="" class="form-control" readonly>
					</div>
				</div>
			</div>
			<div class="col-md-6">
				...
				<div class="form-group">
					...
					<div class="col-lg-8">
						<input type="text" id="Keterangan" name="f[Keterangan]" value="<?php echo @$cashier->Keterangan ?>" placeholder="" class="form-control" readonly>
					</div>
				</div>
				<div class="form-group">
					<label class="col-lg-4 control-label"><?php echo lang('drug_payment:patient_type_label') ?></label>
					<div class="col-lg-8">
						<input type="text" value="<?= @$cashier->TipePasien ?>" class="form-control" readonly>
						<input type="hidden" id="JenisKerjasama" name="p[JenisKerjasama]" value="<?php echo @$cashier->JenisKerjasama ?>" placeholder="" class="form-control" readonly>
					</div>
				</div>
				<div class="form-group">
					<label class="col-lg-4 control-label"><?php echo lang('drug_payment:card_number_label') ?></label>
					<div class="col-lg-8">
						<input type="text" id="NoKartu" name="p[NoKartu]" value="<?php echo @$cashier->NoKartu ?>" placeholder="" class="form-control" readonly>
					</div>
				</div>
				<div class="form-group">
					<label class="col-lg-4 control-label"><?php echo lang('drug_payment:company_code_label') ?></label>
					<div class="col-lg-8">
						<input type="text" id="KodeCustomerPenjamin" name="f[KodeCustomerPenjamin]" value="<?php echo @$cashier->KodePerusahaan ?>" placeholder="" class="form-control" readonly>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-md-4">
				...
				<div class="table-responsive">
					<table class="table table-sm">
						...
						<tbody>
							<?php $no = 1;
							if (!empty($cashier_detail)) : foreach ($cashier_detail as $row) :
							...
							?>
									<tr>
										...
										<td align="center"><?php echo number_format(@$row->Harga, 2, '.', ',') ?></td>
									</tr>
							<?php endforeach;
							endif; ?>
						</tbody>
			...
			<div class="col-md-4">
				...
				<div class="form-group">
					...
					<div class="col-lg-7">
						<input type="text" id="NilaiTransaksi" name="f[NilaiTransaksi]" value="<?php echo @$cashier->Total ?>" placeholder="" class="form-control text-right mask-number" readonly>
					</div>
				</div>
				<div class="form-group">
	...
	(function($) {
		var form_actions = {
			...
			calculate_payment: function() {
				...
				var Total = SubTotal = addCharge = 0,
					Sisa_ = 0,
					TaxCC_ = 0;
