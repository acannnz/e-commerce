	...
	(function($) {
		...
		var search_datatable_o = {
			init: function() {
				...
				$("#date_from_o, #date_till_o").datetimepicker({
					format: "YYYY-MM-DD"
		...
		$.fn.extend({
			DataTable_DrugPaymenOpens: function() {
				...
				var _datatable = _this.DataTable({
					...
					ajax: {
						url: "<?php echo base_url("cashier/drug-payments/data_open/datatable_collection") ?>",
						type: "POST",
					...
					columns: [{
						...
						},
						{
							...
							render: function(val, type, row) {
								...
								buttons += "<a href=\"<?php echo base_url("cashier/drug-payment/pay") ?>/" + val + "\" title=\"Bayar Obat\" class=\"btn btn-danger btn-xs\"><b><i class=\"fa fa-shopping-cart\"></i> Bayar</b></a>";
								buttons += "</div>";
