		...
		$.fn.extend({
			DataTable_DrugPaymenCloses: function() {
				...
				var _datatable = _this.DataTable({
					...
					ajax: {
						url: "<?php echo base_url("cashier/drug-payments/data_close/datatable_collection") ?>",
						type: "POST",
					...
					columns: [{
						...
						},
						{
							...
							render: function(val, type, row) {
								...
								buttons += "<a href=\"<?php echo base_url("cashier/drug-payment/pay") ?>/" + val + "\" title=\"Bayar Obat\" class=\"btn btn-primary btn-xs\"><b><i class=\"fa fa-eye\"></i> Lihat</b></a>";
								buttons += "</div>";
