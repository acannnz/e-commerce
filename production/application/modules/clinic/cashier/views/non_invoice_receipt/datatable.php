...
<div class="panel panel-success">
	<div class="panel-heading">
		<h3 class="panel-title"><?php echo lang('non_invoice_receipt:list_subtitle') ?></h3>
		<ul class="panel-btn">
	...
	<div class="panel-body">
		...
		<div class="table-responsive">
			<table id="dt-non-invoice-receipt" class="table table-sm table-bordered table-striped" width="100%">
				<thead>
					<tr>
						<th><?php echo lang("non_invoice_receipt:evidence_number_label")?></th>
						<th><?php echo lang("non_invoice_receipt:date_label")?></th>
						<th><?php echo lang("non_invoice_receipt:description_label")?></th>
						<th><?php echo lang("non_invoice_receipt:value_label")?></th>
						<th><?php echo lang("non_invoice_receipt:account_label")?></th>
						<th><?php echo lang("non_invoice_receipt:user_label")?></th>
						<th></th>
					</tr>
				</thead>
				<tbody>
...
(function( $ ){
	var search_datatable = {
			...
			reload_table : function(){
					$( "#dt-non-invoice-receipt" ).DataTable().ajax.reload();
				}
		};
		...
		$.fn.extend({
				DataTable_NonInvoiceReceipt: function(){
						...
						var _datatable = _this.DataTable( {
							...
							ajax: {
									url: "<?php echo base_url("cashier/non-invoice-receipt/datatable_collection") ?>",
									type: "POST",
									...
									{ 
										...
										render: function ( val, type, row ){
												var buttons = "<div class=\"btn-group pull-right\" role=\"group\">";
													buttons += "<a href=\"<?php echo base_url("cashier/non-invoice-receipt/edit") ?>/" + val + "\" title=\"Lihat Detail\" class=\"btn btn-primary btn-xs\"><b><i class=\"fa fa-eye\"></i> View</b></a>";
												buttons += "</div>";
					...
					$( "#dt-non-invoice-receipt_length select, #dt-non-invoice-receipt_filter input" )
		...
		$( document ).ready(function(e) {
            	$( "#dt-non-invoice-receipt" ).DataTable_NonInvoiceReceipt();
