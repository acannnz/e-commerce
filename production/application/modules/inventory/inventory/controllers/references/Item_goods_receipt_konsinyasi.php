...
class item_goods_receipt_konsinyasi extends ADMIN_Controller
{
	...
	public function __construct()
	{
		...
		$this->data['nameroutes'] = $this->nameroutes = 'inventory/references/item_goods_receipt_konsinyasi'; 
	...
	{						
		...
		$db_where["{$t_item}.BarangKonsinyasi"] = 1;
