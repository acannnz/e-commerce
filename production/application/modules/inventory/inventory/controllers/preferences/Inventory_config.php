...
class Inventory_config extends ADMIN_Controller
{
	...
	public function __construct()
	{
		...
		$this->data['nameroutes'] = $this->nameroutes = 'inventory/preferences/inventory_config'; 
	...
	public function update($id = 0)
	{
		...
		$this->load->view('preferences/inventory_config/modal/update', $this->data);
	}
	...
	public function delete($id = 0)
	{
		...
		$this->load->view('preferences/inventory_config/modal/delete', $this->data);
	}
	...
	public function collection()
	{
		...
		$this->datatables
			->select("Kategori_ID,Kode_Kategori,Nama_Kategori", false)
