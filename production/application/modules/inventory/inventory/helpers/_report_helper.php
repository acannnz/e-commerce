...
final class report_helper
{
	...
	public static function export_purchase_receipt($date_start, $date_end, $location, $supplier, $opsi, $payment_type, $kelompok_jenis)
	{
		$_ci = self::ci();
		...
		$collection = self::get_purchase_receipt($date_start, $date_end, $location, $supplier, $opsi, $payment_type, $kelompok_jenis);
		...
		$_sheet->setCellValue("A{$tb_row}", 'GRAND TOTAL');
		$_sheet->getStyle("A{$tb_row}:H{$tb_row}")->applyFromArray(self::_get_style('tfoot_value'));
		$_sheet->setCellValue("H{$tb_row}", "=SUM(H7:F{$tb_row})/2");
		$_sheet->getStyle("H{$tb_row}")->applyFromArray(self::_get_style('thead'));
		$_sheet->getStyle("H{$tb_row}")->applyFromArray(self::_get_style('currency'));
	...
	public static function get_purchase_receipt($date_start, $date_end, $location, $supplier, $opsi, $payment_type, $kelompok_jenis)
	{
