		...
		<div class="panel panel-default">
            ...
            <div class="form-group">
            	<div class="row">
                    ...
                    <?php echo form_input('f[Tgl_Retur]', set_value('f[Tgl_Retur]', $item->Tgl_Retur, TRUE), [
                            'id' => 'Tgl_Retur', 
                            'placeholder' => '', 
                            'required' => 'required',
                    ...
                    <div class="form-group col-md-2">
                        ...
                        <?php echo form_input('f[No_Retur]', set_value('f[No_Retur]', $item->No_Retur, TRUE), [
                     ...
                     <div class="form-group col-md-2">
                      ...
                      <div class="form-group col-md-3">
                          ...
                          <div class="input-group">
                              ...
                              <input type="text" id="Kode_Supplier" name="h[Kode_Supplier]" value="<?php echo @$supplier->Kode_Supplier ?>" placeholder="" class="form-control" readonly="readonly">
                              <div class="input-group-btn">
                                 <?php /*?> <a href="#" id="add_supplier" data-act="ajax-modal" data-toggle="modal" data-dismiss="modal" data-action-url="<?php echo @$lookup_supplier ?>" data-title="<?php echo lang('header:lookup_supplier') ?>" class="btn btn-info"><?php echo "Pick!"//lang('buttons:pick_patient') ?></a><?php */?>
                              </div>
                          </div>
                      </div>
                      <div class="form-group col-md-2">
                          ...
                          <div class="col-md-12">
                             <input type="text" id="Nama_Supplier" name="Nama_Supplier" value="<?php echo @$supplier->Nama_Supplier ?>" placeholder="" class="form-control" required readonly="readonly">
                          </div>
                      </div>
                </div>
