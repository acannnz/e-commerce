							...
							<div class="col-md-9">
								<div class="input-group">
									...
									<div class="input-group-btn">
										<a href="#" id="add_supplier" data-act="ajax-modal" data-toggle="modal" data-dismiss="modal" data-action-url="<?php echo @$lookup_supplier ?>" data-title="<?php echo lang('header:lookup_supplier') ?>" class="btn btn-info"><?php echo "Pick!" //lang('buttons:pick_patient') 
																																																																		?></a>
									</div>
								</div>
							</div>
