...
<?php echo form_open(site_url("{$nameroutes}/create_post"), [
		'id' => 'form_create_return', 
		'name' => 'form_create_return', 
		'rule' => 'form', 
		'class' => ''
	]); ?>
<input type="hidden" id="barang_id" value="0" />
<input type="hidden" id="Supplier_ID" value="0" name="h[Supplier_ID]" />
<input type="hidden" id="Retur_ID" value="<?php echo $gen_request_id ?>" name="h[Retur_ID]" />
<div class="row">
	<div class="col-md-12">
		<div class="panel panel-default">
            ...
            <div class="form-group">
            	<div class="row">
                    ...
                    <div class="form-group col-md-2">
                        <?php echo form_label(lang('label:request_number').' *', 'No_Retur', ['class' => 'control-label']) ?>
                     ...
                     <div class="form-group col-md-2">
                      ...
                      <div class="form-group col-md-3">
                          ...
                          <div class="input-group">
                              ...
                              <input type="text" id="Kode_Supplier" name="h[Kode_Supplier]" value="<?php echo @$item->supplier_code ?>" placeholder="" class="form-control" readonly>
                              <div class="input-group-btn">
                                  <a href="#" id="add_supplier" data-act="ajax-modal" data-toggle="modal" data-dismiss="modal" data-action-url="<?php echo @$lookup_supplier ?>" data-title="<?php echo lang('header:lookup_supplier') ?>" class="btn btn-info"><?php echo "Pick!"//lang('buttons:pick_patient') ?></a>
                              </div>
                          </div>
                      </div>
                      <div class="form-group col-md-2">
                          ...
                          <div class="col-md-12">
                             <input type="text" id="Nama_Supplier" name="Nama_Supplier" value="<?php echo @$item->supplier_name ?>" placeholder="" class="form-control" required readonly>
                          </div>
                      </div>
                </div>
                ...
                <div class="form-group">
                    <a href="#" data-action-url="<?php echo @$item_lookup ?>" id="add_charge" data-act="ajax-modal" class="btn btn-primary btn-block"><b><i class="fa fa-plus"></i> Tambah Barang</b></a>
                </div>
                <div class="row">
                    <div class="col-lg-4">
                        <div class="form-group">
                            <?php echo form_label(lang('label:keterangan').' *', 'input_keterangan', ['class' => 'control-label']) ?>
				...
				edit: function( row, data, index ){
						...
						switch( this.index() ){
							...
							case 5:
								...
								var _input = $( "<input type=\"number\" value=\"" + Number(data.Qty_Retur || 0) + "\" style=\"width:100%\"  class=\"form-control Qty_Retur\">" );
								var discount;
								var total;
								...
								_input.on( "blur", function(e){
										...
										try{
											data.Qty_Retur = this.value || this.value;
											data.Jumlah_Total = Number(data.Qty_Retur) * Number(data.Harga_Retur);
				...
				dt_services: function(){
						...
						_datatable = _this.DataTable( {
								...
								columns: [
										...
										{ data: "Harga_Retur", render: $.fn.dataTable.render.number(',','.',2,'') },
										{ data: "Jumlah_Total", render: $.fn.dataTable.render.number(',','.',2,'') }
