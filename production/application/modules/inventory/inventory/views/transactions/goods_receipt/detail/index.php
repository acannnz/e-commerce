	...
	<div class="col-md-12">
		<div class="panel panel-default">
            <div class="panel-heading">  
				<div class="row">
					<div class="col-md-6">
		                <h3 class="panel-title"><?php echo 'Detail Penerimaan Barang'; ?></h3>
					</div>
					<div class="col-md-6">
						<?php /*
								...
								render: function ( val, type, row ){
										var buttons = '<div class="btn-group">';
															...
															buttons += '<ul class="dropdown-menu">';
																if(row.OutStok == 0){
																	buttons += '<li><a href="javascript:;" data-action-url="<?php echo @$update_state ?>/'+ row.Penerimaan_ID +'/'+ row.Barang_ID +'/1" data-title="Update Status Stok Habis" data-act="ajax-modal" data-modal-lg="0"><i class="fa fa-pencil"></i> Ubah Stok Habis</a></li>';
																} else if(row.OutStok == 1){
																	buttons += '<li><a href="javascript:;" data-action-url="<?php echo @$update_state ?>/'+ row.Penerimaan_ID +'/'+ row.Barang_ID +'/0" data-title="Update Status Stok Tersisa" data-act="ajax-modal" data-modal-lg="0"><i class="fa fa-pencil"></i> Ubah Stok Sisa</a></li>';
																}															
															buttons += '</ul>';
														buttons += '</div>';
										return buttons
