...
<div class="modal-body">
    <div class="form-group" style="margin: 27px 0px;">
    	<p style="margin-bottom: 0;line-height: 100%;font-size: 14px;"><?php echo lang('global:cancel_confirm')?></p>   
...
<div class="modal-footer">
    <?php echo form_button([
			...
			'value' => '',
			'type' => 'button',
			'content' => '<i class="fa fa-times" aria-hidden="true"></i> Tidak',
	...
	<?php echo form_button([
			...
			'value' => '',
			'type' => 'submit',
			'content' => '<i class="fa fa-trash-o" aria-hidden="true"></i> Ya',
