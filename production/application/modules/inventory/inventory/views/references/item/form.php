								...
								<div class="form-group">
									...
									<div class="col-sm-8 col-xs-12">
										...
										<?php echo form_checkbox([
											...
											'name' => 'f[Aktif]',
											'value' => 1,
											'checked' => set_value('f[Aktif]', (bool) @$item->Aktif, TRUE),
											'class' => 'checkbox'
								...
								<!-- <div class="form-group">
                                    ...
                                    <div class="col-sm-8 col-xs-12">
                                        ...
                                        <?php echo form_checkbox([
											...
											'value' => 1,
											'checked' => set_value('f[FormulariumUmum]', (bool) @$item->FormulariumUmum, TRUE),
											'class' => 'checkbox'
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8 col-xs-12">
                                        ...
                                        <?php echo form_checkbox([
											...
											'name' => 'f[Formularium]',
											'value' => 1,
											'checked' => set_value('f[Formularium]', (bool) @$item->Formularium, TRUE),
											'class' => 'checkbox'
					...
					<div class="tab-pane" id="form-detail">
						<div class="row">
							<div class="col-sm-6 col-xs-12">
								...
								<div class="form-group">
									<?php echo form_label('Persentase (%)', 'Persentase', ['class' => 'col-sm-4 col-xs-12 control-label']) ?>
									<div class="col-sm-8 col-xs-12">
										<?php echo form_input('', set_value('', TRUE), [
											'id' => 'Persentase',
											'placeholder' => '',
											'class' => 'form-control'
										]); ?>
...
<script type="text/javascript">
	...
	(function($) {
		function populate_typegroup(v) {
			...
			_input.load('<?php echo site_url("{$nameroutes}/get_typegroup_list") ?>', {
				'g': group
		...
		$(document).ready(function() {
			...
			$('#Harga_Jual').on('change', function(e) {
				var hb = mask_number.currency_remove($('#Harga_Beli').val());;
				var hj = $('#Harga_Jual').val();
				var cv = $('#Konversi').val();
				var persentase = (hj - (hb / cv)) / (hb / cv) * 100;
			...
			$('#js-btn-submit').on('click', function(e) {
				...
				$.each(_datatable_location.rows().data(), function(i, v) {
					post_data.push({
						name: 'collection_location[' + i + '][Lokasi_ID]',
						value: v.Lokasi_ID
					});
					post_data.push({
						name: 'collection_location[' + i + '][Barang_ID]',
						value: v.Barang_ID
					});
					post_data.push({
						name: 'collection_location[' + i + '][Qty_Stok]',
						value: v.Qty_Stok
					});
					post_data.push({
						name: 'collection_location[' + i + '][Min_Stok]',
						value: v.Min_Stok
					});
					post_data.push({
						name: 'collection_location[' + i + '][Max_Stok]',
						value: v.Max_Stok
					});
					post_data.push({
						name: 'collection_location[' + i + '][Aktif]',
						value: v.Aktif
					});
					post_data.push({
						name: 'collection_location[' + i + '][Kode_Satuan]',
						value: $("#Stok_Satuan_ID option:selected").html()
					});
				});

				$.each(_datatable_package.rows().data(), function(i, v) {
					post_data.push({
						name: 'collection_package[' + i + '][Barang_ID_Penyusun]',
						value: v.Barang_ID_Penyusun
					});
					post_data.push({
						name: 'collection_package[' + i + '][Satuan_ID]',
						value: v.Satuan_ID
					});
					post_data.push({
						name: 'collection_package[' + i + '][Jumlah]',
						value: v.Jumlah
					});
				});
