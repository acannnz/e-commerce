...
<div class="modal-body">
        ...
        <div class="col-sm-8 col-xs-12">
			<div class="row lookupbox7-form-control">
            	<div class="col-sm-4 col-xs-12">
                	<?php echo form_input('t[Kode_Barang]', set_value('t[Kode_Barang]', '', TRUE), [
							'placeholder' => '', 
							'readonly' => 'readonly',
							'class' => 'form-control'
						]); ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8 col-xs-12">
			<div class="row lookupbox7-form-control">
            	<div class="col-sm-4 col-xs-12">
                	<?php echo form_input('t[Kode_Supplier]', set_value('t[Kode_Supplier]', '', TRUE), [
							'placeholder' => '', 
							'readonly' => 'readonly',
							'class' => 'form-control'
						]); ?>
                ...
                <div class="col-sm-6 col-xs-12">
                	<?php echo form_input('t[Nama_Supplier]', set_value('t[Nama_Supplier]', '', TRUE), [
							'placeholder' => '', 
							'class' => 'form-control lookupbox7-input-search'
						]); ?>
                </div>
                <div class="col-sm-2 col-xs-12">
                	...
                	<?php echo form_hidden('f[SupplierID]', set_value('f[SupplierID]', '', TRUE)); ?>
                </div>
            </div>
    	</div>
    </div>
    ...
    <div class="form-group">
		<?php echo form_label('Tanggal Beli *', 'input_date', ['class' => 'col-sm-4 col-xs-12 control-label']) ?>
        <div class="col-sm-8 col-xs-12">
            <?php echo form_input('f[Tgl_Beli_Terakhir]', set_value('f[Tgl_Beli_Terakhir]', '', TRUE), [
                    'id' => 'input_date', 
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8 col-xs-12">
            <?php echo form_input([
                    'id' => 'input_min_stock',
					'name' => 'f[MinStok]',
					'value' => set_value('f[MinStok]', 1, TRUE),
					'type' => 'number', 
                    'class' => 'form-control'
                ]); ?>
    	</div>
