...
<div class="table-responsive">
    <table id="dt-lookup-section" class="table table-sm table-bordered table-hover table-icd" width="100%">
        <thead>
            <tr>
                <th></th>
...
(function( $ ){
		$.fn.extend({
				DT_Lookup_Section: function(){
						...
						var _datatable = _this.DataTable( {
							...
							//scrollY: "200px",
							ajax: {
									url: "<?php echo base_url("inventory/references/Section/lookup") ?>",
									type: "POST",
		...
		var _datatable = $( "#dt-lookup-section" ).DT_Lookup_Section();
