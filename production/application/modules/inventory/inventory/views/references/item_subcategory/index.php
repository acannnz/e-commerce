	...
	<div class="col-md-8 col-md-offset-2">
		<div class="panel panel-default">
            <div class="panel-heading">                
                ...
                <h3 class="panel-title"><?php echo lang('heading:item_subcategory_list'); ?></h3>
            </div>
            <div class="panel-body table-responsive">
                <table id="dt_ref_item_subcategory" class="table table-bordered table-hover" width="100%" cellspacing="0">
                    <thead>
                        <tr>
                            ...
                            <th><?php echo lang('label:parent') ?></th>
...
(function( $ ){
		$( document ).ready(function(e) {
				...
				$( "#dt_ref_item_subcategory" ).DataTable({
						order: [[2, 'asc']],
						ajax: {
