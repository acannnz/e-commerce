	...
	<div class="col-md-10 col-md-offset-1">
		<div class="panel panel-default">
            <div class="panel-heading">                
                ...
                <h3 class="panel-title"><?php echo lang('heading:item_type_list'); ?></h3>
            </div>
            <div class="panel-body table-responsive">
                <table id="dt_ref_item_type" class="table table-bordered table-hover" width="100%" cellspacing="0">
                    <thead>
                        <tr>
                            ...
                            <th><?php echo 'Kelompok'; ?></th>
                            <th><?php echo 'Jenis'; ?></th>
                            <th><?php echo 'Pengadaan'; ?></th>
                            <th><?php echo 'Akun Pembelian'; ?></th>
                            <th><?php echo 'Akun Mutasi'; ?></th>
...
(function( $ ){
		$( document ).ready(function(e) {
				...
				$( "#dt_ref_item_type" ).DataTable({
						...
						columns: [
								{data: 'ID', orderable: false, searchable: false, render: checkbox},
								{data: 'Kelompok'},
								{data: 'KelompokJenis'},
								{data: 'JenisPengadaanID'},
								{data: 'Akun_ID'},
								{data: 'Akun_ID_Mutasi'},
