...
<div class="page-subtitle margin-bottom-20">
	<div class="row">
        <div class="col-md-6">
            <h3 class="text-info">List Data Stok Opname</h3>
            <p>Data Stok Opname akan diolah disini.</p>
        </div>
	</div>
</div>
<div class="row">
    ...
    <div class="col-md-6">
		<div class="form-group text-right">
        	<a href="<?php echo $create_link ?>" class="btn btn-primary"><b><i class="fa fa-plus"></i> Stok Opname Baru</b></a>
		</div>    	
    </div>
</div>
									...
									{ 
										...
										render: function ( val, type, row ){
												var buttons = "<div class=\"btn-group pull-right\" role=\"group\">";
													buttons += "<a href=\"<?php echo base_url("inquiry/pharmacy/stock-opname-view") ?>/" + val + "\" title=\"Lihat Stok Opname\" class=\"btn btn-default btn-xs\"> <i class=\"fa fa-eye\"></i> Lihat</a>";
												buttons += "</div>";
