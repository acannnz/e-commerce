...
<div class="page-subtitle margin-bottom-20">
	<div class="row">
        <div class="col-md-6">
            <h3 class="text-info">List Data Retur Mutasi</h3>
            <p>Data Retur Mutasi akan diolah disini.</p>
        </div>
	</div>
</div>
<div class="row">
    ...
    <div class="col-md-6">
		<div class="form-group">
        	...
        	<a href="<?php echo $create_link ?>" class="btn btn-primary pull-right"><b><i class="fa fa-plus"></i> Retur Mutasi Baru</b></a>
		</div>    	
    </div>
</div>
		...
		$.fn.extend({
				DataTable_DataInquiries: function(){
						...
						var _datatable = _this.DataTable( {
							...
							ajax: {
									url: "<?php echo base_url("inquiry/datatable_mutation_return") ?>",
									type: "POST",
									...
									{ 
										...
										render: function ( val, type, row ){
												var buttons = "<div class=\"btn-group pull-right\" role=\"group\">";
													buttons += "<a href=\"<?php echo base_url("inquiry/pharmacy/mutation-view") ?>/" + val + "\" title=\"Lihat Stok Opname\" class=\"btn btn-default btn-xs\"> <i class=\"fa fa-eye\"></i> Lihat</a>";
												buttons += "</div>";
