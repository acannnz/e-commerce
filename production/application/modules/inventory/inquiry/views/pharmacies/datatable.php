...
<div class="row">
    ...
    <div class="col-md-6">
		<div class="form-group text-right">
        	<a href="<?php echo $create_link ?>" class="btn btn-primary"><b><i class="fa fa-plus"></i> Amprah Baru</b></a>
		</div>    	
    </div>
</div>
									...
									{ 
										...
										render: function ( val, type, row ){
												var buttons = "<div class=\"btn-group pull-right\" role=\"group\">";
													buttons += "<a href=\"<?php echo base_url("inquiry/pharmacy/view") ?>/" + val + "\" title=\"Periksa Pasien\" class=\"btn btn-default btn-xs\"> <i class=\"fa fa-medkit\"></i> Periksa</a>";
												buttons += "</div>";
