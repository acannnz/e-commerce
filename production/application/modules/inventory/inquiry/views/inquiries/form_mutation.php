    ...
    <div class="col-md-6">
        ...
        <div class="form-group">
            ...
            <div class="col-lg-9">
                ...
                <input type="text" id="SectionAsalName" name="f[SectionAsalName]" value="<?php echo @$inquiry->SectionAsalName ?>" placeholder="" class="form-control inquiry" readonly="readonly">
            </div>
        </div>
        <div class="form-group">
            <label class="col-lg-3 control-label">Tanggal Amprah</label>
            <div class="col-lg-4">
                <input type="text" id="TanggalAmprah" name="f[tanggal_amprah]" value="<?php echo @$inquiry->Tanggal ?>" placeholder="" class="form-control inquiry" readonly="readonly">
            </div>
        </div>        
        <div class="form-group">
            <label class="col-lg-3 control-label">Keterangan Amprah</label>
            <div class="col-lg-9">
            	<textarea id="KeteranganAmprah" name="f[KeteranganAmprah]" class="form-control inquiry" readonly="readonly"><?php echo @$inquiry->Keterangan ?></textarea>
            </div>
        </div>
    </div>
</div>
