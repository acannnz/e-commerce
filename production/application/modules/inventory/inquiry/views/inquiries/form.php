...
<div class="row form-group">
	<div class="col-md-6">
        ...
        <div class="form-group">
            ...
            <div class="col-lg-4">
                <input type="text" id="NRM" name="f[NRM]" value="<?php echo @$item->Tanggal ?>" placeholder="" class="form-control" maxlength="8" readonly="readonly">
            </div>
        </div>
        <div class="form-group">
		...
		$( document ).ready(function(e) {			
				...
				$("form[name=\"form_inquiry\"]").on("submit", function(e){
					...
					try{
						...
						var amprahan = {
								"NoBukti" : $("#NoBukti").val(),
								"Tanggal" : "<?php echo date("Y-m-d") ?> "+ d.getHours() +":"+ d.getMinutes() +":"+ d.getSeconds(),
						...
						$.post('<?php echo @$create_url ?>', data_post, function( response, status, xhr ){
							...
							<?php /*?>setTimeout(function(){
								...
								document.location.href = "<?php echo base_url("inquiry/emergency/edit"); ?>/"+ RegNo;
