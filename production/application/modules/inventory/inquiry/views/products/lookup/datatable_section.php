		...
		$.fn.extend({
				DT_Lookup_CommonServices: function(){
						...
						var _datatable = _this.DataTable( {
							...
							//scrollY: "200px",
							ajax: {
									url: "<?php echo base_url("inquiry/products/lookup_collection") ?>",
									type: "POST",
									data: function( params ){
										params.SectionAsal = $("#SectionAsal").val();
										params.SectionTujuan = $("#SectionTujuan").val();
										params.Lokasi_Asal = $("#Lokasi_Asal").val();
									}
								},
							columns: [
									{ 
