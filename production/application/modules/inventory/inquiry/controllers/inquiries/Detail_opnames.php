...
class Detail_opnames extends Admin_Controller
{
	...
	{
		//print_r($this->inquiry_m->get_opname_detail( $item->No_Bukti ));exit;
		$data = array(
				"item" => $item,
		...
		$this->load->view( 'inquiries/form/detail_opnames', $data );		
	}

	public function lookup_product_opname( $is_ajax_request=false )
	{
		if( $this->input->is_ajax_request() || $is_ajax_request == true )
		{	
			$this->load->view( 'inquiries/details/lookup/product_opnames' );
		} 
	}
