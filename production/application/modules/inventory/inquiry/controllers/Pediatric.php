...
class Pediatric extends Inquiry
{
	...
	public function request( )
	{
		...
		$this->template
			->set( "heading", "Amprah Barang Poli Anak" )
			->set_breadcrumb( "Amprahan", base_url("inquiry/pediatric/request") )
			->set_breadcrumb( "Amprah Barang Poli Anak" )
			;

		$this->request_( "SEC009" );
	}

	public function request_list( )
	{

		$section = $this->inquiry_m->get_row_data("SIMmSection", array("SectionID" => "SEC009" ));
		...
		$data = array(
				...
				"form" => TRUE,
				'datatables' => TRUE,
				'create_link' => base_url("inquiry/pediatric/request"),
			);
		
		$this->template
			->set( "heading", "List Amprahan Poli Anak" )
			->set_breadcrumb( lang("inquiry:breadcrumb") )
			->set_breadcrumb( "Amprahan Poli Anak", current_url() )
	...
	{
		$this->template
			->set( "heading", "Stok Opname Poli Anak" )
			->set_breadcrumb( "Stok Opname", current_url() )
			->set_breadcrumb( "Stok Opname Poli Anak" )
			;
			
		$this->stock_opname_( "SEC009" );
	}
	...
	public function stock_opname_view( $No_Bukti )
	{
		...
		$this->stock_opname_view_( "SEC009", $No_Bukti );
	}
	...
	public function stock_opname_list()
	{
		...
		$data = array(
				...
				"form" => TRUE,
				'datatables' => TRUE,
				"create_link" => base_url("inquiry/pediatric/stock-opname")
			);
		
		$this->template
			->set( "heading", "List Stok Opname Poli Anak" )
			->set_breadcrumb( "Stok Opname" )
			->set_breadcrumb( "Stok Opname Poli Anak", current_url() )
