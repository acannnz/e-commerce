...
class Emergency extends Inquiry
{
	...
	public function request( )
	{
		...
		$this->template
			->set( "heading", "Amprah Barang UGD" )
			->set_breadcrumb( "Amprahan", base_url("inquiry/emergency/request") )
			->set_breadcrumb( "Amprah Barang UGD" )
			;
	...
	public function request_list( )
	{
		...
		$data = array(
				...
				"form" => TRUE,
				'datatables' => TRUE,
				'create_link' => base_url("inquiry/emergency/request"),
			);
		
		$this->template
			->set( "heading", "List Amprahan UGD" )
			->set_breadcrumb( lang("inquiry:breadcrumb") )
			->set_breadcrumb( "Amprahan UGD", current_url() )
	...
	{
		$this->template
			->set( "heading", "Stok Opname UGD" )
			->set_breadcrumb( "Stok Opname", current_url() )
			->set_breadcrumb( "Stok Opname UGD" )
			;
	...
	public function stock_opname_list()
	{
		...
		$data = array(
				...
				"form" => TRUE,
				'datatables' => TRUE,
				"create_link" => base_url("inquiry/emergency/stock-opname")
			);
		
		$this->template
			->set( "heading", "List Stok Opname UGD" )
			->set_breadcrumb( "Stok Opname" )
			->set_breadcrumb( "Stok Opname UGD", current_url() )
