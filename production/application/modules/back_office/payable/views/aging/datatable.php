	...
	<div class="panel-body">
		...
		<div class="row">
			<div class="col-md-6">
				...
				<div class="form-group">
					<label class="col-lg-2 control-label"><?php echo lang('aging:supplier_label') ?></label>
					<div class="col-lg-3">
						<input type="hidden" id="supplier_id" name="supplier_id" class="form-control supplier" value="" />
						<input type="text" id="supplier_code" name="supplier_code" class="form-control supplier" readonly />
					</div>
					<div class="col-md-7 input-group">
						<input type="text" id="supplier_name" name="supplier_name" class="form-control supplier" readonly />
		...
		<div class="">
			<table id="dt-aging" class="table table-bordered table-sm" width="100%">
				<thead>
					<tr>
						<th rowspan="2"></th>
						<th rowspan="2"><?php echo lang('aging:supplier_label') ?></th>
