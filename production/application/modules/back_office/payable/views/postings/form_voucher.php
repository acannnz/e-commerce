...
<div class="row">
	<div class="col-md-6">
        <div class="form-group">
            ...
            <div class="col-lg-10">
                <input type="text" id="voucher_date" name="f[voucher_date]" value="<?php echo @$item->voucher_date ?>" placeholder="" <?php echo (@$is_edit) ? "readonly" : NULL ?> class="form-control datepicker" required>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-lg-10">
                <input type="text" id="voucher_number" name="f[voucher_number]" value="<?php echo @$item->voucher_number ?>" placeholder="" class="form-control" readonly="readonly"  required>
            </div>
        </div>
	</div>
    <div class="col-md-6">
        ...
        <div class="form-group">
            <div class="col-lg-12">
                <a href="<?php echo base_url("payable/credit_debit_notes/lookup_vouchers")?>" id="lookup_vouchers" class="btn btn-success btn-xl col-md-12" data-toggle="lookup-ajax-modal" disabled><b><i class="fa fa-search"></i> <?php echo lang("buttons:search")?></b></a>
            </div>
        </div>
    </div>
</div>
...
<!-- Untuk menyimpan data voucher id yg akan disesuikan -->
<input type="hidden" id="voucher_id" name="voucher_id" value="<?php echo @$voucher->id ?>">
<!-- Untuk menyimpan nomor nota debit credit-->
<input type="hidden" id="evidence_number" name="evidence_number" value="<?php echo @$item->voucher_number ?>">

<div class="row">
	<?php echo  modules::run("payable/debit_credit_note/details", @$item, @$is_edit) ?>
</div>
<hr/>
<div class="row">
	<div class="col-md-6">
