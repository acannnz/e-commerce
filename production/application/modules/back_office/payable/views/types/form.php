...
<div class="col-md-6 col-md-offset-3">
	<div class="panel panel-info">
		<div class="panel-heading">
			<h3 class="panel-title"><?php echo lang('types:page'); ?></h3>
		</div>
			...
			<div class="row">
				<div class="col-md-12">
					...
					<div class="form-group">
						...
						<div class="col-md-9">
							<div class="input-group">
								<input type="text" id="Akun_No" name="Akun_No" value="<?php echo @$item->Akun_No .'-'. @$item->Akun_Name ?>" class="form-control" readonly />
					...
					<div class="form-group">
						...
						<div class="col-lg-9">
							<label class="switch">
								<input type="hidden" value="0" name="f[Default_Type_Hutang]" />
								<input type="checkbox" <?php if(@$item->Default_Type_Hutang == 1){ echo "checked=\"checked\""; } ?> name="f[Default_Type_Hutang]" value="1">
								<span></span>
							</label>
						</div>
					</div>
