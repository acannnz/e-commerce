...
<div class="modal-dialog">
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <input type="hidden" name="f[Akun_ID]" value="<?php echo $item->Akun_ID ?>">
            <input type="hidden" name="f[Type_Akun]" value="0">
            <input type="hidden" name="confirm" value="<?php echo $item->Akun_ID ?>">
            <input type="hidden" name="r_url" value="<?php echo base_url( 'general-ledger/account/income-loss-setup' ) ?>">    
        </div>
