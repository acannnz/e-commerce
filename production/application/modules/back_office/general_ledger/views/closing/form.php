...
<div class="col-md-6">
    <div class="form-group">
        ...
        <div class="col-lg-6">
            <input type="text" id="closing_date" name="closing_date" placeholder="" class="form-control datepicker" value="<?php echo date("Y-m", strtotime("$last_period_closing first day of next month "))?>" data-date-min-date="<?php echo $last_period_closing ?>" data-date-format="YYYY-MM" required>
        </div>
    </div>
    <div class="form-group">
