                            	...
                            	<td width="50%">
                                	<table class="table reports-table"  style="border:1px solid black; font-size:10px">
                                        ...
                                        <tr style="border:1px dotted black; ">
                                            ...
                                            <td align="right" style="padding:2px;"><?php echo @$item->p_value ?></td>
                                        </tr>
                                        <?php endforeach; endif;?>
                                    </table>
                            	</td>
                                ...
                                <td width="50%">
                                	<table  class="table reports-table">
                                    	<tr style="border:1px solid black">
                                            ...
                                            <td align="right"><h5>Rp. <?php echo number_format( $total_activa, 2 )?></h5></td>
                                        </tr>
                                    </table>
                                </td>
                                <td width="50%">
                                	<table  class="table reports-table">
                                    	<tr style="border:1px solid black">
                                            ...
                                            <td align="right"><h5>Rp. <?php echo number_format( $total_pasiva, 2 ) ?></h5></td>
                                        </tr>
                                    </table>
                                </td>
                            </tr>
                            <tr>
                            	<td colspan="2" align="center"><h5>Rp. <?php echo number_format($total_activa - $total_pasiva, 2) ?></h5></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
