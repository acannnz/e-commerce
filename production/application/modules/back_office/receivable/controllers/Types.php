...
class Types extends Admin_Controller
{
	...
	public function create()
	{
		...
		} else
		{
			$data = array(
					...
					"form" => TRUE,
					"datatables" => TRUE,
					"lookup_accounts" => base_url("receivable/types/lookup_accounts")
				);
	...
	public function datatable_collection( $state=false )
    {
		...
		if( isset($search['value']) && ! empty($search['value']) )
        {
			...
			$db_like[ $this->db->escape_str("a.Default_Type_Piutang") ] = $keywords;
