...
?>
<?php echo form_open( current_url(), array("name" => "form_receivable") ); ?>
...
<div class="row">
    ...
    <div class="col-md-8">
        <div class="form-group">
            <label class="col-lg-2 control-label"><?php echo lang('facturs:customer_label') ?> <span class="text-danger">*</span></label>
            <input type="hidden" id="customer_id" name="customer_id" value="<?php echo @$customer->id ?>" class="form-control" />
            <div class="col-md-3">
...
<div class="row">
	<?php echo  modules::run("receivable/postings/factur_details", @$item, @$is_edit) ?>
</div>
<hr />
<?php echo form_close() ?>
