...
<div class="row">
    <div class="col-md-12">
        <div class="table-responsive">
            <table id="dt_invoice_details" class="table table-bordered table-sm" width="100%">
                <thead>
                	<tr>
                    	<th></th>
				...
				$("form[name=\"form_receivable\"]").on("submit", function(e){
					...
					$.post($(this).attr("action"), data_post, function( response, status, xhr ){
						...
						setTimeout(function(){
							...
							document.location.href = "<?php echo base_url("receivable/invoices/edit"); ?>?No_Invoice="+ No_Invoice ;
