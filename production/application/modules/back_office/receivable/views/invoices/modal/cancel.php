...
<div class="modal-dialog">
    <div class="modal-content">
        <div class="modal-header bg-danger"> 
            ...
            <h4 class="modal-title"><?php echo lang('invoices:cancel_title')?></h4>
        </div>        
        
			<?php echo form_open( $cancel_url, array("id" => 'form_cancel', "name" => 'form_cancel') ); ?>
            <div class="modal-body">
                <p><?php echo lang('invoices:cancel_invoice')?></p>            
                <input type="hidden" name="confirm" value="<?php echo $item->No_Invoice ?>">
                <div class="form-group">
                	<label class="col-md-3"><?php echo lang("invoices:username_label")?> <span class="text-danger">*</span></label>
                    <div class="col-md-9">
                    	<input type="text" id="username" name="username" class="form-control" autocomplete="off" required="required" />
                    </div>
                </div>
                <div class="form-group">
                	<label class="col-md-3"><?php echo lang("invoices:password_label")?> <span class="text-danger">*</span></label>
                    <div class="col-md-9">
