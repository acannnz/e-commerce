  ...
  <div class="row" style="margin:0 !important;">
    	<div class="col-lg-12" style="margin:0 !important;">
        	...
        	<div class="row text-center" style="margin:0 !important;">
            	<h4><?php echo lang('reports:card_receivable_label')?></h4>
            </div>
            
            <div class="row">
            	<div class="col-md-6">
	            	<h5><?php echo sprintf("%s: %s", lang("reports:customer_label"), $data->customer_name ) ?></h5>
                    ...
                    <table class="table reports-table"  style="border:1px solid black; font-size:10px">
                        ...
                        <tbody>	
                            ...
                            <?php if(!empty( $collections )): foreach( $collections as $item ): 
								...
								$tot_ending_balance = $tot_ending_balance + $item->SaldoAwal + $item->Debet - $item->Kredit;
