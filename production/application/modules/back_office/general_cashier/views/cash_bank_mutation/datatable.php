...
<div class="panel panel-info">
	<div class="panel-heading">
		...
		<ul class="panel-btn">
			<li><a href="<?php echo base_url("general-cashier/cash-bank-mutation/create") ?>" class="btn btn-info" title="Pembayaran Baru"><b><i class="fa fa-plus"></i> <?php echo lang( 'buttons:create' ) ?></b></a></li>
		</ul>
	</div>
	<div class="panel-body">
		<div class="row">
			<div class="col-md-3">
				<div class="form-group">
					<label class="control-label"><?php echo lang('cash_bank_mutation:periode_label') ?></label>
		...
		<div class="table-responsive">
			<table id="dt-receivable-vouchers" class="table table-sm" width="100%">
				<thead>
					<tr>
						<th><?php echo lang('cash_bank_mutation:date_label') ?></th>
						<th><?php echo lang('cash_bank_mutation:evidence_number_label') ?></th>
						<th><?php echo lang('cash_bank_mutation:value_label') ?></th>
						<th><?php echo lang('cash_bank_mutation:account_label') ?></th>
						<th><?php echo lang('cash_bank_mutation:description_label') ?></th>
						<th></th>
					</tr>
				</thead>        
				<tbody>
		...
		$.fn.extend({
				DataTableReceivableFacturs: function(){
						...
						var _datatable = _this.DataTable( {
							...
							responsive: true,
							ajax: {
									url: "<?php echo base_url("general-cashier/cash-bank-mutation/datatable_collection") ?>",
									type: "POST",
							...
							columns: [
									...
									{ 
										data: "Akun_Name", 
										render: function( val, type, row ){
												return row.Akun_No +" - "+ row.Akun_Name
											} 
									...
									{ 
										...
										render: function ( val, type, row ){		
												buttons = "<div class=\"btn-group\" role=\"group\" aria-label=\"\">";
													buttons += "<a href=\"<?php echo base_url("general-cashier/cash-bank-mutation/edit") ?>/?No_Bukti=" + encodeURIComponent(val) + "\" title=\"<?php echo lang( "buttons:view" ) ?>\" class=\"btn btn-info btn-xs\"><i class=\"fa fa-pencil\"></i> <?php echo lang( "buttons:view" ) ?></a>";
