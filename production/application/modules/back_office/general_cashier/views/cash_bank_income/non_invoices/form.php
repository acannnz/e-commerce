...
<div class="panel panel-info">
	<div class="panel-heading">
		<h3 class="panel-title"><?php echo lang('cash_bank_income:non_invoice_page'); ?></h3>
	</div>
	<div class="panel-body">
		<div class="row">
			...
			<div class="col-md-6"> 
				...
				<div class="form-group">
					<label class="col-lg-3 control-label"><?php echo lang('cash_bank_income:from_label') ?></label>
					<div class="col-lg-9">
		...
		<div class="row">
			<div class="col-md-12">
				<h4 class="text-primary"><b><?php echo lang("cash_bank_income:account_detail_subtitle")?></b></h4>
			</div>
		</div>
		<div class="row">
			<?php echo  modules::run("general_cashier/cash_bank_income/non_invoices/detail", @$item, @$is_edit) ?>
		</div>
