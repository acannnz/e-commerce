...
class Mutation_return_detail_model extends CI_Model
{
	public $table = 'GD_trReturMutasiDetail'; 
	...
	public function get_mutation_return_detail( Array $where, $to_array = FALSE )
	{		
