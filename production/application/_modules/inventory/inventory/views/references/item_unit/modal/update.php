...
<div class="modal-body">
	<div class="form-group">
        ...
        <?php echo form_input('f[Kode_Satuan]', set_value('f[Kode_Satuan]', $item->Kode_Satuan, TRUE), [
				'id' => 'input_code', 
				'placeholder' => '', 
				'class' => 'form-control'
			]); ?>
    ...
    <div class="form-group">
		<?php echo form_label(lang('label:unit_name').' *', 'input_name', ['class' => 'control-label']) ?>
        <?php echo form_input('f[Nama_Satuan]', set_value('f[Nama_Satuan]', $item->Nama_Satuan, TRUE), [
				'id' => 'input_name', 
				'placeholder' => '', 
				'class' => 'form-control'
			]); ?>
...
;(function( $ ){
		$( document ).ready(function(){
				...
				_form.appForm({onSuccess: function(result){ 
						try{
							$("#dt_ref_item_unit").DataTable().ajax.reload();
						} catch(e){
							location.reload(); 
						}
					}});
