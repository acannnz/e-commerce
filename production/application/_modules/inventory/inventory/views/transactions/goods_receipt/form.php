							...
							<div class="col-md-9">
								<div class="input-group">
									...
									<div class="input-group-btn">
										<a href="javascript:;" data-act="ajax-modal" data-action-url="<?php echo @$lookup_purchase_order ?>" data-title="<?php echo lang('heading:purchase_request_list') ?>" class="btn btn-info"><i class="fa fa-search"></i></a>
									</div>
								</div>
							</div>	
                        </div>
