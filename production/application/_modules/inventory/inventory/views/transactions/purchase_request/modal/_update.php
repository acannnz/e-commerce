...
<div class="modal-body">
	<div class="form-group">
        ...
        <?php echo form_input('f[Kode_Kelas]', set_value('f[Kode_Kelas]', $item->Kode_Kelas, TRUE), [
				'id' => 'input_code', 
				'placeholder' => '', 
				'required' => 'required',
				'class' => 'form-control'
    ...
    <div class="form-group">
        ...
        <?php echo form_input('f[Nama_Kelas]', set_value('f[Nama_Kelas]', $item->Nama_Kelas, TRUE), [
				'id' => 'input_name', 
				'placeholder' => '',
				'required' => 'required', 
				'class' => 'form-control'
    ...
    <div class="row">
        ...
        <div class="form-group col-md-6">
			...
			<?php echo form_dropdown('f[SubKategori_ID]', [0 => lang('label:subcategory')], set_value('f[SubKategori_ID]', $item->SubKategori_ID, TRUE), [
...
;(function( $ ){
		var category_id = 0;
		var subcategory_id = <?php echo (int) $item->SubKategori_ID; ?>;
