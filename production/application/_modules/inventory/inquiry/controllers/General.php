...
class General extends Inquiry
{
	...
	public function request( )
	{
		...
		$this->template
			->set( "heading", "Amprah Barang Poli Umum" )
			->set_breadcrumb( "Amprahan", base_url("inquiry/general/request") )
			->set_breadcrumb( "Amprah Barang Poli Umum" )
			;

		$this->request_( "SEC007" );
	}

	public function request_list( )
	{

		$section = $this->inquiry_m->get_row_data("SIMmSection", array("SectionID" => "SEC007" ));
		...
		$data = array(
				...
				"form" => TRUE,
				'datatables' => TRUE,
				'create_link' => base_url("inquiry/general/request"),
			);
		
		$this->template
			->set( "heading", "List Amprahan Poli Umum" )
			->set_breadcrumb( lang("inquiry:breadcrumb") )
			->set_breadcrumb( "Amprahan Poli Umum", current_url() )
	...
	{
		$this->template
			->set( "heading", "Stok Opname Poli Umum" )
			->set_breadcrumb( "Stok Opname", current_url() )
			->set_breadcrumb( "Stok Opname Poli Umum" )
			;
			
		$this->stock_opname_( "SEC007" );
	}
	...
	public function stock_opname_view( $No_Bukti )
	{
		...
		$this->stock_opname_view_( "SEC007", $No_Bukti );
	}
	...
	public function stock_opname_list()
	{
		...
		$data = array(
				...
				"form" => TRUE,
				'datatables' => TRUE,
				"create_link" => base_url("inquiry/general/stock-opname")
			);
		
		$this->template
			->set( "heading", "List Stok Opname Poli Umum" )
			->set_breadcrumb( "Stok Opname" )
			->set_breadcrumb( "Stok Opname Poli Umum", current_url() )
