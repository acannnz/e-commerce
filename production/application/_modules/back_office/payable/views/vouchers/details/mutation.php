            ...
            <table id="dt_mutation_details" class="table table-bordered table-striped table-sm" width="100%">
                <thead>
                	<tr>
                        ...
                        <th><?php echo lang("vouchers:debit_label") ?></th>
                        <th><?php echo lang("vouchers:credit_label") ?></th>
...
<div class="row">
    <div class="col-md-6">
    	<div class="form-group">
        	<label class="col-md-3 text-center"><?php echo lang("vouchers:mutation_total_label")?></label>
            <div class="col-md-9">
    ...
    <div class="col-md-6">
    	<div class="form-group">
        	<label class="col-md-3 text-center"><?php echo lang("vouchers:mutation_remain_label")?></label>
            <div class="col-md-9">
...
(function( $ ){
		...
		var _datatable_actions = {		
				calculate_balance: function(params, fn, scope){
						...
						var _tol_voucher = _form.find( "input[id=\"Nilai\"]" );
						var _tol_mutation = _form.find( "input[id=\"mutation_total\"]" );
						...
						tol_remain = Number( _tol_voucher.val() ) + tol_mutation;
