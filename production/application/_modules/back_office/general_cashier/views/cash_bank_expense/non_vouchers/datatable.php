...
<div class="panel panel-info">
	<div class="panel-heading">
		...
		<ul class="panel-btn">
			<li><a href="<?php echo base_url("general-cashier/cash-bank-expense/non-vouchers/create") ?>" class="btn btn-info" title="Pembayaran Baru"><b><i class="fa fa-plus"></i> <?php echo lang( 'buttons:create' ) ?></b></a></li>
		</ul>
	</div>
		...
		$.fn.extend({
				DataTableReceivableFacturs: function(){
						...
						var _datatable = _this.DataTable( {
							...
							responsive: true,
							ajax: {
									url: "<?php echo base_url("general-cashier/cash-bank-expense/non-vouchers/datatable_collection") ?>",
									type: "POST",
									...
									{ 
										...
										render: function ( val, type, row ){		
												buttons = "<div class=\"btn-group\" role=\"group\" aria-label=\"\">";
													buttons += "<a href=\"<?php echo base_url("general-cashier/cash-bank-expense/non-vouchers/edit") ?>/?No_Bukti=" + encodeURIComponent(val) + "\" title=\"<?php echo lang( "buttons:view" ) ?>\" class=\"btn btn-info btn-xs\"><i class=\"fa fa-pencil\"></i> <?php echo lang( "buttons:view" ) ?></a>";
