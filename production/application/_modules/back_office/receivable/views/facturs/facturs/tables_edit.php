...
(function( $ ){
		...
		var _datatable_actions = {		
				...
				update_receivable_type: function( _selected_data ){
						indexRow = _datatable_actions.get_receivable_type_row();
