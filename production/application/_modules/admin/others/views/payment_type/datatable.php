	...
	<div class="col-md-offset-2 col-md-8">
		<div class="panel panel-default">
            <div class="panel-heading">  
				<div class="row">
					<div class="col-md-6">
		                <h3 class="panel-title"><?php echo lang('heading:payment_type_list'); ?></h3>
					</div>
					<div class="col-md-6">
			...
			<div class="panel-body">
				<div class="row">
					<div class="col-md-12">
						<div class="form-payment_type">
							<table id="dt_payment_type" class="table table-bordered table-hover" width="100%" cellspacing="0">
								<thead>
									<tr>
										...
										<th><?php echo lang('label:order') ?></th>
...
(function( $ ){
		...
		$( document ).ready(function(e) {
				...
				_form.find("button[name=\"btn_search\"]").on("click", function(e){
						$( "#dt_payment_type" ).DataTable().ajax.reload();
				});					
					
				$("#dt_payment_type").DataTableInit();
