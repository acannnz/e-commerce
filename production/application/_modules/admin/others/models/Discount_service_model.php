...
class Discount_service_model extends CI_Model
{
	public $table = 'mDiscountJasa';
	public $index_key = 'IDDiscount';
	public $rules;
	...
	public function delete_not_in($IDDiscount, $where_not_in)
	{
		$this->db->where('IDDiscount', $IDDiscount);
		$this->db->where_not_in('IDJasa', $where_not_in);
		return $this->db->delete($this->table);
	}
