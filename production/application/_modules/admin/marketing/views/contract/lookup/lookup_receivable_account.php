    ...
    function lookupbox_row_selected( response ){
        ...
        if( _response ){
            ...
            try {
                ...
                $("#AkunPiutang_ID").val( _response.Akun_ID );
				$("#NamaAkunPiutang").val( _response.Akun_No+' - '+_response.Akun_Name );
			...
			$.fn.extend({
					dataTableInit: function(){
							...
							var _datatable = _this.DataTable( {
								...
								//scrollY: "200px",
								ajax: {
										url: "<?php echo base_url("marketing/account/lookup_collection") ?>",
										type: "POST",
