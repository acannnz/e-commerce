	...
	<div class="col-md-offset-2 col-md-8">
		<div class="panel panel-default">
            <div class="panel-heading">  
				<div class="row">
					<div class="col-md-6">
		                <h3 class="panel-title"><?php echo lang('heading:customer_contact_person_list'); ?></h3>
					</div>
					<div class="col-md-6">
				...
				<div class="row">
					<div class="col-md-12">
						<div class="form-group">
							<table id="dt_contact_person" class="table table-bordered table-hover" width="100%" cellspacing="0">
								<thead>
									<tr>
...
(function( $ ){
		...
		$( document ).ready(function(e) {
				...
				_form.find("button[name=\"btn_search\"]").on("click", function(e){
						$( "#dt_contact_person" ).DataTable().ajax.reload();
				});					
