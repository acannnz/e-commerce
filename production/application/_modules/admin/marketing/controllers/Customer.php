...
{
	protected $nameroutes = 'marketing/customer';
	...
	public function create()
	{
		...
		if( $this->input->post() ) 
		{
			...
			$post_contact_person = (array) $this->input->post("contact_person");
		...
		$this->data['add_contact_person'] = base_url("marketing/contact_person/form");
	...
	public function delete($id = 0)
	{
		...
		{ 
			$this->db->trans_begin();
				//hapus data di SIMdCustomerKerjasama
				$query = $this->db->where('CustomerID', $id)->get('SIMdCustomerKerjasama')->row();
				$this->db->where('CustomerKerjasamaID', $query->CustomerKerjasamaID)->delete('SIMdKontrakDetailKomponen');
				$this->db->where('CustomerKerjasamaID', $query->CustomerKerjasamaID)->delete('SIMdKontrakKerjasama');
				$this->db->where('CustomerID', $id)->delete('SIMdCustomerKerjasama');
