...
{
	public $table = 'mKabupaten';
	protected $index_key = 'Kode_Kabupaten';
	...
	public function to_list_data( $parent_id = 0 )
	{
		$option_data = [];
		$db_where = $parent_id !== 0 ? ['PropinsiID' => $parent_id] : NULL;
		if ($items = $this->get_all(NULL, 0, $db_where))
		{
			foreach($items as $item)
			{
				$option_data[ $item->{$this->index_key} ] = $item->Nama_Kabupaten;
			}
		}
