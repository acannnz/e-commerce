...
{ 
	...
	public function create( $NoReg, $SectionID )
	{
		...
		$option_section = $this->section_model->get_all(["TipePelayanan" => "RJ"]);
	...
	public function lookup_supplier_sender( $is_ajax_request=false )
	{
		if( $this->input->is_ajax_request() || $is_ajax_request !== false )
		{
			$this->load->view( 'lookup/supplier_sender', array("type" => "doctor" ) );
		} 
	}
	...
	public function lookup_vendor_dirujuk( $is_ajax_request=false )
	{
		if( $this->input->is_ajax_request() || $is_ajax_request !== false )
		{
			$this->load->view( 'lookup/vendor_dirujuk', array("type" => "doctor" ) );
		} 
	}
}