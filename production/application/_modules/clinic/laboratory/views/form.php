					...
					<div class="row">
						...
						<div class="col-md-4">
							...
							<div class="form-group">
								...
								<select id="TransferSectionID" name="TransferSectionID" class="form-control">
									<option value=""></option>
									<?php if (!empty($option_section)): foreach($option_section as $v):?>
									<option value="<?php echo $v->SectionID ?>" <?php echo $v->SectionID == @$item->TransferSectionID ? "selected" : NULL ?>><?php echo $v->SectionName?></option>
						...
						<div class="col-md-4">
							...
							<div class="form-group">
								...
								<textarea class="form-control" name="AlasanDirujuk" id="AlasanDirujuk" cols="30" rows="0"><?= @$item->AlasanDiRujuk ?></textarea>
			...
			try{
				...
				*/
				...
				data_post['lab'] = {
					...
					AlasanDiRujuk : $("#AlasanDirujuk").val(),
