	...
	<div class="col-md-3">
        <div class="form-group">
            ...
            <div class="input-group">
                ...
                <input type="text" id="NRM_c" class="form-control searchable_c mask_nrm" placeholder="<?php echo lang('laboratory:mr_number_label')?>" />
				<span class="input-group-addon"><i class="fa fa-wheelchair"></i></span>
                <input type="text" id="Nama_c" class="form-control searchable_c" placeholder="<?php echo lang('laboratory:name_label') ?>"/>
            </div>
        </div>
    </div>
    <div class="col-md-3">
		...
		$.fn.extend({
				DataTable_DataCheckups: function(){
						...
						var _datatable = _this.DataTable( {
							...
							ajax: {
									url: "<?php echo base_url("{$nameroutes}/laboratories/data_checkup/datatable_collection") ?>",
									type: "POST",
									...
									{ 
										...
										render: function ( val, type, row ){
												var buttons = "<div class=\"btn-group pull-right\" role=\"group\">";
													buttons += "<a href=\"<?php echo base_url("{$nameroutes}/edit") ?>/" + val + "\" title=\"Periksa Pasien\" class=\"btn btn-default btn-xs\"> <i class=\"fa fa-eye\"></i> Lihat</a>";
