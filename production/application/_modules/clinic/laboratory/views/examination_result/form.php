...
<?php echo form_open( current_url(), array("id" => "form_examination_result") ); ?>
...
<div class="panel panel-info">
	...
	<div class="panel-body">
		<div class="row">
			...
			<div class="col-md-6">
				...
				<div class="form-group">
					...
					<div class="col-lg-9">
						<input type="text" id="NamaPasien" name="f[NamaPasien]" value="<?php echo @$item->NamaPasien ?>" placeholder="" class="form-control">
					</div>
				</div>				  
				<div class="form-group">
		...
		<div class="row">
			<div class="col-md-12">
				<div class="form-group">
					<table id="dt_examination_result" class="table table-bordered table-hover" width="100%">
						<thead>
							<tr>
								...
								<th><?php echo "Hasil Pemeriksaan" ?></th>                            
							</tr>
						</thead>
						<tbody>
						</tbody>
		...
		<div class="row">
			<div class="col-md-12">
				<div class="form-group text-right">
					<a href="<?php echo $verify_result_link ?>" id="btn-view-result" data-toggle="form-ajax-modal" class="btn btn-success pull-left <?= (! @$is_edit) ? 'disabled' : '' ?>"><?php echo 'Lihat Hasil' ?></a>
					<button type="submit" class="btn btn-primary"><?php echo lang( 'buttons:submit' ) ?></button>
					<button type="reset" data-dismiss="modal" class="btn btn-default"><?php echo lang( 'buttons:close' ) ?></button>
				</div>
			</div>
		</div>
	</div>
...
//<![CDATA[
(function( $ ){
		var _form = $("#form_examination_result");
		var _datatable;
				...
				edit: function( row, data, index ){
						...
						switch( this.index() ){			
							case 4:
								...
								var _input = $( "<input type=\"text\" value=\"" + (data.Nilai || '') + "\" style=\"width:100%\"  class=\"form-control\">" );
		...
		$.fn.extend({
				dt_examination_result: function(){
						var _this = this;
								...
								columns: [
										...
										{ 
											...
											render: function(val, type, row){
												return typeof row.Nilai !== "undefined" ? row.Nilai : '';
											} 
										},
									],
						...
						$( "#dt_examination_result_length select, #dt_examination_result_filter input" )
		...
		$( document ).ready(function(e) {			
			$( "#dt_examination_result" ).dt_examination_result();
			
			_form.on("submit", function(e){
				e.preventDefault();
				
				var data_post = $(this).serializeArray();
				var table_data = $( "#dt_examination_result" ).DataTable().rows().data();
