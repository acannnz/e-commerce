		...
		var _datatable_actions = {
				edit: function( row, data, index ){
						switch( this.index() ){
							...
							case 9:
								var _input = $( "<input type=\"number\" style=\"width:100%\" value=\""+ Number(data.Qty_Amprah || 0) +"\" class=\"form-control\">" );
								...
								_input.on( "blur", function( e ){
										...
										try{
											...
											data.Qty_Amprah = Number(this.value || 0);
				...
				dt_details: function(){
						...
						_datatable = _this.DataTable( {
								...
								columns: [
										...
										{ data: "Qty_Amprah", className: "text-right" },
									],
								columnDefs  : [
										{
											"targets": ["Barang_ID", "StatusBarang"],
											"visible": false,
											"searchable": false
										}
									],
