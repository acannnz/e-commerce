...
<div class="panel panel-info">
	<div class="panel-heading">
		...
		<ul class="panel-btn">
			<li><a href="<?php echo $create_url ?>" class="btn btn-info" title="Kelola Stok Opname"><b><i class="fa fa-plus"></i> <?php echo 'Stok Opname Baru' ?></b></a></li>
		</ul>
	</div>
									...
									{ 
										...
										render: function ( val, type, row ){
												var buttons = "<div class=\"btn-group pull-right\" role=\"group\">";
													buttons += "<a href=\"<?php echo base_url("inquiry/stock-opname-view/{$type}") ?>/" + val + "\" title=\"Lihat Stok Opname\" class=\"btn btn-default btn-xs\"> <i class=\"fa fa-eye\"></i> Lihat</a>";
												buttons += "</div>";
