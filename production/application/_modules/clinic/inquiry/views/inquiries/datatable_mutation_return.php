...
<div class="panel panel-info">
	<div class="panel-heading">
		<h3 class="panel-title"><?php echo 'List Data Retur Mutasi' ?></h3>
		<ul class="panel-btn">
			<li><a href="<?php echo $create_link ?>" class="btn btn-info" title="Kelola Mutasi"><b><i class="fa fa-plus"></i> <?php echo 'Retur Mutasi Baru' ?></b></a></li>
		</ul>
	</div>
									...
									{ 
										...
										render: function ( val, type, row ){
												var buttons = "<div class=\"btn-group pull-right\" role=\"group\">";
													buttons += "<a href=\"<?php echo base_url("inquiry/mutation-return-view/{$type}") ?>/" + val + "\" title=\"Lihat Retur Mutasi\" class=\"btn btn-default btn-xs\"> <i class=\"fa fa-eye\"></i> Lihat</a>";
												buttons += "</div>";
