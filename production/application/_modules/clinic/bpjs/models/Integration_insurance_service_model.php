...
class Integration_insurance_service_model extends CI_Model
{
	public $table = 'SIMtrIntegrasiAsuransiTindakan';
	public $index_key = 'NoBuktiIntegrasi';
	public $rules;
	...
	public function __construct()
	{
		$this->rules = [
			'insert' => [
				[
					'field' => 'NoReg',
                	'label' => lang('label:registration_number'),
               		'rules' => 'required'
				],
				[
					'field' => 'NoBuktiIntegrasi',
