...
<div class="modal-body">
    ...
    function lookupbox_row_selected( response ){
        ...
        if( _response ){
            ...
            try {
                ...
                $("#Barang_ID_BPJS").val( _response.kdObat );
	...
	<div class="table-responsive">
		<table id="dt-drug-bpjs" class="table table-sm table-bordered table-hover" width="100%">
			<thead>
				<tr>
					<th></th>
					<th><?php echo lang('label:code') ?></th>
					<th><?php echo lang('label:name') ?></th>
					<th><?php echo lang('label:available') ?></th>
				</tr>
			</thead>
			<tbody>
			</tbody>
	...
	(function( $ ){
			$.fn.extend({
					dataTableInit: function(){
							...
							var _datatable = _this.DataTable( {
								...
								scrollCollapse: true,
								ajax: {
										url: "<?php echo config_item('bpjs_api_baseurl')."/obat/dpho/filter/a/limit/1000" ?>",
										type: "GET",
			...
			var _datatable = $( "#dt-drug-bpjs" ).dataTableInit();
			...
			$('#dt-drug-bpjs').on( 'page.dt', function (e) {
