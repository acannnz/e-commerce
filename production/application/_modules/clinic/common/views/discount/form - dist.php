...
<div class="page-subtitle">
    ...
    <h3 class="text-info"><?php echo lang('suppliers:general_subtitle') ?></h3>
...
<div class="page-subtitle">
    ...
    <h3 class="text-info"><?php echo lang('suppliers:address_subtitle') ?></h3>
...
<div class="page-subtitle">
    ...
    <h3 class="text-info"><?php echo lang('suppliers:contact_subtitle') ?></h3>
