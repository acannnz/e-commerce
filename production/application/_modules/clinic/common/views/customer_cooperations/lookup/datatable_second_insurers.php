...
<div class="table-responsive">
    <table id="dt-lookup-customer_cooperations" class="table table-sm table-bordered table-striped" width="100%">
        <thead>
            <tr>
                <th></th>
                <th>Kode </th>
...
(function( $ ){
		$.fn.extend({
				DT_Lookup_Customer_cooperations: function(){
						var _this = this;
						...
						var _datatable = _this.DataTable( {
							...
							columns: [
									...
									{ 
										data: "Active", className: "text-center", orderable: true, searchable: true,
										render: function ( val ){
		...
		var _datatable = $( "#dt-lookup-customer_cooperations" ).DT_Lookup_Customer_cooperations();

		$('#dt-lookup-customer_cooperations tbody').on( 'click', 'tr', function () {
			if ( $(this).hasClass('selected') ) {
				$(this).removeClass('selected');
			}else {
				$('#dt-lookup-customer_cooperations tbody tr.selected').removeClass('selected');
