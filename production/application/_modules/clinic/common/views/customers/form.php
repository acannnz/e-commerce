...
<div class="page-subtitle">
    ...
    <h3 class="text-primary"><?php echo lang('customers:general_subtitle') ?></h3>
	<p><?php echo lang('customers:general_subtitle_helper') ?></p>
</div>
<div class="form-group-one-unit margin-bottom-30">
    <div class="row">
        <div class="col-md-4">
            <div class="form-group form-group-custom">
            	<label class="control-label"><?php echo lang('customers:mr_number_label') ?> <span class="text-danger">*</span></label>
        ...
        <div class="col-md-4">
            <div class="form-group form-group-custom">
            	<label class="control-label"><?php echo lang('customers:type_label') ?> <span class="text-danger">*</span></label>
                <div class="form-control-clear-wrap">
                    <?php echo form_dropdown(
                            'f[type_id]', 
                            (array(0 => lang('customers:type_no_select')) + $options_type), 
                            @$item->type_id, 
        ...
        <div class="col-md-4">
            <div class="form-group form-group-custom">
                <label class="control-label"><?php echo lang('customers:state_label')?></label>
                <div class="form-control-clear-wrap">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="form-group form-group-custom form-control-clear">
                <label class="control-label"><?php echo lang('customers:name_label') ?> <span class="text-danger">*</span></label>
                <div class="form-control-clear-wrap">
    ...
    <div class="row">
        <div class="col-md-8">
            <div class="form-group form-group-custom">
                <label class="control-label"><?php echo lang('customers:referrer_label') ?></label>
        ...
        <div class="col-md-4">
            <div class="form-group form-group-custom">
                <label class="control-label"><?php echo lang('customers:is_member_label') ?></label>
                <div class="form-control-clear-wrap">
                    <div class="radio radio-inline">
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="form-group form-group-custom form-control-clear">
                <label class="control-label"><?php echo lang('customers:birth_date_label') ?></label>
                <div class="form-control-clear-wrap">
        ...
        <div class="col-md-2">
            <div class="form-group form-group-custom">
                <label class="control-label"><?php echo lang('customers:gender_label') ?></label>
                <div class="form-control-clear-wrap">
                    <div class="radio radio-inline">
        ...
        <div class="col-md-2">
            <div class="form-group form-group-custom">
                <label class="control-label"><?php echo lang('customers:age_label') ?></label>
                <div class="form-control-clear-wrap">
        ...
        <div class="col-md-4">
            <div class="form-group form-group-custom">
                <label class="control-label"><?php echo lang('customers:nationality_label') ?></label>
                <div class="form-control-clear-wrap">
					<?php echo form_dropdown(
                            'f[personal_nationality]', 
                            (array(0 => lang('customers:nationality_no_select')) + $options_nationality), 
...
<div class="page-subtitle">
    ...
    <h3 class="text-primary"><?php echo lang('customers:address_subtitle') ?></h3>
	<p><?php echo lang('customers:address_subtitle_helper') ?></p>
</div>
<div class="form-group-one-unit margin-bottom-30">
    <div class="row">
        <div class="col-md-12">
            <div class="form-group form-group-custom form-control-clear">
                <label class="control-label"><?php echo lang('customers:address_label') ?></label>
                <div class="form-control-clear-wrap">
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="form-group form-group-custom">
                <label class="control-label"><?php echo lang('customers:country_label') ?></label>
                <?php echo form_dropdown(
                        'f[country_id]', 
                        (array(0 => lang('customers:country_no_select')) + $options_country), 
                        @$item->country_id, 
        ...
        <div class="col-md-4">
            <div class="form-group form-group-custom">
                <label class="control-label"><?php echo lang('customers:province_label') ?></label>
                <div class="form-control-clear-wrap">
					<?php echo form_dropdown(
                            'f[province_id]', 
                            (array(0 => lang('customers:province_no_select')) + $options_province), 
                            @$item->province_id, 
        ...
        <div class="col-md-4">
            <div class="form-group form-group-custom">
                <label class="control-label"><?php echo lang('customers:county_label') ?></label>
                <div class="form-control-clear-wrap">
					<?php echo form_dropdown(
                            'f[county_id]', 
                            (array(0 => lang('customers:county_no_select')) + $options_county), 
                            @$item->county_id, 
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="form-group form-group-custom">
                <label class="control-label"><?php echo lang('customers:district_label') ?></label>
                <div class="form-control-clear-wrap">
					<?php echo form_dropdown(
                            'f[district_id]', 
                            (array(0 => lang('customers:district_no_select')) + $options_district), 
                            @$item->district_id, 
        ...
        <div class="col-md-8">
            <div class="form-group form-group-custom">
                <label class="control-label"><?php echo lang('customers:area_label') ?></label>
                <div class="form-control-clear-wrap">
					<?php echo form_dropdown(
                            'f[area_id]', 
                            (array(0 => lang('customers:area_no_select')) + $options_area), 
                            @$item->area_id, 
...
<div class="page-subtitle">
    ...
    <h3 class="text-primary"><?php echo lang('customers:contact_subtitle') ?></h3>
	<p><?php echo lang('customers:contact_subtitle_helper') ?></p>
</div>
<div class="form-group-one-unit margin-bottom-30">
    <div class="row">
        <div class="col-md-4">
            <div class="form-group form-group-custom form-control-clear">
                <label class="control-label"><?php echo lang('customers:phone_label') ?></label>
                <div class="form-control-clear-wrap">
        ...
        <div class="col-md-4">
            <div class="form-group form-group-custom form-control-clear">
                <label class="control-label"><?php echo lang('customers:email_label') ?></label>
                <div class="form-control-clear-wrap">
        ...
        <div class="col-md-4">
            <div class="form-group form-group-custom form-control-clear">
                <label class="control-label"><?php echo lang('customers:profession_label') ?></label>
                <div class="form-control-clear-wrap">
...
;(function( $ ){
		...
		$( document ).ready(function(){
				...
				$("#lookup_referrer").on("click", function( e ){					
					lookup_ajax_modal.show('<?php echo base_url("common/customers/lookup_referrer")?>')
				});
