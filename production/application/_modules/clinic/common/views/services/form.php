...
<div class="form-group">
    <label class="col-lg-3 control-label"><?php echo lang('services:code_label') ?> <span class="text-danger">*</span></label>
    <div class="col-lg-6">
        <input type="text" id="code" name="f[code]" value="<?php echo @$item->code ?>" placeholder="" class="form-control" required>
    </div>
</div>
<div class="form-group">
    <label class="col-lg-3 control-label"><?php echo lang('services:title_label') ?> <span class="text-danger">*</span></label>
    <div class="col-lg-6">
...
<div class="form-group">
    <label class="col-lg-3 control-label"><?php echo lang('services:description_label') ?></label>
    <div class="col-lg-6">
...
<div class="form-group">
    <label class="col-lg-3 control-label"><?php echo lang('services:price_label') ?></label>
    <div class="col-lg-6">
