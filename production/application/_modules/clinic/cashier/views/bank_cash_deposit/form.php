...
<div class="panel panel-info">
	<div class="panel-heading">
		<h3 class="panel-title"><?php echo lang('bank_cash_deposit:pay_heading')?></h3>
	</div>
				...
				<div class="form-group">
					...
					<div class="col-lg-9">
						<div class="input-group">
							...
							<span class="input-group-btn">
								<a href="<?php echo @$lookup_account_cash_bank_merchan ?>" data-toggle="lookup-ajax-modal" class="btn btn-default" ><i class="fa fa-search"></i></a>
				...
				<div class="form-group">
					...
					<div class="col-lg-9">
						<div class="input-group">
							...
							<span class="input-group-btn">
								<a href="<?php echo @$lookup_account_cash_bank ?>" data-toggle="lookup-ajax-modal" class="btn btn-default" ><i class="fa fa-search"></i></a>
		...
		<div class="row form-group">
			...
			<div class="col-lg-6">
				<div class="form-group text-right"> 
					...
					<?php endif; ?>
					<a href="<?php echo base_url("cashier/bank-cash-deposit/create")?>" class="btn btn-info"><i class="fa fa-file"></i> <?php echo lang( 'buttons:create' ) ?></a>
