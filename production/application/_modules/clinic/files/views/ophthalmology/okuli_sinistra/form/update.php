...
?>
<?php echo form_open_multipart(current_url(), array('id' => 'form_files_ophthalmology_os', 'name' => 'form_files_ophthalmology_os')); ?>
...
;(function( $ ){
		$.fn.extend({
				form_files_ophthalmology_os: function( remote_server ){
		...
		$( document ).ready(function(e) {
            	$( "form[name=\"form_files_ophthalmology_os\"]" )
					.form_files_ophthalmology_os( "<?php echo @$update_action ?>" );
        	});
	})( jQuery );
//]]>
</script>
