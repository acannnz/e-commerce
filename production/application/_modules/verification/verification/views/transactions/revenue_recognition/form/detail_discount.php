...
<div class="row">
	...
	<div class="form-group">
		<div class="table-responsive">
			<table id="dt_detail_discount" class="table table-sm table-bordered" width="100%">
				<thead>
					<tr>
						<th><?php echo lang('label:discount_name')?></th>                                                
						<th><?php echo lang('label:doctor_id')?></th>                    
						<th><?php echo lang('label:doctor_name')?></th>    
						<th><?php echo lang('label:service')?></th>                        
						<th><?php echo lang('label:class')?></th>                        
						<th><?php echo lang('label:percent')?></th>
...
(function( $ ){
		...
		$.fn.extend({
				dt_detail_discount: function(){
						...
						_datatable = _this.DataTable( {
								...
								columns: [
										...
										{ 
											data: "JasaID", 
											render: function( val, type, row ){
												return row.JasaID +'-'+ row.JasaName
											}
										},
										{ data: "NamaKelas" },
										{ data: "Persen" },
						...
						$( "#dt_detail_discount_length select, #dt_detail_discount_filter input" )
		...
		$( document ).ready(function(e) {
			$( "#dt_detail_discount" ).dt_detail_discount();
