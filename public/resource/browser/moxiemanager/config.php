...
// Filesystem
$moxieManagerConfig['filesystem.rootpath'] = 'D:/Localhost/host-metta/wsjasaraharja/public_html/public/resource/attachments';
...
$moxieManagerConfig['filesystem.extensions'] = 'jpg,png,gif,zip,rar,pdf,doc,docx,xls,xlsx';
...
$moxieManagerConfig['upload.extensions'] = 'jpg,png,gif,zip,rar,pdf,doc,docx,xls,xlsx';
...
$moxieManagerConfig['filesystem.local.wwwroot'] = 'http://ws-jasaraharja.metta.web/';
//$moxieManagerConfig['filesystem.local.wwwroot'] = array(
//													"D:/Localhost/host-metta/wsjasaraharja/public_html/public/resource/attachments" => array(
//															"urlprefix" => "http://ws-jasaraharja.metta.web/",
//															"urlsuffix" => "?suffix"
//														)
//												);
...
$moxieManagerConfig['basicauthenticator.users'] = array(array(
		"username" => "admin", 
		"password" => "admin", 
