...
jQuery(document).ready(function() {
		...
		// Select2		
		//jQuery('.form-group').find('select').select2({minimumResultsForSearch: -1, dropdownAutoWidth: true, width: '100%'});
		//jQuery('.form-group').find('select').removeClass('form-control');
