...
var ajax_modal = {
		...
		show: function( _prop, fn, scope ){
				...
				$( "body" ).append( _modal );
				_modal.modal({backdrop: false, keyboard: true});
				_modal.find('.modal-body').load( _prpo.remote );
...
(function($){
		$(document).ready(function(e) {
				...
				$('input[type="checkbox"].checkbox,input[type="radio"].radio').iCheck({
...
(function($){
		$(document).ready(function() {
				...
				if ($('[data-toggle="ajax-tab"] a').filter('.active').size()) {
					$('[data-toggle="ajax-tab"] a').filter('.active').trigger("click");
				} else {
					$('[data-toggle="ajax-tab"] a').first().trigger("click");
				}
			...
			var remote_modal = function(url) {
				...
				$("#ajaxModal .modal-body").html(spinner);
				$("#ajaxModal .modal-body").load(url);
...
if (typeof TableTools != 'undefined') {
	...
	TableTools.DEFAULTS.sSwfPath = "/themes/bracketadmin/js/datatable/TableTools/swf/copy_csv_xls_pdf.swf";
}
...
(function($) {
	...
	$.fn.appTable = function(options) {
		...
		var datatableOptions = {
			...
			pageLength: settings.displayLength,
			autoWidth: false,
			orderClasses: false,
		...
		if (!settings.hideTools) {
			datatableOptions.dom = "<'datatable-tools'<'col-md-3'l><'col-md-9 custom-toolbar'f>r>t<'datatable-tools clearfix'<'col-md-3'i><'col-md-9'p>>";
		}
		...
		if (settings._exportable) {
			...
			if (!settings.hideTools) {
				datatableOptions.dom = "<'datatable-tools'<'col-md-3'l><'col-md-9 custom-toolbar'f<'datatable-export'T>>r>t<'datatable-tools clearfix'<'col-md-3'i><'col-md-9'p>>";
			}
