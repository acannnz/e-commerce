...
(function($) {
	function lookupbox7(options) {
		...
		var settings = {
				...
				containerClass: 'lookupbox7-form-control',
				searchClass: 'lookupbox7-input-search',
				buttonClass: 'lookupbox7-btn-popup',
		...
		$(document).ready(function() {
			...
			var _form_control = _this.parents('.' + settings.containerClass),
				_button = _form_control.find('.' + settings.buttonClass),
				_search = _form_control.find('.' + settings.searchClass);
			...
			_search.attr('placeholder', settings.placeholder);
